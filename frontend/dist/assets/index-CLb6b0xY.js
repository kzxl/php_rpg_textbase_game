(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const d of document.querySelectorAll('link[rel="modulepreload"]'))r(d);new MutationObserver(d=>{for(const $ of d)if($.type==="childList")for(const g of $.addedNodes)g.tagName==="LINK"&&g.rel==="modulepreload"&&r(g)}).observe(document,{childList:!0,subtree:!0});function t(d){const $={};return d.integrity&&($.integrity=d.integrity),d.referrerPolicy&&($.referrerPolicy=d.referrerPolicy),d.crossOrigin==="use-credentials"?$.credentials="include":d.crossOrigin==="anonymous"?$.credentials="omit":$.credentials="same-origin",$}function r(d){if(d.ep)return;d.ep=!0;const $=t(d);fetch(d.href,$)}})();const lt="/api";class ot{async request(e,t={}){try{const r=await fetch(`${lt}${e}`,{headers:{"Content-Type":"application/json",...t.headers},...t}),d=await r.json();if(!r.ok)throw new Error(d.error||`HTTP ${r.status}`);return d}catch(r){throw console.error(`API Error [${e}]:`,r),r}}register(e,t,r,d){return this.request("/auth/register",{method:"POST",body:JSON.stringify({username:e,password:t,name:r,gender:d})})}login(e,t){return this.request("/auth/login",{method:"POST",body:JSON.stringify({username:e,password:t})})}createPlayer(e,t){return this.request("/player/create",{method:"POST",body:JSON.stringify({name:e,gender:t})})}getPlayer(e){return this.request(`/player/${e}`)}allocateStat(e,t,r=1){return this.request(`/player/${e}/allocate`,{method:"POST",body:JSON.stringify({stat:t,points:r})})}equipItem(e,t){return this.request(`/player/${e}/equip`,{method:"POST",body:JSON.stringify({itemId:t})})}learnSkill(e,t){return this.request(`/player/${e}/learn-skill`,{method:"POST",body:JSON.stringify({skillId:t})})}equipSkill(e,t,r=!0){return this.request(`/player/${e}/equip-skill`,{method:"POST",body:JSON.stringify({skillId:t,equip:r})})}healPlayer(e){return this.request(`/player/${e}/heal`,{method:"POST"})}useMedicine(e,t){return this.request(`/player/${e}/use-medicine`,{method:"POST",body:JSON.stringify({medicineId:t})})}trainStat(e,t){return this.request(`/player/${e}/train`,{method:"POST",body:JSON.stringify({stat:t})})}fullCombat(e,t=null){return this.request("/combat/full",{method:"POST",body:JSON.stringify({playerId:e,monsterId:t})})}getMonsters(){return this.request("/data/monsters")}getSkills(){return this.request("/data/skills")}getItems(){return this.request("/data/items")}getMedicines(){return this.request("/data/medicines")}getCrimes(){return this.request("/data/crimes")}getEducation(){return this.request("/data/education")}getExploration(){return this.request("/data/exploration")}getRecipes(){return this.request("/recipes")}equipItem(e,t){return this.request(`/player/${e}/equip`,{method:"POST",body:JSON.stringify({itemId:t})})}useItem(e,t){return this.request(`/player/${e}/use`,{method:"POST",body:JSON.stringify({itemId:t})})}useMedicine(e,t){return this.request(`/player/${e}/use-medicine`,{method:"POST",body:JSON.stringify({medicineId:t})})}generateItem(e,t){return this.request("/items/generate",{method:"POST",body:JSON.stringify({rarity:t,playerId:e})})}trainStat(e,t,r=1){return this.request(`/player/${e}/train`,{method:"POST",body:JSON.stringify({stat:t,count:r})})}allocateStat(e,t){return this.request(`/player/${e}/allocate`,{method:"POST",body:JSON.stringify({stat:t})})}attemptBreakthrough(e){return this.request(`/player/${e}/breakthrough`,{method:"POST"})}getRealm(e){return this.request(`/player/${e}/realm`)}craftItem(e,t){return this.request(`/player/${e}/craft`,{method:"POST",body:JSON.stringify({recipeId:t})})}getCurrencies(){return this.request("/crafting/currencies")}applyCurrency(e,t,r,d=-1){return this.request(`/player/${e}/crafting/apply`,{method:"POST",body:JSON.stringify({currencyId:t,itemId:r,lockAffixIndex:d})})}commitCrime(e,t){return this.request(`/player/${e}/commit-crime`,{method:"POST",body:JSON.stringify({crimeId:t})})}escapeJail(e){return this.request(`/player/${e}/escape-jail`,{method:"POST"})}bail(e){return this.request(`/player/${e}/bail`,{method:"POST"})}enrollNode(e,t,r){return this.request(`/player/${e}/enroll`,{method:"POST",body:JSON.stringify({nodeId:t,treeId:r})})}checkEducation(e){return this.request(`/player/${e}/check-education`,{method:"POST"})}generateItem(e="common",t=null){return this.request("/items/generate",{method:"POST",body:JSON.stringify({rarity:e,slot:t})})}explore(e){return this.request(`/player/${e}/explore`,{method:"POST"})}trackMonster(e,t){return this.request(`/player/${e}/track-monster`,{method:"POST",body:JSON.stringify({monsterId:t})})}getAreaMonsters(e){return this.request(`/player/${e}/area-monsters`)}getNpc(e){return this.request(`/npc/${e}`)}getNpcs(){return this.request("/data/npcs")}acceptQuest(e,t,r){return this.request(`/player/${e}/accept-quest`,{method:"POST",body:JSON.stringify({npcId:t,questId:r})})}completeQuest(e,t){return this.request(`/player/${e}/complete-quest`,{method:"POST",body:JSON.stringify({questId:t})})}getQuests(e){return this.request(`/player/${e}/quests`)}searchPlayers(e){return this.request(`/players/search?q=${encodeURIComponent(e)}`)}getRelationships(e){return this.request(`/player/${e}/relationships`)}interactPlayer(e,t,r,d){return this.request(`/player/${e}/interact`,{method:"POST",body:JSON.stringify({targetId:t,action:r,amount:d})})}addFriend(e,t){return this.request(`/player/${e}/add-friend`,{method:"POST",body:JSON.stringify({targetId:t})})}acceptFriend(e,t){return this.request(`/player/${e}/accept-friend`,{method:"POST",body:JSON.stringify({targetId:t})})}rejectFriend(e,t){return this.request(`/player/${e}/reject-friend`,{method:"POST",body:JSON.stringify({targetId:t})})}removeFriend(e,t){return this.request(`/player/${e}/remove-friend`,{method:"POST",body:JSON.stringify({targetId:t})})}addEnemy(e,t){return this.request(`/player/${e}/add-enemy`,{method:"POST",body:JSON.stringify({targetId:t})})}removeEnemy(e,t){return this.request(`/player/${e}/remove-enemy`,{method:"POST",body:JSON.stringify({targetId:t})})}getGlobalChat(e=0){return this.request(`/chat/global?afterId=${e}`)}getPrivateChat(e,t,r=0){return this.request(`/chat/private/${e}?with=${t}&afterId=${r}`)}getChatFriends(e){return this.request(`/chat/friends/${e}`)}sendChat(e,t,r,d){return this.request("/chat/send",{method:"POST",body:JSON.stringify({senderId:e,channel:t,receiverId:r,message:d})})}getMarketListings(e="",t="newest"){const r=new URLSearchParams;return e&&r.set("type",e),t&&r.set("sort",t),this.request(`/market?${r.toString()}`)}getMyListings(e){return this.request(`/market/my/${e}`)}listForSale(e,t,r,d,$){return this.request("/market/list",{method:"POST",body:JSON.stringify({sellerId:e,itemType:t,itemId:r,quantity:d,price:$})})}buyFromMarket(e,t,r=1){return this.request("/market/buy",{method:"POST",body:JSON.stringify({buyerId:e,listingId:t,quantity:r})})}cancelListing(e,t){return this.request("/market/cancel",{method:"POST",body:JSON.stringify({sellerId:e,listingId:t})})}getRealmInfo(e){return this.request(`/player/${e}/realm`)}attemptBreakthrough(e){return this.request(`/player/${e}/breakthrough`,{method:"POST"})}getAllRealms(){return this.request("/data/realms")}getMugTargets(e){return this.request(`/player/${e}/mug-targets`)}mugPlayer(e,t){return this.request(`/player/${e}/mug`,{method:"POST",body:JSON.stringify({victimId:t})})}getMugLog(e){return this.request(`/player/${e}/mug-log`)}getMapItems(e){return this.request(`/player/${e}/map-items`)}enterDungeon(e,t){return this.request(`/player/${e}/dungeon/enter`,{method:"POST",body:JSON.stringify({mapItemId:t})})}fightDungeonWave(e){return this.request(`/player/${e}/dungeon/fight`,{method:"POST"})}abandonDungeon(e){return this.request(`/player/${e}/dungeon/abandon`,{method:"POST"})}getDungeonHistory(e){return this.request(`/player/${e}/dungeon/history`)}getHousing(e){return this.request(`/player/${e}/housing`)}buyHousing(e){return this.request(`/player/${e}/housing/buy`,{method:"POST"})}plantHerb(e,t,r){return this.request(`/player/${e}/housing/plant`,{method:"POST",body:JSON.stringify({herbId:t,slotIndex:r})})}harvestGarden(e){return this.request(`/player/${e}/housing/harvest`,{method:"POST"})}upgradeFormation(e,t){return this.request(`/player/${e}/housing/formation`,{method:"POST",body:JSON.stringify({formationId:t})})}payMaintenance(e){return this.request(`/player/${e}/housing/maintenance`,{method:"POST"})}listForRent(e,t){return this.request(`/player/${e}/housing/rent/list`,{method:"POST",body:JSON.stringify({pricePerDay:t})})}getRentals(){return this.request("/housing/rentals")}rentRoom(e,t){return this.request(`/player/${e}/housing/rent/take`,{method:"POST",body:JSON.stringify({rentalId:t})})}getMyGuild(e){return this.request(`/player/${e}/guild`)}createGuild(e,t,r,d){return this.request(`/player/${e}/guild/create`,{method:"POST",body:JSON.stringify({name:t,tag:r,description:d})})}contributeGuild(e,t){return this.request(`/player/${e}/guild/contribute`,{method:"POST",body:JSON.stringify({amount:t})})}upgradeGuild(e){return this.request(`/player/${e}/guild/upgrade`,{method:"POST"})}joinGuild(e,t){return this.request(`/player/${e}/guild/join`,{method:"POST",body:JSON.stringify({guildId:t})})}leaveGuild(e){return this.request(`/player/${e}/guild/leave`,{method:"POST"})}listGuilds(){return this.request("/guilds")}payGuildUpkeep(e){return this.request(`/guild/${e}/upkeep`,{method:"POST"})}getTribulation(e){return this.request(`/player/${e}/tribulation`)}fightTribulation(e){return this.request(`/player/${e}/tribulation/fight`,{method:"POST"})}getCurrencies(){return this.request("/crafting/currencies")}applyCurrency(e,t,r,d=-1){return this.request(`/player/${e}/crafting/apply`,{method:"POST",body:JSON.stringify({currencyId:t,itemId:r,lockAffixIndex:d})})}getShops(e){return this.request("/shops")}buyFromShop(e,t,r,d=1){return this.request(`/player/${e}/shop/buy`,{method:"POST",body:JSON.stringify({shopId:t,itemId:r,quantity:d})})}getMarketTax(){return this.request("/market/tax")}searchPlayers(e){return this.request(`/players/lookup?q=${encodeURIComponent(e)}`)}getPlayerProfile(e){return this.request(`/player/${e}/profile`)}getArena(e){return this.request(`/player/${e}/arena`)}arenaFight(e){return this.request(`/player/${e}/arena/fight`,{method:"POST"})}getAuctions(e=""){return this.request(`/auction${e?"?q="+encodeURIComponent(e):""}`)}getMyAuctions(e){return this.request(`/player/${e}/auction/mine`)}listAuction(e,t,r,d=24){return this.request(`/player/${e}/auction/list`,{method:"POST",body:JSON.stringify({itemId:t,buyoutPrice:r,durationHours:d})})}buyAuction(e,t){return this.request(`/player/${e}/auction/buy`,{method:"POST",body:JSON.stringify({listingId:t})})}cancelAuction(e,t){return this.request(`/player/${e}/auction/cancel`,{method:"POST",body:JSON.stringify({listingId:t})})}getDailyQuests(e){return this.request(`/player/${e}/daily-quests`)}claimDailyQuest(e,t){return this.request(`/player/${e}/daily-quests/claim`,{method:"POST",body:JSON.stringify({questId:t})})}getWorldBoss(){return this.request("/world-boss")}attackWorldBoss(e){return this.request(`/player/${e}/world-boss/attack`,{method:"POST"})}getGachaPools(){return this.request("/gacha/pools")}getGachaPity(e){return this.request(`/player/${e}/gacha/pity`)}gachaPull(e,t,r=1){return this.request(`/player/${e}/gacha/pull`,{method:"POST",body:JSON.stringify({poolId:t,pulls:r})})}getLeaderboard(e){return this.request(`/leaderboard/${e}`)}getActiveEvents(){return this.request("/events/active")}quickEvent(e){return this.request(`/events/quick/${e}`,{method:"POST"})}}const q=new ot;function ct(a,e){var m;const{state:t,api:r,notify:d,renderGame:$,updateSidebar:g}=e,c=t.player,u=t.exploration?t.exploration[c.currentArea||"thanh_lam_tran"]:null,x=u?u.name:"Vùng Đất Vô Danh",v=u?u.staminaCost:10;a.innerHTML=`
    ...
    <div class="panel mt-md">
      ...
      <div class="panel-body no-pad" id="areaMonstersList" style="max-height: 250px; overflow-y: auto;">
    ...
    </div>`;const h=((m=c.insightLevels)==null?void 0:m.monster)??0;(async()=>{try{const s=await r.getAreaMonsters(c.id);if(s.monsters){t.player.trackedMonsters=s.monsters;const o=document.getElementById("trackedMonstersList");if(!o)return;if(s.monsters.length===0){o.innerHTML='<div style="padding: 16px; text-align: center;" class="text-dim">Không có dấu vết yêu thú nào quanh đây.</div>';return}o.innerHTML=s.monsters.map(p=>{var P,I,M,N,R;const n=p.currentHp/p.stats.hp*100,f=n>60?"var(--green)":n>30?"var(--orange)":"var(--red)";let T='<div class="item-desc text-sm text-dim mb-sm">Bản thể mờ ảo, không rõ căn cơ.</div>';h>=1&&(T=`<div class="item-desc text-sm text-dim mb-sm">${p.description||"Yêu thú vùng này."}</div>`);let k="";h>=1&&(k=`<div class="w-full bg-darker rounded mb-sm" style="height: 6px; overflow: hidden;">
              <div style="width: ${n}%; background: ${f}; height: 100%;"></div>
            </div>`);let w=h>=2?`❤ ${p.currentHp}/${p.stats.hp}`:h>=1?"❤ ???":"",L="";h>=3&&(L=`
              ...
              <span class="text-blue">🛡 ${p.stats.defense}</span>`);let E="";h>=4&&p.drops&&p.drops.length>0&&(E=`<div class="text-xs text-dim mt-sm" style="display:flex;gap:4px;flex-wrap:wrap;">
              📦 ${p.drops.map(_=>`<span class="badge" style="background:rgba(255,255,255,0.08);font-size:9px;padding:1px 4px;">${_.id} (${h>=5?_.chance+"%":"?%"})</span>`).join("")}
            </div>`);let S="";if(h>=5){const _=((P=p.goldReward)==null?void 0:P[0])??((I=p.goldReward)==null?void 0:I.min)??"?",B=((M=p.goldReward)==null?void 0:M[1])??((N=p.goldReward)==null?void 0:N.max)??"?";S=`<span class="text-gold">💰 ${_}-${B}</span> <span class="text-purple">✨ ${p.xpReward??"?"} XP</span>`}return`
            <div class="list-item flex flex-col items-start gap-4">
              <div class="item-info" style="width: 100%;">
                <div class="flex justify-between items-center mb-sm">
                  <div class="item-name text-lg">${p.name} <span class="text-xs text-dim">(${((R=p.instance_id)==null?void 0:R.substring(0,8))??""})</span></div>
            ...
            </div>`}).join(""),o.querySelectorAll(".btn-attack-tracked").forEach(p=>{p.addEventListener("click",n=>{const f=n.currentTarget;W(e,f.dataset.mid,f.dataset.inst)})})}}catch(s){console.error("Lỗi tải dấu vết:",s)}})(),(async()=>{const s=document.getElementById("areaMonstersList");if(s)try{const o=await r.getAreaMonsters(c.id),l=t.exploration?t.exploration[c.currentArea||"thanh_lam_tran"]:null,p=(t.monsters||[]).filter(f=>!f.isWorldBoss&&!f.is_world_boss),n=p.length>0?p:[];if(n.length===0){s.innerHTML='<div style="padding: 16px; text-align: center;" class="text-dim">Không rõ quần thể yêu thú nơi đây.</div>';return}s.innerHTML=n.map(f=>{let T='<div class="item-desc text-sm text-dim mb-sm">Thông tin mờ ảo...</div>';return h>=1&&(T=`<div class="item-desc text-sm text-dim mb-sm">${f.description||"Yêu thú sinh sống tại vùng này."}</div>`),`
        ...
        `}).join("")}catch(o){console.error("Lỗi tải quần thể:",o)}})();const y=document.getElementById("btnExplore");y&&y.addEventListener("click",()=>pt(e)),a.querySelectorAll(".list-item.clickable").forEach(s=>{s.addEventListener("click",()=>startCombat(s.dataset.mid,e))})}async function pt(a){var g,c,u;const{state:e,api:t,notify:r,updateSidebar:d}=a,$=document.getElementById("exploreResult");if($){$.innerHTML='<div class="panel"><div class="panel-body text-center text-gold">⏳ Đang tìm kiếm...</div></div>';try{const x=await t.explore(e.playerId);e.player=x.player,d();const v=x.event;let h=`
    ...
    `;if(v.type==="monster")h+=`
      ...
      `;else if(v.type==="monster_ambush"&&v.combatResult){const i=v.combatResult,b=(i.log||[]).map(s=>s.startsWith("---")?`<div class="turn">${s}</div>`:s.includes("hụt")?`<div class="miss">${s}</div>`:s.includes("CHÍNH MẠNG")||s.includes("💥")?`<div class="crit">${s}</div>`:s.includes("ngã xuống")||s.includes("💀")?`<div class="death">${s}</div>`:s.includes("Chiến thắng")||s.includes("🏆")?`<div class="victory">${s}</div>`:`<div class="hit">${s}</div>`).join(""),y=i.outcome==="win"?"🏆 Chiến thắng!":i.outcome==="loss"?"💀 Bại trận!":"⏰ Bất phân",m=i.outcome==="win"?"var(--green)":i.outcome==="loss"?"var(--red)":"var(--orange)";h+=`
        <div style="font-size:36px;margin-bottom:8px">⚠️</div>
        <div class="text-lg bold" style="color:var(--red);margin-bottom:8px">${v.message}</div>
        <div style="font-size:16px;font-weight:700;color:${m};margin-bottom:12px">${y}</div>
      ...
      `,v.studyEffect){const i=v.studyEffect,b=i.isDebuff?"var(--red)":"var(--gold)";h+=`<div class="text-sm mt-sm" style="color:${b};animation:fadeIn 0.5s;">
          ${i.message}
      ...
      `,v.questNotifications&&v.questNotifications.length>0&&v.questNotifications.forEach(i=>{h+=`<div class="text-sm text-gold mt-sm" style="animation: fadeIn 0.5s;">🏷️ ${i.message}</div>`})):h+=`
        <div style="font-size: 32px; margin-bottom: 8px;">💨</div>
        <div class="text-md text-dim mb-sm">${v.message}</div>
      `;v.type!=="monster"&&v.type!=="worldBoss"&&!(v.type==="npc"&&v.npcId)&&(h+='<button class="btn btn--blue mt-sm" id="btnExploreContinue">Tiếp tục hành trình</button>'),v.type==="npc"&&v.npcId||(h+="</div></div>"),$.innerHTML=h,v.type==="player_encounter"&&v.player&&(document.getElementById("btnInteractFriend").addEventListener("click",async i=>{try{const b=await t.addFriend(e.playerId,i.target.dataset.pid);(b.success||b.message)&&r(b.message||"Đã gửi lời mời!","success")}catch(b){r(b.message,"error")}}),document.getElementById("btnInteractGift").addEventListener("click",async i=>{var b;try{const y=await t.interactPlayer(e.playerId,i.target.dataset.pid,"gift",100);if(y.player){e.player=y.player,d(),r(y.message,"success");const m=i.target.closest(".panel-body");m&&(m.innerHTML='<div class="text-green text-lg mb-md">Đã bồi đắp hảo cảm!</div><button class="btn btn--blue" id="btnExploreContinueAfterGift">Rời đi</button>'),(b=document.getElementById("btnExploreContinueAfterGift"))==null||b.addEventListener("click",()=>{$.innerHTML=""})}}catch(y){r(y.message,"error")}}),(g=document.getElementById("btnInteractMug"))==null||g.addEventListener("click",async i=>{var y;const b=i.target.dataset.pid;i.target.disabled=!0,i.target.textContent="⏳ Đang tấn công...";try{const m=await t.request(`/player/${e.playerId}/mug`,{method:"POST",body:JSON.stringify({victimId:b})});e.player=m.player,d();const s=i.target.closest(".panel-body");if(s){const o=m.success?"var(--green)":"var(--red)",l=m.success?"💰":"💀";s.innerHTML=`
              <div style="font-size:36px;margin-bottom:8px">${l}</div>
              <div style="color:${o};font-size:16px;font-weight:700;margin-bottom:8px">${m.message}</div>
            ...
            `,(y=document.getElementById("btnExploreContinueAfterMug"))==null||y.addEventListener("click",()=>{$.innerHTML=""})}r(m.message,m.success?"success":"error")}catch(m){r(m.message,"error"),i.target.disabled=!1,i.target.textContent="⚔️ Cướp Linh Thạch"}})),(v.type==="monster"||v.type==="worldBoss")&&(document.getElementById("btnExploreCombat").addEventListener("click",i=>{$.innerHTML="",W(a,i.target.dataset.mid,null)}),document.getElementById("btnExploreTrack").addEventListener("click",async i=>{try{const b=await t.trackMonster(e.playerId,i.target.dataset.mid);b.success?(r(b.message,"success"),$.innerHTML="",typeof a.renderGame=="function"&&a.renderGame()):b.error&&r(b.error,"error")}catch(b){r("Lỗi theo dõi: "+b.message,"error")}})),v.type==="npc"&&v.npcId&&((c=document.getElementById("btnNpcInteract"))==null||c.addEventListener("click",async()=>{await gt(a,v.npcId,$)})),(u=document.getElementById("btnExploreContinue"))==null||u.addEventListener("click",()=>{$.innerHTML=""})}catch(x){$.innerHTML=`<div class="panel"><div class="panel-body text-red text-center">Lỗi: ${x.message}</div></div>`}}}async function gt(a,e,t){const{state:r,api:d,notify:$,renderGame:g}=a,c=document.getElementById("npcQuestModal")||t;try{const x=(await d.getNpc(e)).npc;if(!x)return;const v=(r.player.activeQuests||[]).map(i=>i.quest_id);let h=x.quests.map(i=>{const b=v.includes(i.id);return`
        <div class="quest-offer" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:8px;padding:12px;margin-bottom:8px;">
          ...
          ${b?'<span class="text-xs text-dim">✅ Đã nhận</span>':`<button class="btn btn--gold btn--sm btn-accept-quest" data-npc="${e}" data-qid="${i.id}">📜 Nhận Nhiệm Vụ</button>`}
        </div>
      `}).join("");c.innerHTML=`
      ...
      <div class="panel">
        ...
        <div class="panel-body combat-result ${s.cls}">
          <div class="combat-opponents">
            ...
            <div class="vs">VS</div>
            <div class="fighter">
              <div class="f-name monster-name">${i.name}</div>
              <div class="mini-hp-bar"><div class="fill hp" style="width:${y}%"></div></div>
              <div class="mini-hp-val">${i.currentHp}/${i.maxHp}</div>
            </div>
          </div>
        </div>
        <div class="combat-log">${h}</div>
      </div>`,g(),t&&typeof c=="function"&&setTimeout(()=>c(),1500)}catch(v){u.innerHTML=`<div class="panel"><div class="panel-body text-red">Lỗi: ${v.message}</div></div>`}}}function X(a,e){const{state:t,api:r,notify:d}=e,$=t.player,g=($.skills||[]).find(h=>(typeof h=="string"?h:h.id)==="nhan_thuat"),c=g?g.level||1:0,u=[...t.skills].sort((h,i)=>(h.tier||1)-(i.tier||1)),x=($.skills||[]).map(h=>typeof h=="string"?h:h.id),v={1:"Nhất",2:"Nhị",3:"Tam",4:"Tứ",5:"Ngũ",6:"Lục",7:"Thất",8:"Bát",9:"Cửu"};a.innerHTML=`
    <div class="page-header">
      <h1>📚 Tàng Kinh Các</h1>
    ...
    <div class="panel">
      <div class="panel-body no-pad" id="libraryList">
        ${u.map(h=>{const i=x.includes(h.id),b=h.tier||1,y=b>c+1,m=b<=c;let s="";return h.requirements&&h.requirements.length>0?m||i?s=`<div class="mt-sm text-xs text-orange">Điều kiện: ${h.requirements.map(o=>`<br>• ${o}`).join("")}</div>`:y?s=`<div class="mt-sm text-xs text-dim" style="font-style: italic;">[???] Khẩu quyết bị sương mù che khuất. Cần Nhãn Thuật Tầng ${b}.</div>`:s='<div class="mt-sm text-xs text-dim">[???] Đạo hạnh thấp kém, linh hồn hoa mắt chóng mặt.</div>':s='<div class="mt-sm text-xs text-green">Điều kiện: Phàm nhân cũng có thể luyện</div>',`
            <div class="list-item" style="flex-direction:column; padding:0; align-items:stretch">
              ...
              <div class="accordion-header" style="display:flex; justify-content:space-between; align-items:center; padding:14px; cursor:pointer">
                <div>
                  <div style="color:${i?"var(--blue)":"var(--text-light)"}; font-size:16px; font-weight:bold; margin-bottom:4px">
                    ${h.name} ${i?' <span style="font-size:12px; color:var(--text-dim)">(Đã Lĩnh Hội)</span>':""}
                  </div>
                  <div class="flex gap-2 items-center">
                    <span class="badge" style="background:${i?"rgba(59,130,246,0.2)":"var(--gold)"}">Bậc ${v[b]||b}</span>
              ...
              <div class="accordion-body" style="display:none; padding:14px; background:rgba(0,0,0,0.2); border-top:1px solid rgba(255,255,255,0.05)">
                <div class="text-sm text-dim mb-md italic" style="line-height:1.5">
                  "${m||i?h.description:"Sách cổ không thể nhìn thấu công dụng."}"
                </div>
                ...
                <div class="mt-md" style="display:flex; justify-content:flex-end">
                  ${i?'<button class="btn btn--sm" disabled style="opacity: 0.5">Đã Lĩnh Hội</button>':`<button class="btn ${y?"btn--dark":"btn--gold"} btn--sm btn-learn" ${y?'disabled title="Ngộ tính chưa đủ"':""} data-sid="${h.id}">Lĩnh Hội 📜</button>`}
                </div>
              </div>
            </div>
          `}).join("")}
  ...
  `,a.querySelectorAll(".accordion-header").forEach(h=>{h.addEventListener("click",()=>{const i=h.nextElementSibling;i.style.display==="none"?(i.style.display="block",h.querySelector("div:last-child").textContent="▲"):(i.style.display="none",h.querySelector("div:last-child").textContent="▼")})}),a.querySelectorAll(".btn-learn").forEach(h=>{h.addEventListener("click",async i=>{i.stopPropagation();try{const b=await r.learnSkill($.id,h.dataset.sid);b.error?d(b.error,"error"):(t.player=b.player,d(b.message,"success"),X(a,e))}catch(b){d("Lỗi học kỹ năng: "+b.message,"error")}})})}function ut(a,e){var b,y,m;const{state:t,api:r,notify:d,renderGame:$}=e,g=t.player,c=g.stats,u=g.allocatedStats||{},x=5,v=g.currentEnergy>=x&&!g.hospitalRemaining,h=g.talentDisplay||{},i=[["strength","💪","Sức mạnh","Tăng sát thương mỗi đòn"],["speed","🏃","Tốc độ","Tăng hit chance, giảm escape"],["dexterity","🎯","Khéo léo","Tăng dodge, escape, stealth"],["defense","🛡","Phòng thủ","Giảm sát thương nhận vào"]];a.innerHTML=`
    <div class="page-header">
      <h1>🏋 Rèn Luyện & Cảnh Giới</h1>
      <div class="actions">
        <span class="text-dim">🔮 ${g.currentEnergy}/${g.maxEnergy} linh lực · Chi phí: ${x}/lần</span>
      </div>
    </div>
      ...
      <div class="panel-body flex justify-between" style="align-items:center">
        <div>
          ...
          <div class="text-xl text-gold bold" style="text-shadow:0 0 10px rgba(255,215,0,0.3)">
            🌟 ${((b=g.realmInfo)==null?void 0:b.fullName)||"Phàm Nhân"}
          </div>
        </div>
        <div>
          ${(y=g.realmInfo)!=null&&y.canBreakthrough?'<button class="btn btn--gold btn--lg shadow-glow btn-breakthrough" style="animation:pulse 2s infinite">⚡ Đột Phá Cảnh Giới!</button>':'<div class="text-sm text-dim" style="opacity:0.6">Chưa đủ điều kiện đột phá</div>'}
        </div>
      </div>
    </div>
    ...
    <div class="panel" style="margin-bottom:12px">
      ...
      <div class="panel-body" style="padding:12px 16px">
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;text-align:center">
          ${i.map(([s,o,l])=>{const p=h[s]||{value:1,name:"Phàm Cốt",icon:"⚪",color:"#ccc"};return`
    ...
    <div class="panel">
      ...
      <div class="panel-body no-pad">
        ${i.map(([s,o,l,p])=>{const n=h[s]||{value:1,name:"Phàm Cốt",icon:"⚪",color:"#ccc"},f=Math.floor(g.currentEnergy/x)||0;return`
          <div class="stat-row" style="padding:12px 16px">
            <div class="stat-label">
              <span class="stat-icon">${o}</span> ${l}
            ...
            <div class="stat-val flex items-center gap-3">
              ...
              <button class="btn btn--sm ${v?"btn--blue":"btn--dark"} train-btn" data-train="${s}" ${v?"":"disabled"} title="Tốn ${x} Linh lực/lần · Căn cốt ×${n.value}">Rèn Luyện</button>
            </div>
          </div>
        `}).join("")}
        <div style="padding:8px 16px;font-size:11px;opacity:0.4;border-top:1px solid rgba(255,255,255,0.05)">
          💡 Rèn luyện tốn <strong>${x} linh lực</strong> / lần. Hiệu quả nhân với hệ số căn cốt. Tối đa <strong>${Math.floor(g.currentEnergy/x)}</strong> lần hiện tại.
        </div>
    ...
    </div>`,(m=a.querySelector(".btn-breakthrough"))==null||m.addEventListener("click",async()=>{try{const s=a.querySelector(".btn-breakthrough");s.disabled=!0,s.innerHTML="Đang Độ Kiếp...";const o=await r.attemptBreakthrough(t.playerId);t.player=o.player,d(o.message,"success"),$()}catch(s){d(s.message||"Đột phá thất bại","error");const o=a.querySelector(".btn-breakthrough");o&&(o.disabled=!1,o.innerHTML="⚡ Đột Phá Cảnh Giới!")}}),a.querySelectorAll(".train-btn").forEach(s=>{s.addEventListener("click",async o=>{o.stopPropagation();const l=a.querySelector(`.train-count[data-stat="${s.dataset.train}"]`),p=parseInt(l==null?void 0:l.value)||1;try{const n=await r.trainStat(t.playerId,s.dataset.train,p);t.player=n.player,d(n.message,"success"),$()}catch(n){d(n.message||"Lỗi rèn luyện","error")}})})}function Y(a,e){const{state:t,api:r,notify:d}=e,$=t.player.skills||[],g=$.map(u=>typeof u=="string"?u:u.id),c=$.map(u=>{const x=typeof u=="string"?u:u.id;return{...t.skills.find(h=>h.id===x)||{name:"Vô danh thủ thuật",id:x},level:u.level||1,currentXp:u.currentXp||0}});t.skills.filter(u=>!g.includes(u.id)),a.innerHTML=`
    <div class="page-header"><h1>⚡ Thần Thông</h1></div>

    <div class="panel">
      <div class="panel-title">Đã học (${c.length})</div>
      <div class="panel-body no-pad">
        ${c.length===0?'<div style="padding:14px" class="text-dim">Chưa lĩnh hội kỹ năng nào</div>':c.map(u=>{const x=u.type==="passive"&&(!u.tags||!u.tags.includes("movement")&&!u.tags.includes("thân pháp")),v=x?'<span class="text-xs text-dim">Vĩnh Viễn Kích Hoạt</span>':u.isEquipped?`<button class="btn btn--sm equip-btn" style="background:var(--red)" data-eq="0" data-sid="${u.id}">Tháo Gỡ</button>`:`<button class="btn btn--sm equip-btn" data-eq="1" data-sid="${u.id}">Trang Bị</button>`,h=u.isEquipped&&!x?'<span class="badge" style="background:var(--green)">Đang trang bị</span>':"";return`
            <div class="list-item flex flex-col items-start gap-4" style="${u.isEquipped&&!x?"border-left: 3px solid var(--green); background: rgba(50, 200, 100, 0.05);":""}">
              <div class="item-info w-full">
                <div class="flex justify-between items-center mb-xs">
                  <div class="item-name text-lg">${u.name} <span class="badge" style="background:var(--blue)">Tầng ${u.level}</span> ${h}</div>
    ...
    </div>`,a.querySelectorAll(".equip-btn").forEach(u=>{u.addEventListener("click",async()=>{try{const x=u.dataset.sid,v=u.dataset.eq==="1",h=await r.equipSkill(t.playerId,x,v);t.player=h.player,d(h.message,"success"),Y(a,e)}catch(x){d(x.message||"Lỗi trang bị","error")}})})}function vt(a,e){return e==="manual"?"📜":a==="weapon"?"⚔️":a==="body"?"🥋":a==="shield"?"🛡️":a==="feet"?"👢":a==="ring"?"💍":"📦"}function Q(a,e){let t="",r="";if(a.slot==="weapon"){let u=0,x=0;(a.affixes||[]).forEach(v=>{v.stat==="strength"&&v.type==="flat"&&(u+=v.value),v.stat==="dexterity"&&v.type==="flat"&&(x+=v.value)}),u===0&&(u=a.itemLevel*2+5),x===0&&(x=a.itemLevel+10),t=`⚔️ ${u}`,r=`🎯 ${x}`}else if(a.slot==="body"||a.slot==="shield"||a.slot==="feet"){let u=0;(a.affixes||[]).forEach(x=>{x.stat==="defense"&&x.type==="flat"&&(u+=x.value)}),u===0&&(u=a.itemLevel*3),t=`🛡️ ${u}`}else if(a.slot==="ring"){let u=0;(a.affixes||[]).forEach(x=>{x.stat==="capacity"&&(u+=x.value)}),t=u>0?`🎒 +${u}`:""}const d=(a.affixes||[]).map(u=>mt(u)).map(u=>`<span class="badge badge-dim">${u}</span>`).join(" "),$=a.description||`Một vật phẩm loại ${a.slot} cấp ${a.itemLevel} thuộc phẩm chất ${a.rarity}. Khí tức tỏa ra không tồi.`,g=a.craftedBy?`<div class="text-gold mt-xs" style="font-size:12px">⚒️ Đúc bởi: <strong>${a.craftedBy}</strong></div>`:"",c=e?a.category==="manual"?`<button class="btn btn--sm btn--gold" data-use="${a.id}">Sử Dụng</button>`:`<button class="btn btn--sm btn--blue" data-eid="${a.id}">Trang Bị</button>`:"";return`
    ...
    </div>`}function mt(a){const t={strength:"STR",speed:"SPD",dexterity:"DEX",defense:"DEF",critMultiplier:"CRIT MUL"}[a.stat]||a.stat,r=a.value>=0?"+":"";return a.type==="flat"?`${r}${a.value} ${t}`:a.type==="increase"?`${r}${a.value}% ${t}`:a.type==="more"?`×${r}${a.value}% ${t}`:`${r}${a.value} ${t}`}function K(a,e){var o,l,p,n,f,T,k;const{state:t,api:r,notify:d,renderGame:$}=e,g=Object.values(t.player.equipment||{}),c=t.player,u=t.medicines||[],x=c.medCooldownRemaining||0,v=t.inventoryTab||"equipped",h=c.skills&&c.skills.some(w=>{const L=typeof w=="string"?w:w.id;return L==="duoc_ly"||L==="y_thuat"}),i=g.find(w=>w.slot==="ring1"),b=g.find(w=>w.slot==="ring2");let y=20;((i==null?void 0:i.id)==="tui_tru_vat"||(o=i==null?void 0:i.baseType)!=null&&o.includes("tru_vat"))&&(y+=((p=(l=i.affixes)==null?void 0:l[0])==null?void 0:p.value)||10),((b==null?void 0:b.id)==="tui_tru_vat"||(n=b==null?void 0:b.baseType)!=null&&n.includes("tru_vat"))&&(y+=((T=(f=b.affixes)==null?void 0:f[0])==null?void 0:T.value)||10),a.innerHTML=`
    <div class="page-header">
      <h1>🎒 Túi Đồ <span style="font-size:14px;color:var(--text-dim)">(${(c.inventory||[]).length} / ${y})</span></h1>
    ...
    `,s()}a.querySelectorAll("[data-tab]").forEach(w=>{w.addEventListener("click",()=>{t.inventoryTab=w.dataset.tab,K(a,e)})}),(k=document.getElementById("btnGen"))==null||k.addEventListener("click",async()=>{const w=["common","rare","epic","legendary"];try{const L=await r.generateItem(t.playerId,w[Math.floor(Math.random()*w.length)]);t.player=L.player,t.items=L.items||[],d(L.message,"success"),K(a,e)}catch{d("Lỗi tạo ngẫu nhiên","error")}})}function ht(a,e){var p,n;const{state:t,api:r,notify:d,renderGame:$}=e,g=t.player,c=t.crimes||[];if((g.jailRemaining??0)>0){const f=g.jailRemaining,T=Math.max(10,100*Math.ceil(f/60)*g.level);a.innerHTML=`
      ...
      </div>`,(p=document.getElementById("btnEscape"))==null||p.addEventListener("click",async()=>{try{const k=await r.escapeJail(t.playerId);t.player=k.player,d(k.message,k.success?"success":"error"),$()}catch(k){d(k.message||"Lỗi","error")}}),(n=document.getElementById("btnBail"))==null||n.addEventListener("click",async()=>{try{const k=await r.bail(t.playerId);t.player=k.player,d(k.message,k.success?"success":"error"),$()}catch(k){d(k.message||"Lỗi","error")}});return}const x={theft:{label:"🧤 Trộm cắp",color:"var(--blue)"},fraud:{label:"🎭 Gian trá",color:"var(--purple)"},vandalism:{label:"🔥 Phá hoại",color:"var(--orange)"},intel:{label:"🕶️ Tình báo",color:"var(--cyan)"},trade:{label:"📦 Buôn bán",color:"var(--green)"},explore:{label:"⚰️ Thám hiểm",color:"var(--gold)"},combat:{label:"🗡️ Chiến đấu",color:"var(--red)"},ritual:{label:"🩸 Nghi lễ",color:"#c0392b"}},v={unlock_hidden_event:"🔓 Mở content ẩn",rare_material_drop:"✨ Nguyên liệu hiếm",random_buff:"⬆️ Buff ngẫu nhiên",random_debuff:"⬇️ Debuff khi thất bại",boss_encounter:"🐉 Gặp Boss",epic_loot:"🏺 Bảo vật hiếm",legendary_drop:"💎 Cổ vật truyền thuyết"},h=c.reduce((f,T)=>{const k=T.category||"theft";return f[k]||(f[k]=[]),f[k].push(T),f},{}),i=Object.keys(x).map(f=>{const T=h[f];if(!T||T.length===0)return"";const k=x[f];return`
    ...
    </div>`}).join(""),b=g.crimeExp||0,y=Math.floor(b/50),m=b%50,s=50,o=m/s*100,l=`
    <div class="panel mb-md" style="border-color: var(--gold)40; margin-bottom: 16px;">
      <div class="panel-body">
        ...
        <div class="bar-track">
          <div class="bar-fill" style="width:${o}%; background:var(--gold);"></div>
        </div>
  ...
  `;a.innerHTML=`
    ...
    ${l}
    ${i}`,a.querySelectorAll("[data-crime]").forEach(f=>{f.addEventListener("click",async()=>{try{const T=await r.commitCrime(t.playerId,f.dataset.crime);t.player=T.player;const k=T.outcome==="success"?"success":T.outcome==="critical_fail"?"error":"info";d(T.message,k),$()}catch(T){d(T.message||"Lỗi","error")}})})}function yt(a,e){var l;const{state:t,api:r,notify:d,renderGame:$}=e,g=t.player,c=t.educationTrees||[],u=g.unlockedNodes||[],x=g.studyingNode||"",v=x?x.split("|")[0]:"",h=g.studyEndsAt||0,i=Math.max(0,h-Math.floor(Date.now()/1e3)),b=g.treeProgress||{},y=g.skillProgress||{};let m=localStorage.getItem("eduActiveTree")||((l=c[0])==null?void 0:l.id),s=c.find(p=>p.id===m)||c[0];!s&&c.length>0&&(s=c[0]);const o=()=>{if(!s){a.innerHTML='<div class="p-lg">Chưa có dữ liệu tu luyện.</div>';return}const p=c.map(S=>`
      <button class="edu-tab ${S.id===s.id?"active":""}" data-tab="${S.id}">
        ...
        <span class="edu-tab-badge">${b[S.id]||0}</span>
      </button>
    `).join("");let n="";if(v){let S=null,P=null;c.forEach(I=>{const M=I.nodes.find(N=>N.id===v);M&&(S=M,P=I)}),S&&(n=`
          <div class="panel edu-studying-panel glass">
            <div class="panel-body text-center">
              ...
              <div class="edu-timer mt-sm">⏳ Còn lại: <strong id="eduCounter">${i}s</strong></div>
              <button class="btn btn--green btn--lg mt-md w-full" id="btnCheckEdu" ${i>0?"disabled":""}>
                ${i>0?"Đang Lãnh Ngộ...":"✨ Đột Phá!"}
              </button>
            </div>
          </div>
        `)}const f=b[s.id]||0;let T=null;for(const S of s.milestones||[])if(f<S.require){T=S;break}let k="";T?k=`
      ...
      `:k='<div class="text-green text-sm flex items-center gap-2"><div style="font-size:24px">🌟</div> Cảnh giới đã viên mãn! Không còn chướng ngại.</div>';const w=g.discoveredNodes||[],L=(s.nodes||[]).map(S=>{const P=u.includes(S.id),I=v===S.id,M=(S.prerequisites||[]).every(j=>u.includes(j)),N=s.nodes.some(j=>(j.prerequisites||[]).includes(S.id));if(!(w.includes(S.id)||P||!(S.prerequisites&&S.prerequisites.length>0))||P&&N)return"";let _="";I?_="studying":P?_="done":_="available";let B="";I?B='<button class="btn btn--sm" disabled>Đang Lãnh Ngộ...</button>':v?B='<button class="btn btn--sm" disabled>Tâm trí bận rộn</button>':P?B=`<button class="btn btn--sm btn--gold btn-learn" data-node="${S.id}">Tiếp Tục Lãnh Ngộ (${S.duration}s)</button>`:M?B=`<button class="btn btn--sm btn--blue btn-learn" data-node="${S.id}">Bắt Đầu (${S.duration}s)</button>`:B='<button class="btn btn--sm" disabled>Chưa đả thông kinh mạch</button>';const G=y[S.id]||{level:1,exp:0},dt=G.level*100;let U="";return P&&(U=`<div class="text-xs text-gold mt-xs">Cảnh giới: ${G.level} | Độ hiểu thấu: ${G.exp}/${dt}</div>`),`
    ...
    `,a.querySelectorAll(".edu-tab").forEach(S=>{S.addEventListener("click",()=>{const P=S.dataset.tab;localStorage.setItem("eduActiveTree",P),m=P,s=c.find(I=>I.id===P)||c[0],o()})}),window.eduTimer&&clearInterval(window.eduTimer),v&&h>0&&(window.eduTimer=setInterval(()=>{const S=Math.floor(Date.now()/1e3);let P=Math.max(0,h-S);const I=document.getElementById("eduCounter");if(I&&(I.innerText=P+"s"),P<=0){clearInterval(window.eduTimer);const M=document.getElementById("btnCheckEdu");M&&(M.disabled=!1,M.innerHTML="✨ Đột Phá!")}},1e3));const E=a.querySelector("#btnCheckEdu");E&&E.addEventListener("click",async()=>{try{E.disabled=!0,E.innerHTML="Đang xử lý...";const S=await r.checkEducation(t.playerId);t.player=S.player,d(S.message,S.completed?"success":"info"),$()}catch(S){d(S.message||"Lỗi đột phá","error"),E.disabled=!1,E.innerHTML="Thử lại"}}),a.querySelectorAll(".btn-learn").forEach(S=>{S.addEventListener("click",async()=>{try{const P=S.dataset.node;S.disabled=!0,S.innerHTML="Chờ...";const I=await r.enrollNode(t.playerId,P,s.id);t.player=I.player,d(I.message,"success"),$()}catch(P){d(P.message||"Lỗi ghi danh","error"),S.disabled=!1,S.innerHTML="Bắt Đầu"}})})};o()}function Z(a,e){const{state:t,api:r,notify:d,updateSidebar:$,renderGame:g}=e,c=t.playerId;t._dungeon||(t._dungeon={mapItems:[],activeRun:null,history:[],loaded:!1,combatLog:[],lastLoot:[],lastResult:null});const u=t._dungeon;async function x(){try{const[s,o]=await Promise.all([r.getMapItems(c),r.getDungeonHistory(c)]);u.mapItems=s.mapItems||[],u.activeRun=s.activeRun||null,u.history=o.history||[],u.loaded=!0,v()}catch(s){d(s.message||"Lỗi tải Bí Cảnh","error")}}function v(){a.innerHTML=`
      ...
      ${y()}
    `,m()}function h(){var p,n;const s=u.activeRun,o=s.currentWave===s.totalWaves,l=((s.currentWave-1)/s.totalWaves*100).toFixed(0);return`
        ...
        <div class="panel-body" style="padding:14px 16px">
          ...
          <div style="display:flex;gap:8px">
            <button class="btn btn--gold" id="btnFight" ${((p=t.player)==null?void 0:p.hospitalRemaining)>0?"disabled":""}>
              ${o?"🐉 Đánh Boss!":"⚔️ Chiến Đấu Tầng "+s.currentWave}
            </button>
    ...
    `}function i(){return u.mapItems.length===0?`
        <div class="panel">
      ...
      <div class="panel">
        ...
        <div class="panel-body no-pad">
          ${u.mapItems.map(s=>{const o=s.dungeon;return`
              <div class="list-item" style="padding:12px 16px">
                ...
                ${o?`<button class="btn btn--sm btn--gold" data-enter="${s.item.id}">⚡ Kích Hoạt</button>`:""}
              </div>
            `}).join("")}
        </div>
      </div>
    `}function b(){var p,n;const s=u.lastResult,o=s.result==="dungeon_complete"?"🏆":s.result==="wave_cleared"?"✅":"💀",l=s.result==="dungeon_failed"?"var(--red)":"var(--gold)";return`
      <div class="panel" style="margin-bottom:12px;border-color:${l}">
        <div class="panel-title" style="color:${l}">${o} Kết Quả</div>
        <div class="panel-body" style="padding:12px 16px">
    ...
    `}function y(){return u.history.length===0?"":`
      <div class="panel" style="margin-top:12px">
        <div class="panel-title">📚 Lịch Sử Bí Cảnh</div>
        <div class="panel-body no-pad" style="max-height:200px;overflow-y:auto">
          ${u.history.map(s=>{const o=s.status==="completed"?"✅":s.status==="failed"?"❌":s.status==="abandoned"?"🚪":"⏳";return`
              <div class="list-item" style="padding:8px 14px;font-size:12px">
                <span style="color:${s.status==="completed"?"var(--green)":s.status==="failed"?"var(--red)":"var(--orange)"}">${o} ${s.dungeonName}</span>
                <span style="opacity:0.4;margin-left:auto">Tầng ${s.wave}/${s.totalWaves} · ${new Date(s.startedAt).toLocaleDateString("vi-VN")}</span>
              </div>
            `}).join("")}
        </div>
      </div>
    `}function m(){var s,o;document.querySelectorAll("[data-enter]").forEach(l=>{l.addEventListener("click",async()=>{const p=l.dataset.enter;if(confirm("⚡ Kích hoạt Ngọc Giản và vào Bí Cảnh?")){l.disabled=!0;try{const n=await r.enterDungeon(c,p);d(n.message,"success"),t.player=n.player,$(),u.activeRun=n.run,u.lastResult=null,await x()}catch(n){d(n.message,"error"),l.disabled=!1}}})}),(s=document.getElementById("btnFight"))==null||s.addEventListener("click",async()=>{const l=document.getElementById("btnFight");l.disabled=!0,l.textContent="⏳ Đang chiến đấu...";try{const p=await r.fightDungeonWave(c);t.player=p.player,$(),u.lastResult=p,p.result==="dungeon_complete"||p.result==="dungeon_failed"?u.activeRun=null:p.result==="wave_cleared"&&(u.activeRun.currentWave=p.nextWave),v()}catch(p){d(p.message,"error"),l.disabled=!1,l.textContent="⚔️ Chiến Đấu"}}),(o=document.getElementById("btnAbandon"))==null||o.addEventListener("click",async()=>{if(confirm("🚪 Bỏ cuộc? Ngọc Giản sẽ không được hoàn lại!"))try{await r.abandonDungeon(c),d("Đã rời khỏi Bí Cảnh.","info"),u.activeRun=null,u.lastResult=null,await x()}catch(l){d(l.message,"error")}})}u.loaded?v():x()}function tt(a,e){const{state:t}=e,r=t._travelTab||"map";a.innerHTML=`
    <div class="page-header">
      <h1>🗺️ Ngao Du</h1>
  ...
  `,a.querySelectorAll(".tab-btn").forEach($=>{$.addEventListener("click",()=>{t._travelTab=$.dataset.tab,tt(a,e)})});const d=a.querySelector("#travelTabContent");r==="map"?O(d,e):Z(d,e)}async function O(a,e){const{state:t,api:r,notify:d,updateSidebar:$}=e;a.innerHTML='<div class="loading" style="padding:20px; text-align:center">Đang mở địa đồ...</div>';try{const[g,c]=await Promise.all([r.request("/data/areas"),r.request(`/player/${t.playerId}/area`)]),u=g.areas||[],x=c.area,v=c.player,h=c.traveling||!1,i=c.travelRemaining||0,b=c.travelDestination||"";c.message&&d(c.message,"success"),c.player&&(t.player=c.player,$());const y=t.exploration||{},m=y[(v==null?void 0:v.currentArea)||"thanh_lam_tran"],s=(x==null?void 0:x.name)||(m==null?void 0:m.name)||"Vùng Đất Vô Danh",o=(m==null?void 0:m.staminaCost)||10,l={hac_phong_lam:"🌲 Rừng rậm: +5% Tốc Độ",vong_linh_coc:"👻 Âm khí: +10% Nhanh Nhẹn",thiet_huyet_son:"🌋 Nóng bức: +10% ST Hỏa",thien_kiep_uyen:"⚡ Lôi điện: +15% Tốc Độ",bac_suong_canh:"❄️ Đóng băng: -10% Tốc Độ",am_sat_hoang:"🎯 Sát khí: +15 Nhanh Nhẹn",co_moc_linh_vien:"🌳 Linh mộc: +15% Phòng Ngự",huyet_ma_chien_truong:"🩸 Huyết chiến: +30% ST, +20% ST nhận",thien_hoa_linh_dia:"🔥 Địa hỏa: +25% ST Hỏa",u_minh_quy_vuc:"💀 U minh: -15% Phòng Ngự",thien_dao_tan_tich:"✨ Thiên đạo: +15% Toàn Chỉ Số",vo_tan_hu_khong:"🌀 Hỗn loạn: +50% ST Gây & Nhận"},p=l[v==null?void 0:v.currentArea]||"",n=[...u].sort((T,k)=>(T.sort_order||T.mapY||0)-(k.sort_order||k.mapY||0)),f=[...u].sort((T,k)=>(T.mapY||0)-(k.mapY||0));if(a.innerHTML=`
      ${h?`
        <div class="panel glass" style="border-color:var(--gold); box-shadow:0 0 20px rgba(255,215,0,0.1)">
          <div class="panel-body" style="text-align:center; padding: 24px">
            ...
            <div id="travelTimer" style="font-size:24px; font-weight:bold; color:var(--gold); margin:12px 0; text-shadow:0 0 10px rgba(255,215,0,0.3)">⏳ ${i}s</div>
          ...
          <div class="panel-body" style="padding: 14px 16px">
            <div class="flex items-center justify-between">
              ...
              <div style="text-align:right">
                ...
                <div class="text-gold bold">-${o}/lần</div>
              </div>
            </div>
            ${x!=null&&x.description?`<div class="text-sm text-dim" style="margin-top:6px">${x.description}</div>`:""}
            <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:8px">
              <span class="badge" style="background:rgba(255,255,255,0.08);font-size:11px">Lv.${(x==null?void 0:x.min_level)||1}+</span>
      ...
      <div class="panel mt-md">
        ...
        <div class="panel-body no-pad" style="position:relative; width:100%; height:300px; background-color: #0f172a; background-image: radial-gradient(rgba(255,255,255,0.05) 1px, transparent 1px); background-size: 20px 20px; overflow:hidden; border-radius:0 0 8px 8px">
          ...
          ${f.map(T=>{const k=y[T.id],w=T.id===v.currentArea&&!h,L=v.level<(T.min_level||1),E=(k==null?void 0:k.mapX)||50,S=(k==null?void 0:k.mapY)||50,P=w?"var(--green)":L?"var(--red)":"var(--blue)",I=w?`box-shadow: 0 0 15px ${P}; animation: pulse 2s infinite`:"",M=!w&&!L&&!h;return`
      ...
      <div class="panel mt-md">
        ...
        <div class="panel-body no-pad" style="max-height: 300px; overflow-y:auto">
          ${n.map(T=>{const k=y[T.id],w=T.id===v.currentArea&&!h,L=v.level<(T.min_level||1),E=parseInt(T.travel_time)||0,S=(k==null?void 0:k.staminaCost)||"?",P=l[T.id]||"";return`
              <div class="list-item ${w||L?"":"clickable"}" ${!w&&!L&&!h?`data-travel="${T.id}"`:""} style="padding: 10px 14px">
                <div class="item-info" style="flex:1">
      ...
      </div>`,a.querySelectorAll("[data-travel]").forEach(T=>{T.addEventListener("click",async k=>{k.stopPropagation();const w=T.dataset.travel;a.querySelectorAll("[data-travel]").forEach(L=>{L.tagName==="BUTTON"&&(L.disabled=!0),L.style.pointerEvents="none"});try{const L=await r.request(`/player/${t.playerId}/travel`,{method:"POST",body:JSON.stringify({areaId:w})});L.player&&(t.player=L.player,$()),d(L.message,"success"),O(a,e)}catch(L){d(L.message||"Lỗi di chuyển!","error"),O(a,e)}})}),h&&i>0){let T=i;const k=i,w=setInterval(async()=>{T--;const L=document.getElementById("travelTimer"),E=document.getElementById("travelBar");if(L&&(L.textContent=`⏳ ${Math.max(0,T)}s`),E&&(E.style.width=`${Math.max(0,T/k*100)}%`),T<=0){clearInterval(w);try{const S=await r.request(`/player/${t.playerId}/travel-check`,{method:"POST"});S.player&&(t.player=S.player,$()),S.arrived&&d(S.message,"success"),O(a,e)}catch{O(a,e)}}},1e3)}}catch(g){a.innerHTML='<div class="panel"><div class="panel-body text-dim">Lỗi tải dữ liệu khu vực</div></div>',console.error(g)}}function F(a,e){var l,p;const{state:t,renderGame:r,notify:d,updateSidebar:$}=e,g=t.player,c=t.recipes||[],u=t.medicines||[],x=t._alchemyTab||"recipes",v=n=>{const f=u.find(T=>T.id===n);return f?(f.icon||"💊")+" "+f.name:n};let h=0,i=0,b=0,y=0;(g.skills||[]).forEach(n=>{const f=typeof n=="string"?n:n.id,T=typeof n=="string"?1:n.level||1;f==="tinh_che"&&(h=T*2),f==="phu_an_thuat"&&(i=T*5),f==="linh_kiem_thuat"&&(b=T*10),f==="cuong_hoa_thuat"&&(y=T*15)});const m=n=>n.split("_").map(f=>f.charAt(0).toUpperCase()+f.slice(1)).join(" "),s=[];Object.values(g.equipment||{}).forEach(n=>{n&&s.push({...n,loc:"eq"})}),(g.inventory||[]).filter(n=>n.slot&&n.slot!=="consumable").forEach(n=>s.push({...n,loc:"inv"}));let o=`
    <div class="page-header">
  ...
  `;if(x==="recipes"){if(o+=`<div class="panel"><div class="panel-title">🌿 Khí Hải Tàng Trữ (Nguyên Liệu)</div>
      <div class="panel-body flex gap-2" style="overflow-x:auto;padding-bottom:12px;white-space:nowrap">`,!g.materials||Object.keys(g.materials).length===0)o+='<div style="color:var(--text-dim);font-size:14px;padding:8px 0">Nguyên liệu trống không...</div>';else for(const[n,f]of Object.entries(g.materials))o+=`<div class="badge" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);padding:4px 8px">${m(n)} <span style="color:var(--gold)">x${f}</span></div>`;o+="</div></div>",o+='<div class="panel"><div class="panel-title">🔥 Bản Ghi Công Thức</div><div class="panel-body no-pad">',c.length===0?o+='<div style="padding:16px" class="text-dim">Chưa có công thức...</div>':c.forEach(n=>{var E;const f=v(n.target),T=Math.min(100,(n.successRate||100)+h);let k="";(E=n.requirements)!=null&&E.skill&&(k=`<div class="text-orange" style="font-size:12px;margin-bottom:8px">Yêu cầu: ${m(n.requirements.skill)} lv${n.requirements.level||1}</div>`);let w="";n.materials.forEach(S=>{var I;const P=((I=g.materials)==null?void 0:I[S.id])||0;w+=`<span style="font-size:13px;margin-right:12px;display:inline-block;background:rgba(255,255,255,0.05);padding:2px 6px;border-radius:4px"><span style="color:${P>=S.amount?"var(--green)":"var(--red)"};font-weight:bold">${P}/${S.amount}</span> ${m(S.id)}</span>`});const L=u.find(S=>S.id===n.target)||{};o+=`
          <div class="list-item" style="flex-direction:column;padding:0;align-items:stretch">
        ...
        ${[{id:"tay_tuy_phu",name:"Tẩy Tủy Phù",icon:"🔄",desc:"Xóa toàn bộ affix và roll lại",cost:200},{id:"hon_chu_phu",name:"Hỗn Chú Phù",icon:"➕",desc:"Thêm 1 affix (tối đa 4)",cost:500},{id:"thien_menh_phu",name:"Thiên Mệnh Phù",icon:"🔒",desc:"Khóa 1 affix, reroll còn lại",cost:1e3},{id:"thang_cap_phu",name:"Thăng Cấp Phù",icon:"⬆️",desc:"Tăng item level +1 (max +5)",cost:1500}].map(n=>{const f=Math.max(1,Math.round(n.cost*(1-i/100)));return`
            <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:12px">
              ...
              <button class="btn btn--gold btn--sm btn-currency" data-cid="${n.id}" style="width:100%">
                💎 ${f} ${i>0?`<s style="opacity:0.4;font-size:10px">${n.cost}</s>`:""}
              </button>
            </div>`}).join("")}
      </div>
...
`)}`);if(E===null)return;if(k=parseInt(E),isNaN(k)||k<0||k>=L.length)return d("Chỉ số không hợp lệ!","error")}n.disabled=!0,n.textContent="⏳...";try{const w=await q.applyCurrency(g.id,T,f.value,k);d(w.message,"success"),t.player=w.player,$(),F(a,e)}catch(w){d(w.message,"error"),n.disabled=!1,n.textContent="💎 Dùng"}})}),(l=document.getElementById("selItem"))==null||l.addEventListener("change",()=>{const n=s.find(T=>T.id===document.getElementById("selItem").value),f=document.getElementById("itemPreview");n&&f&&(f.innerHTML=(n.affixes||[]).map(T=>`<span style="color:var(--blue)">• ${T.name||T.stat} +${T.value}</span>`).join(" | ")||"Không có affix")}),(p=document.getElementById("selItem"))==null||p.dispatchEvent(new Event("change"))}function bt(a,e){const{state:t,api:r,notify:d,renderGame:$}=e;t.player,a.innerHTML=`
  ...
  `,g();async function g(){try{const u=(await r.getQuests(t.playerId)).quests||[],x=document.getElementById("questList");if(!x)return;if(u.length===0){x.innerHTML=`
    ...
    <div class="admin-layout">
      <div class="admin-tabs" id="adminTabs">
        ${g.map(o=>`
          <button class="admin-tab ${o.id===c?"active":""}" data-tab="${o.id}">${o.label}</button>
        `).join("")}
      </div>
  ...
  `,document.getElementById("adminTabs").addEventListener("click",o=>{const l=o.target.closest(".admin-tab");l&&(c=l.dataset.tab,document.querySelectorAll(".admin-tab").forEach(p=>p.classList.remove("active")),l.classList.add("active"),u(c))}),u(c);async function u(o){const l=document.getElementById("adminContent");if(l){l.innerHTML='<div class="loading-spinner">⏳ Đang tải...</div>';try{const p=await r.request(`/admin/${o}?adminId=${t.playerId}`);x(o,p,l)}catch(p){l.innerHTML=`<div class="panel"><div class="panel-body text-red">Lỗi: ${p.message}</div></div>`}}}function x(o,l,p){o==="monsters"?v(l,p):o==="npcs"?h(l,p):o==="areas"?i(l,p):b(o,l,p)}function v(o,l){const p=o.monsters||[];l.innerHTML=`
        ...
        ${p.map(n=>{var f,T,k,w,L,E,S,P;return`
          <div class="admin-card" data-id="${n.id}">
            <div class="admin-card-header">
              ...
              <span class="badge" style="background:${((T=(f=o.tierInfo)==null?void 0:f[n.tier])==null?void 0:T.color)||"#888"}">${((w=(k=o.tierInfo)==null?void 0:k[n.tier])==null?void 0:w.name)||"T"+n.tier}</span>
            </div>
    ...
    `,m(l,o,"monsters","monsters")}function h(o,l){const p=o.npcs||[];l.innerHTML=`
      <div class="admin-table-header">
    ...
    `,m(l,o,"npcs","npcs")}function i(o,l){const p=Object.keys(o);l.innerHTML=`
      <div class="admin-table-header">
        <span class="text-dim">${p.length} khu vực</span>
      </div>
      <div class="admin-grid">
        ${p.map(n=>{const f=o[n];return`
    ...
    `,l.querySelectorAll(".admin-edit-area").forEach(n=>{n.addEventListener("click",()=>{const f=n.dataset.id,T=o[f];y(f,T,`areas/${f}`)})})}function b(o,l,p){var T;const n=JSON.stringify(l,null,2),f=n.split(`
`).length;p.innerHTML=`
      <div class="admin-table-header">
    ...
    `,(T=document.getElementById("btnSaveGeneric"))==null||T.addEventListener("click",async()=>{try{const k=document.getElementById("genericEditor").value,w=JSON.parse(k);d("Generic save chưa hỗ trợ — vui lòng dùng editor chi tiết.","error")}catch(k){d("JSON không hợp lệ: "+k.message,"error")}})}function y(o,l,p,n){const f=JSON.stringify(l,null,2),T=document.createElement("div");T.className="admin-modal-overlay",T.innerHTML=`
    ...
    `,document.body.appendChild(T),T.querySelectorAll(".admin-modal-close").forEach(k=>{k.addEventListener("click",()=>T.remove())}),T.addEventListener("click",k=>{k.target===T&&T.remove()}),document.getElementById("btnModalSave").addEventListener("click",async()=>{try{const k=document.getElementById("modalEditor").value,w=JSON.parse(k);await r.request(`/admin/${p}?adminId=${t.playerId}`,{method:"PUT",body:JSON.stringify({data:w})}),d("✅ Đã lưu!","success"),T.remove(),u(c)}catch(k){d("Lỗi: "+k.message,"error")}})}function m(o,l,p,n){o.querySelectorAll(".admin-edit-btn").forEach(f=>{f.addEventListener("click",()=>{const T=f.dataset.id,w=(l[n]||[]).find(L=>L.id===T);w&&y(T,w,`${p}/${T}`)})})}function s(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}function et(a,e){const{state:t,api:r,notify:d,renderGame:$,updateSidebar:g}=e,c=t.playerId;t._social||(t._social={tab:"friends",searchQuery:"",searchResults:[],relationships:{friends:[],enemies:[],pendingSent:[],pendingReceived:[]},loaded:!1});const u=t._social;async function x(){try{const m=await r.getRelationships(c);u.relationships=m,u.loaded=!0,v()}catch(m){d(m.message||"Lỗi tải dữ liệu Giao Tế","error")}}function v(){const{friends:m,enemies:s,pendingSent:o,pendingReceived:l}=u.relationships,p=l.length;a.innerHTML=`
      <div class="page-header">
        <h2>🤝 Đạo Hữu</h2>
    ...
    `,y()}function h(m){return m.length===0?'<div style="text-align:center;opacity:0.5;padding:20px">Chưa có đạo hữu nào. Hãy tìm kiếm và kết giao!</div>':m.map(s=>`
    ...
    `).join("")}function i(m){return m.length===0?'<div style="text-align:center;opacity:0.5;padding:20px">Không có kẻ thù. Giang hồ thái bình!</div>':m.map(s=>`
      <div class="social-row" style="display:flex;align-items:center;justify-content:space-between;padding:10px;border-bottom:1px solid rgba(255,255,255,0.05)">
        <div>
    ...
    `).join("")}function b(m,s){let o="";return m.length>0&&(o+='<div style="font-weight:600;margin-bottom:8px;color:var(--gold)">📥 Lời mời nhận được</div>',o+=m.map(l=>`
        <div class="social-row" style="display:flex;align-items:center;justify-content:space-between;padding:10px;border-bottom:1px solid rgba(255,255,255,0.05)">
          <div>
      ...
      `).join("")),s.length>0&&(o+='<div style="font-weight:600;margin-top:16px;margin-bottom:8px;opacity:0.7">📤 Lời mời đã gửi</div>',o+=s.map(l=>`
      ...
      `).join("")),m.length===0&&s.length===0&&(o='<div style="text-align:center;opacity:0.5;padding:20px">Không có lời mời nào.</div>'),o}function y(){var m,s;(m=document.getElementById("btnSearch"))==null||m.addEventListener("click",async()=>{var l;const o=(l=document.getElementById("socialSearch"))==null?void 0:l.value.trim();if(!o||o.length<2)return d("Cần ít nhất 2 ký tự","error");u.searchQuery=o;try{const p=await r.searchPlayers(o);u.searchResults=p.players||[],v()}catch(p){d(p.message,"error")}}),(s=document.getElementById("socialSearch"))==null||s.addEventListener("keydown",o=>{var l;o.key==="Enter"&&((l=document.getElementById("btnSearch"))==null||l.click())}),document.querySelectorAll("[data-tab]").forEach(o=>{o.addEventListener("click",()=>{u.tab=o.dataset.tab,v()})}),document.querySelectorAll("[data-action]").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.action,p=o.dataset.target;o.disabled=!0;try{let n;switch(l){case"add-friend":n=await r.addFriend(c,p);break;case"accept-friend":n=await r.acceptFriend(c,p);break;case"reject-friend":n=await r.rejectFriend(c,p);break;case"remove-friend":n=await r.removeFriend(c,p);break;case"add-enemy":n=await r.addEnemy(c,p);break;case"remove-enemy":n=await r.removeEnemy(c,p);break}d(n.message||"Thành công!","success"),await x()}catch(n){d(n.message||"Lỗi!","error"),o.disabled=!1}})})}u.loaded?v():x()}function at(a,e){const{state:t,api:r,notify:d}=e,$=t.playerId;t._chat||(t._chat={tab:"global",globalMessages:[],privateMessages:[],friends:[],selectedFriend:null,lastGlobalId:0,lastPrivateId:0,pollTimer:null,loaded:!1});const g=t._chat;async function c(){try{const[s,o]=await Promise.all([r.getGlobalChat(),r.getChatFriends($)]);g.globalMessages=s.messages||[],g.friends=o.friends||[],g.globalMessages.length>0&&(g.lastGlobalId=g.globalMessages[g.globalMessages.length-1].id),g.loaded=!0,v(),u()}catch(s){d(s.message||"Lỗi tải chat","error")}}function u(){x(),g.pollTimer=setInterval(async()=>{try{if(g.tab==="global"){const s=await r.getGlobalChat(g.lastGlobalId);s.messages&&s.messages.length>0&&(g.globalMessages.push(...s.messages),g.globalMessages.length>100&&(g.globalMessages=g.globalMessages.slice(-100)),g.lastGlobalId=g.globalMessages[g.globalMessages.length-1].id,i(),b())}else if(g.tab==="private"&&g.selectedFriend){const s=await r.getPrivateChat($,g.selectedFriend.id,g.lastPrivateId);s.messages&&s.messages.length>0&&(g.privateMessages.push(...s.messages),g.privateMessages.length>100&&(g.privateMessages=g.privateMessages.slice(-100)),g.lastPrivateId=g.privateMessages[g.privateMessages.length-1].id,i(),b())}}catch{}},5e3)}function x(){g.pollTimer&&(clearInterval(g.pollTimer),g.pollTimer=null)}function v(){const s=g.tab==="global"?g.globalMessages:g.privateMessages;a.innerHTML=`
      <div class="page-header">
      ...
      <div class="chat-tabs" style="display:flex;gap:8px;margin-bottom:12px">
        ...
        ${g.tab==="private"?`
          <select id="friendSelect" style="flex:1;padding:4px 8px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:6px;color:#eee;font-size:13px">
            ...
            ${g.friends.map(o=>{var l;return`<option value="${o.id}" ${((l=g.selectedFriend)==null?void 0:l.id)===o.id?"selected":""}>${o.name} (Lv.${o.level})</option>`}).join("")}
          </select>
        `:""}
      </div>
    ...
    `,m(),b()}function h(s){return s.length===0?'<div style="text-align:center;opacity:0.4;padding:40px">Chưa có tin nhắn nào...</div>':s.map(o=>{const l=o.sender_id===$,p=new Date(o.created_at).toLocaleTimeString("vi-VN",{hour:"2-digit",minute:"2-digit"});return`
        <div style="padding:4px 0;${l?"text-align:right":""}">
          <span style="font-size:11px;opacity:0.4">${p}</span>
          <span style="font-weight:600;color:${l?"var(--blue)":"var(--gold)"}"> ${o.sender_name}</span>
          <span style="opacity:0.8">: ${y(o.message)}</span>
        </div>
      `}).join("")}function i(){const s=document.getElementById("chatMessages");if(!s)return;const o=g.tab==="global"?g.globalMessages:g.privateMessages;s.innerHTML=h(o)}function b(){const s=document.getElementById("chatMessages");s&&(s.scrollTop=s.scrollHeight)}function y(s){const o=document.createElement("div");return o.textContent=s,o.innerHTML}function m(){var o,l,p;document.querySelectorAll("[data-chat-tab]").forEach(n=>{n.addEventListener("click",()=>{g.tab=n.dataset.chatTab,g.tab==="global"&&(g.lastGlobalId=g.globalMessages.length>0?g.globalMessages[g.globalMessages.length-1].id:0),v(),u()})}),(o=document.getElementById("friendSelect"))==null||o.addEventListener("change",async n=>{const f=n.target.value;if(!f){g.selectedFriend=null,g.privateMessages=[],v();return}g.selectedFriend=g.friends.find(T=>T.id===f)||null,g.lastPrivateId=0;try{const T=await r.getPrivateChat($,f);g.privateMessages=T.messages||[],g.privateMessages.length>0&&(g.lastPrivateId=g.privateMessages[g.privateMessages.length-1].id),i(),b()}catch(T){d(T.message,"error")}});const s=async()=>{var T,k;const n=document.getElementById("chatInput"),f=n==null?void 0:n.value.trim();if(f){if(g.tab==="private"&&!g.selectedFriend)return d("Chọn Đạo Hữu trước!","error");try{if(await r.sendChat($,g.tab,g.tab==="private"?g.selectedFriend.id:null,f),n.value="",g.tab==="global"){const w=await r.getGlobalChat(g.lastGlobalId);((T=w.messages)==null?void 0:T.length)>0&&(g.globalMessages.push(...w.messages),g.lastGlobalId=g.globalMessages[g.globalMessages.length-1].id)}else{const w=await r.getPrivateChat($,g.selectedFriend.id,g.lastPrivateId);((k=w.messages)==null?void 0:k.length)>0&&(g.privateMessages.push(...w.messages),g.lastPrivateId=g.privateMessages[g.privateMessages.length-1].id)}i(),b()}catch(w){d(w.message||"Lỗi gửi tin nhắn","error")}}};(l=document.getElementById("btnSend"))==null||l.addEventListener("click",s),(p=document.getElementById("chatInput"))==null||p.addEventListener("keydown",n=>{n.key==="Enter"&&s()})}e.renderGame,g.loaded?(v(),u()):c()}function ft(a,e){const{state:t,api:r,notify:d,updateSidebar:$}=e,g=t.playerId;t._market||(t._market={tab:"browse",filter:"",sort:"newest",search:"",listings:[],myListings:[],mugTargets:[],mugLog:[],mugCooldown:0,loaded:!1,showListForm:!1});const c=t._market;async function u(){try{const[s,o]=await Promise.all([r.getMarketListings(c.filter,c.sort),r.getMyListings(g)]);c.listings=s.listings||[],c.myListings=o.listings||[],c.loaded=!0,v()}catch(s){d(s.message||"Lỗi tải Giao Dịch Đài","error")}}async function x(){try{const[s,o]=await Promise.all([r.getMugTargets(g),r.getMugLog(g)]);c.mugTargets=s.targets||[],c.mugCooldown=s.mugCooldown||0,c.mugLog=o.logs||[],v()}catch(s){d(s.message||"Lỗi tải dữ liệu Cướp Đoạt","error")}}function v(){const s=t.player;a.innerHTML=`
      <div class="page-header">
        <h2>🏪 Giao Dịch Đài</h2>
    ...
    `,o=c.listings;if(c.search.trim()){const l=c.search.toLowerCase().trim();o=o.filter(p=>{var n;return p.item_name.toLowerCase().includes(l)?!0:(n=p.item_data)!=null&&n.affixes?p.item_data.affixes.some(f=>(f.stat||"").toLowerCase().includes(l)||(f.type||"").toLowerCase().includes(l)):!1})}return o.length===0?s+='<div class="panel"><div class="panel-body" style="text-align:center;opacity:0.5;padding:30px">Không tìm thấy sạp hàng nào.</div></div>':(s+='<div class="panel"><div class="panel-body no-pad" style="max-height:400px;overflow-y:auto">',s+=o.map(l=>{var k,w;const p=l.item_type==="item"?"⚔️":l.item_type==="material"?"🧱":"💊",n=((k=l.item_data)==null?void 0:k.rarity)||"",f=l.seller_id===g,T=(w=l.item_data)!=null&&w.affixes?l.item_data.affixes.map(L=>`${L.stat} ${L.type==="flat"?"+":""}${L.value}${L.type!=="flat"?"%":""}`).join(", "):"";return`
        ...
        `}).join(""),s+="</div></div>"),s}function i(){if(c.myListings.length===0)return'<div class="panel"><div class="panel-body" style="text-align:center;opacity:0.5;padding:30px">Bạn chưa đăng bán gì.</div></div>';let s='<div class="panel"><div class="panel-body no-pad">';return s+=c.myListings.map(o=>`
        <div class="list-item" style="padding:10px 14px">
          <div class="item-info">
      ...
      `).join(""),s+="</div></div>",s}function b(){let s=`
    ...
    `;return c.mugTargets.length===0?s+='<div style="text-align:center;opacity:0.5;padding:20px">Không có mục tiêu nào ở khu vực này.</div>':s+=c.mugTargets.map(o=>`
        <div class="list-item" style="padding:8px 14px">
          ...
          <button class="btn btn--sm btn--red" data-mug="${o.id}" ${c.mugCooldown>0?"disabled":""}>💀 Phục Kích</button>
        </div>
      `).join(""),s+="</div></div>",c.mugLog.length>0&&(s+=`
        <div class="panel" style="margin-top:12px">
          <div class="panel-title">📜 Lịch Sử Phục Kích</div>
          <div class="panel-body no-pad" style="max-height:200px;overflow-y:auto">
            ${c.mugLog.map(o=>{const l=o.attacker_id===g,p=o.outcome==="success"?"✅":"❌",n=o.outcome==="success"?"var(--green)":"var(--red)",f=l?o.outcome==="success"?`Cướp ${o.victim_name}: +${o.gold_stolen} 💎`:`Phục kích ${o.victim_name} thất bại!`:o.outcome==="success"?`Bị ${o.attacker_name} cướp: -${o.gold_stolen} 💎`:`${o.attacker_name} phục kích bạn thất bại!`;return`<div class="list-item" style="padding:6px 14px;font-size:12px;color:${n}">${p} ${f} <span style="opacity:0.4;margin-left:auto">${new Date(o.created_at).toLocaleString("vi-VN")}</span></div>`}).join("")}
          </div>
        </div>
      `),s}function y(s){const o=Object.entries(s.materials||{}).map(([f,T])=>({id:f,qty:T,type:"material",name:f})),l=Object.entries(s.medicines||{}).map(([f,T])=>({id:f,qty:T,type:"medicine",name:f})),p=(s.inventory||[]).map(f=>({id:f.id,qty:1,type:"item",name:f.name||f.id})),n=[...o,...l,...p];return`
    ...
    `}function m(){var s,o,l,p;document.querySelectorAll("[data-mtab]").forEach(n=>{n.addEventListener("click",()=>{if(c.tab=n.dataset.mtab,c.tab==="mug"&&c.mugTargets.length===0){x();return}v()})}),(s=document.getElementById("btnShowList"))==null||s.addEventListener("click",()=>{c.showListForm=!c.showListForm,v()}),document.querySelectorAll("[data-filter]").forEach(n=>{n.addEventListener("click",async()=>{c.filter=n.dataset.filter,await u()})}),(o=document.getElementById("sortSelect"))==null||o.addEventListener("change",async n=>{c.sort=n.target.value,await u()}),(l=document.getElementById("searchInput"))==null||l.addEventListener("input",n=>{c.search=n.target.value,v();const f=document.getElementById("searchInput");f&&(f.focus(),f.setSelectionRange(c.search.length,c.search.length))}),(p=document.getElementById("btnConfirmList"))==null||p.addEventListener("click",async()=>{var L,E,S;const n=(L=document.getElementById("listItem"))==null?void 0:L.value;if(!n)return;const[f,T]=n.split("|"),k=parseInt((E=document.getElementById("listQty"))==null?void 0:E.value)||1,w=parseInt((S=document.getElementById("listPrice"))==null?void 0:S.value)||0;if(w<=0)return d("Giá phải lớn hơn 0!","error");try{const P=await r.listForSale(g,f,T,k,w);d(P.message,"success"),t.player=P.player,$(),c.showListForm=!1,await u()}catch(P){d(P.message,"error")}}),document.querySelectorAll("[data-buy]").forEach(n=>{n.addEventListener("click",async()=>{const f=parseInt(n.dataset.buy),T=parseInt(n.dataset.qty),k=parseInt(n.dataset.price);let w=1;if(T>1){const L=prompt(`Mua bao nhiêu? (tối đa ${T}, giá ${k} 💎/cái)`,"1");if(!L)return;w=Math.min(parseInt(L)||1,T)}n.disabled=!0;try{const L=await r.buyFromMarket(g,f,w);d(L.message,"success"),t.player=L.player,$(),await u()}catch(L){d(L.message,"error"),n.disabled=!1}})}),document.querySelectorAll("[data-cancel]").forEach(n=>{n.addEventListener("click",async()=>{n.disabled=!0;try{const f=await r.cancelListing(g,parseInt(n.dataset.cancel));d(f.message,"success"),t.player=f.player,$(),await u()}catch(f){d(f.message,"error"),n.disabled=!1}})}),document.querySelectorAll("[data-mug]").forEach(n=>{n.addEventListener("click",async()=>{const f=n.dataset.mug;if(confirm("⚠️ Xác nhận phục kích? Thất bại sẽ bị phản đòn và trọng thương!")){n.disabled=!0,n.textContent="⏳...";try{const T=await r.mugPlayer(g,f);d(T.message,T.success?"success":"error"),t.player=T.player,$(),await x()}catch(T){d(T.message,"error"),n.disabled=!1,n.textContent="💀 Phục Kích"}}})})}c.tab==="mug"?x():c.loaded?v():u()}function $t(a,e){const{state:t,api:r,notify:d,updateSidebar:$}=e,g=t.playerId;let c=!1,u=null;async function x(){try{u=await r.getRealmInfo(g),c=!0,v()}catch(b){d(b.message||"Lỗi tải Cảnh Giới","error")}}function v(){if(!u)return;const b=u.current,y=u.allRealms||[],m=t.player,s=m.xpToNext>0?Math.floor(m.xp/m.xpToNext*100):0;a.innerHTML=`
      ...
      <div class="card" style="border:2px solid ${b.color};margin-bottom:16px">
        ...
        <div class="sidebar-bar" style="margin:8px 0">
          ...
          <div class="bar-track"><div class="bar-fill" style="width:${s}%;background:${b.color}"></div></div>
        </div>
        ...
        ${b.bonuses?`
          <div style="margin-top:8px">
            ...
            <div style="display:flex;gap:6px;flex-wrap:wrap">
              ${Object.entries(b.bonuses).filter(([,o])=>o>0).map(([o,l])=>`
                <span class="tag" style="background:rgba(255,255,255,0.08);border-radius:4px;padding:2px 6px;font-size:11px">+${l} ${o}</span>
              `).join("")}
            </div>
          </div>
        `:""}
        ...
        ${b.unlocks?`
          <div style="margin-top:8px">
            ...
            <div style="display:flex;gap:6px;flex-wrap:wrap">
              ${b.unlocks.map(o=>`<span style="font-size:12px;opacity:0.7">✅ ${o}</span>`).join(" · ")}
            </div>
          </div>
        `:""}
      </div>
      ...
      <div class="card">
        ...
        ${y.map(o=>{const l=o.tier===b.tier,p=o.tier<b.tier,f=o.tier>b.tier?"0.35":"1";return`
            <div style="display:flex;align-items:center;gap:10px;padding:8px;border-bottom:${l?`2px solid ${o.color}`:"1px solid rgba(255,255,255,0.05)"};opacity:${f};transition:opacity 0.3s">
    ...
    `,i()}function h(b){const y=b.nextRealm;if(!y)return"";const m=y.cost?`💎 ${y.cost.gold} + 🔮 ${y.cost.energy}`:"Miễn phí";return`
      <div class="card" style="border:2px solid ${y.icon==="⚡"?"#4fc3f7":"#ffd54f"};margin-bottom:16px;background:rgba(255,215,0,0.03)">
        ...
        <div style="font-size:12px;opacity:0.5;margin-bottom:8px">
          Bonus mới: ${Object.entries(y.bonuses).filter(([,s])=>s>0).map(([s,o])=>`+${o} ${s}`).join(", ")}
        </div>
    ...
    `}function i(){var b;(b=document.getElementById("btnBreakthrough"))==null||b.addEventListener("click",async()=>{const y=document.getElementById("btnBreakthrough");if(confirm("Bạn có chắc muốn đột phá? Thất bại sẽ bị trọng thương!")){y.disabled=!0,y.textContent="⏳ Đang đột phá...";try{const m=await r.attemptBreakthrough(g);m.success?(d(m.message,"success"),t.player=m.player,$(),await x()):(d(m.message,"error"),m.player&&(t.player=m.player,$()),await x())}catch(m){d(m.message||"Lỗi đột phá","error"),y.disabled=!1,y.textContent="⚡ ĐỘT PHÁ"}}})}x()}function Tt(a,e){const{state:t,api:r,notify:d,updateSidebar:$}=e;kt(a,e)}async function kt(a,e){const{state:t,api:r,notify:d,updateSidebar:$}=e;a.innerHTML='<div class="loading">Đang tải nhật ký sự kiện...</div>';try{const c=(await r.request(`/player/${t.playerId}/events`)).events||[];if(t.player&&(t.player.unreadEventsCount=0,$()),c.length===0){a.innerHTML=`
      ...
      <div class="panel">
        <div class="panel-body no-pad">
          <ul class="event-timeline" style="list-style:none; padding:16px; margin:0;">
            ${c.map(u=>{const x=new Date(u.created_at*1e3),v=x.toLocaleTimeString("vi-VN",{hour:"2-digit",minute:"2-digit"}),h=x.toLocaleDateString("vi-VN",{day:"2-digit",month:"2-digit"});let i="📌";return u.type==="attack"&&(i="⚔️"),u.type==="hospital"&&(i="🏥"),u.type==="jail"&&(i="🚓"),u.type==="money"&&(i="💰"),u.type==="system"&&(i="⚙️"),u.type==="trade"&&(i="🤝"),`
    ...
    `}catch(g){a.innerHTML=`<div class="panel"><div class="panel-body text-red">Lỗi tải dữ liệu sự kiện: ${g.message}</div></div>`}}function wt(a,e){const{state:t,api:r,notify:d,updateSidebar:$,renderGame:g}=e,c=t.playerId;t._housing||(t._housing={data:null,loaded:!1});const u=t._housing;async function x(){try{const y=await r.getHousing(c);u.data=y,u.loaded=!0,v()}catch(y){d(y.message||"Lỗi tải Động Phủ","error")}}function v(){const y=u.data;a.innerHTML=`
      <div class="page-header">
        <h2>🏠 Động Phủ</h2>
      ...
      ${y.owned?i(y):h(y)}
    `,b()}function h(y){const m=y.tiers[1];return`
      <div class="panel">
    ...
    `}function i(y){const m=y.gardenSlots||[],s=y.gardenHerbs||{};return`
      <div class="panel glass" style="margin-bottom:12px">
      ...
      <div class="panel">
        ...
        <div class="panel-body" style="padding:12px 16px">
          <div style="display:grid;grid-template-columns:repeat(${Math.min(y.maxSlots,5)},1fr);gap:8px">
            ${Array.from({length:y.maxSlots},(o,l)=>{const p=m[l]||{},n=!!p.herb,f=p.ready,T=p.remaining||0,k=Math.ceil(T/60);return`
      ...
      <div class="panel" style="margin-top:10px">
        ...
        <div class="panel-body" style="padding:12px 16px">
          <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:8px">
            ${Object.entries(y.formations).map(([o,l])=>{const p=l.currentLevel>=l.maxLevel;return`
                <div style="background:rgba(255,255,255,0.03);border:1px solid ${l.currentLevel>0?"var(--blue)":"rgba(255,255,255,0.08)"};border-radius:8px;padding:10px">
                  <div style="display:flex;justify-content:space-between;align-items:center">
                    ...
                    ${l.canBuild?p?'<span style="font-size:10px;color:var(--gold)">MAX</span>':`<button class="btn btn--sm btn--gold btn-formation" data-fid="${o}">
                        ⬆ ${l.nextCost} 💎
      ...
      `:""}
    `}function b(){var y,m,s,o;(y=document.getElementById("btnBuyHouse"))==null||y.addEventListener("click",async()=>{if(confirm("Mua Động Phủ?"))try{const l=await r.buyHousing(c);d(l.message,"success"),t.player=l.player,$(),await x()}catch(l){d(l.message,"error")}}),(m=document.getElementById("btnUpgrade"))==null||m.addEventListener("click",async()=>{if(confirm("Nâng cấp Động Phủ?"))try{const l=await r.buyHousing(c);d(l.message,"success"),t.player=l.player,$(),await x()}catch(l){d(l.message,"error")}}),document.querySelectorAll(".plant-select").forEach(l=>{l.addEventListener("change",async p=>{const n=p.target.value;if(!n)return;const f=parseInt(l.dataset.slot);try{const T=await r.plantHerb(c,n,f);d(T.message,"success"),await x()}catch(T){d(T.message,"error")}})}),(s=document.getElementById("btnHarvest"))==null||s.addEventListener("click",async()=>{try{const l=await r.harvestGarden(c);d(l.message,"success"),t.player=l.player,$(),await x()}catch(l){d(l.message,"error")}}),document.querySelectorAll(".btn-formation").forEach(l=>{l.addEventListener("click",async()=>{const p=l.dataset.fid;l.disabled=!0,l.textContent="⏳...";try{const n=await r.upgradeFormation(c,p);d(n.message,"success"),t.player=n.player,$(),await x()}catch(n){d(n.message,"error"),l.disabled=!1,l.textContent="⬆ Nâng"}})}),(o=document.getElementById("btnMaintenance"))==null||o.addEventListener("click",async()=>{try{const l=await r.payMaintenance(c);d(l.message,"success"),t.player=l.player,$(),await x()}catch(l){d(l.message,"error")}})}u.loaded?v():x()}function Lt(a,e){const{state:t}=e;t._wikiTab||(t._wikiTab="lore");function r(){a.innerHTML=`
      <div class="page-header">
    ...
    `,a.querySelectorAll("[data-tab]").forEach($=>{$.addEventListener("click",()=>{t._wikiTab=$.dataset.tab,r()})})}function d($){return{lore:`
      ...
      `}[$]||'<div style="text-align:center;opacity:0.4">Chọn một mục để xem</div>'}r()}function St(a,e){const{state:t,api:r,notify:d,updateSidebar:$}=e,g=t.playerId;t._npcShop||(t._npcShop={shops:[],tax:{rate:5,reason:""},loaded:!1});const c=t._npcShop;async function u(){try{const h=await r.getShops(g);c.shops=h.shops||[],c.tax=h.currentTax||{rate:5,reason:"Thuế tiêu chuẩn"},c.loaded=!0,x()}catch(h){d(h.message||"Lỗi tải shop","error")}}function x(){a.innerHTML=`
      <div class="page-header">
              ...
              <div class="list-item" style="padding:8px 14px;display:flex;align-items:center;gap:10px">
                <div style="flex:1">
                  ...
                  <div style="font-size:11px;opacity:0.5">
                    Stock: <span style="color:${i.remainingStock>0?"var(--green)":"var(--red)"}">${i.remainingStock}/${i.dailyStock}</span>
                    · 💎 ${i.currentPrice}
                  </div>
                </div>
                <div style="display:flex;gap:4px;align-items:center">
                  <input type="number" class="buy-qty" data-shop="${h.id}" data-item="${i.id}" data-price="${i.currentPrice}"
                    value="1" min="1" max="${i.remainingStock}" style="width:40px;text-align:center;background:var(--bg-secondary);color:var(--text);border:1px solid rgba(255,255,255,0.1);border-radius:4px;padding:3px;font-size:11px">
                  <button class="btn btn--sm btn--gold btn-buy" data-shop="${h.id}" data-item="${i.id}"
                    ${i.remainingStock<=0?"disabled":""}>
                    ${i.remainingStock>0?"🛒 Mua":"❌ Hết"}
                  </button>
                </div>
              </div>
            `).join("")}
      ...
      `).join("")}
    `,v()}function v(){a.querySelectorAll(".btn-buy").forEach(h=>{h.addEventListener("click",async()=>{const i=h.dataset.shop,b=h.dataset.item,y=a.querySelector(`.buy-qty[data-shop="${i}"][data-item="${b}"]`),m=parseInt((y==null?void 0:y.value)||1);h.disabled=!0,h.textContent="⏳...";try{const s=await r.buyFromShop(g,i,b,m);d(s.message,"success"),t.player=s.player,$(),await u()}catch(s){d(s.message,"error"),h.disabled=!1,h.textContent="🛒 Mua"}})})}c.loaded?x():u()}function Et(a,e){const{state:t,api:r,notify:d,updateSidebar:$}=e,g=t.playerId;t._guild||(t._guild={data:null,loaded:!1,allGuilds:null});const c=t._guild;async function u(){try{c.data=await r.getMyGuild(g),c.loaded=!0,v()}catch(y){d(y.message||"Lỗi","error")}}async function x(){try{const y=await r.listGuilds();c.allGuilds=y.guilds||[],v()}catch(y){d(y.message,"error")}}function v(){const y=c.data;a.innerHTML=`
      <div class="page-header">
        <h2>🏯 Tông Môn</h2>
        <p class="page-sub">Lập hoặc gia nhập Tông Môn. Cùng nhau tu luyện, nhận buff toàn đội.</p>
      </div>

      ${y!=null&&y.inGuild?i(y):h(y)}
    ...
    `}function i(y){var l;const m=y.guild,s=y.members||[],o=y.log||[];return`
      <div class="panel glass" style="margin-bottom:12px">
        <div class="panel-body" style="display:flex;align-items:center;gap:16px;padding:14px 16px">
          <div style="font-size:36px">🏯</div>
          <div style="flex:1">
          ...
          <div style="display:flex;flex-direction:column;gap:4px">
            ${y.myRole==="leader"&&m.nextLevel?`<button class="btn btn--sm btn--gold" id="btnUpgradeGuild" title="Nâng lên ${m.nextLevel.name}">⬆ ${m.nextLevel.upgradeCost} 💎</button>`:""}
            ${y.myRole==="leader"&&m.upkeepDue?'<button class="btn btn--sm btn--orange" id="btnPayUpkeep">💰 Nộp phí</button>':""}
          </div>
        </div>
      </div>
    ...
    `}function b(){var y,m,s,o,l,p;(y=document.getElementById("btnCreate"))==null||y.addEventListener("click",async()=>{var k,w,L,E,S,P;const n=(w=(k=document.getElementById("guildName"))==null?void 0:k.value)==null?void 0:w.trim(),f=(E=(L=document.getElementById("guildTag"))==null?void 0:L.value)==null?void 0:E.trim(),T=(P=(S=document.getElementById("guildDesc"))==null?void 0:S.value)==null?void 0:P.trim();if(!n||!f)return d("Nhập tên và tag!","error");try{const I=await r.createGuild(g,n,f,T);d(I.message,"success"),t.player=I.player,$(),c.loaded=!1,await u()}catch(I){d(I.message,"error")}}),(m=document.getElementById("btnLoadGuilds"))==null||m.addEventListener("click",x),document.querySelectorAll(".btn-join").forEach(n=>{n.addEventListener("click",async()=>{try{const f=await r.joinGuild(g,parseInt(n.dataset.gid));d(f.message,"success"),c.loaded=!1,await u()}catch(f){d(f.message,"error")}})}),(s=document.getElementById("btnContribute"))==null||s.addEventListener("click",async()=>{var f;const n=parseInt(((f=document.getElementById("contributeAmt"))==null?void 0:f.value)||0);if(!(n<=0))try{const T=await r.contributeGuild(g,n);d(T.message,"success"),t.player=T.player,$(),await u()}catch(T){d(T.message,"error")}}),(o=document.getElementById("btnUpgradeGuild"))==null||o.addEventListener("click",async()=>{if(confirm("Nâng cấp Tông Môn? Dùng tiền quỹ."))try{const n=await r.upgradeGuild(g);d(n.message,"success"),await u()}catch(n){d(n.message,"error")}}),(l=document.getElementById("btnPayUpkeep"))==null||l.addEventListener("click",async()=>{try{const n=await r.payGuildUpkeep(c.data.guild.id);d(n.message,"success"),await u()}catch(n){d(n.message,"error")}}),(p=document.getElementById("btnLeave"))==null||p.addEventListener("click",async()=>{if(confirm("Rời Tông Môn?"))try{const n=await r.leaveGuild(g);d(n.message,"success"),c.loaded=!1,await u()}catch(n){d(n.message,"error")}})}c.loaded?v():u()}function Ct(a,e){const{state:t,api:r,notify:d,updateSidebar:$}=e,g=t.playerId;t._profile||(t._profile={results:[],viewing:null,searchQuery:""});const c=t._profile;function u(){a.innerHTML=`
      <div class="page-header">
        <h2>🔍 Tìm Đạo Hữu</h2>
    ...
    `,v()}function x(i){var s,o,l;const b=i.id===g,y=i.maxHp>0?Math.round(i.currentHp/i.maxHp*100):100,m={thanh_lam_tran:"Thanh Lam Trấn",hac_phong_lam:"Hắc Phong Lâm",vong_linh_coc:"Vong Linh Cốc",thiet_huyet_son:"Thiết Huyết Sơn",bac_suong_canh:"Bắc Sương Cảnh"};return`
      <div class="panel glass" style="margin-bottom:12px">
        <div class="panel-body" style="padding:16px">
          <div style="display:flex;align-items:center;gap:16px;margin-bottom:12px">
            <div style="width:52px;height:52px;border-radius:50%;background:linear-gradient(135deg,var(--gold),var(--orange));display:flex;align-items:center;justify-content:center;font-size:22px;font-weight:bold;color:#111">
              ${((s=i.name[0])==null?void 0:s.toUpperCase())||"?"}
            </div>
            <div style="flex:1">
          ...
          <div style="font-size:12px;margin-bottom:12px">💰 Linh thạch: <strong style="color:var(--gold)">${(l=i.gold)==null?void 0:l.toLocaleString()} 💎</strong></div>
    ...
    `}function v(){var i,b,y,m,s;(i=document.getElementById("btnSearch"))==null||i.addEventListener("click",h),(b=document.getElementById("searchInput"))==null||b.addEventListener("keydown",o=>{o.key==="Enter"&&h()}),document.querySelectorAll(".btn-view, [data-view]").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.vid||o.dataset.view;try{const p=await r.getPlayerProfile(l);c.viewing=p.profile,u()}catch(p){d(p.message,"error")}})}),(y=document.getElementById("btnAttack"))==null||y.addEventListener("click",async()=>{const o=document.getElementById("btnAttack").dataset.tid;if(confirm(`Tấn công ${c.viewing.name}?`))try{const l=await r.mugPlayer(g,o);d(l.message,l.won?"success":"error"),l.player&&(t.player=l.player,$())}catch(l){d(l.message,"error")}}),(m=document.getElementById("btnAddFriend"))==null||m.addEventListener("click",async()=>{const o=document.getElementById("btnAddFriend").dataset.tid;try{const l=await r.addFriend(g,o);d(l.message||"Đã gửi lời mời!","success")}catch(l){d(l.message,"error")}}),(s=document.getElementById("btnBackSearch"))==null||s.addEventListener("click",()=>{c.viewing=null,u()})}async function h(){var y;const i=document.getElementById("searchInput"),b=(y=i==null?void 0:i.value)==null?void 0:y.trim();if(!b||b.length<2)return d("Nhập ít nhất 2 ký tự!","error");c.searchQuery=b,c.viewing=null;try{const m=await r.searchPlayers(b);c.results=m.players||[],u()}catch(m){d(m.message,"error")}}u()}function Pt(a,e){const{state:t,api:r,notify:d,updateSidebar:$}=e,g=t.playerId;t._arena||(t._arena={data:null,loaded:!1,fighting:!1,lastResult:null});const c=t._arena;async function u(){try{c.data=await r.getArena(g),c.loaded=!0,x()}catch(h){d(h.message,"error")}}function x(){var o,l,p,n,f,T,k,w;const h=c.data,i=(h==null?void 0:h.arena)||{},b=i.rank||{},y=parseInt(i.streak)||0,m=y>=5?`🔥x${y}`:y>=3?`⚡x${y}`:y>0?`${y}W`:y<0?`${Math.abs(y)}L`:"",s=y>=5?"var(--gold)":y>=3?"var(--orange)":y>0?"var(--green)":y<0?"var(--red)":"var(--text-dim)";a.innerHTML=`
      <div class="page-header">
        <h2>⚔️ Đấu Trường</h2>
        ...
        <div class="panel-body" style="display:flex;align-items:center;gap:16px;padding:16px">
          ...
          <div style="flex:1">
            ...
            <div style="font-size:13px;opacity:0.7;margin-top:2px">
              ...
              ${m?` · <span style="color:${s};font-weight:700">${m}</span>`:""}
            </div>
            ${b.nextThreshold?`
      ...
      <div class="panel" style="margin-bottom:12px;border:2px solid var(--gold);animation:pulse 1.5s infinite;text-align:center;padding:16px">
        <div style="font-size:36px">${(l=c.lastResult.newRank)==null?void 0:l.icon}</div>
        <div style="font-size:16px;font-weight:800;color:var(--gold);margin-top:6px">🎉 THĂNG CẤP! ${(p=c.lastResult.newRank)==null?void 0:p.name}!</div>
      </div>
      `:""}

      <!-- LAST RESULT -->
      ${c.lastResult?`
      <div class="panel" style="margin-bottom:12px;border-left:3px solid ${c.lastResult.won?"var(--green)":"var(--red)"}">
        <div class="panel-body" style="padding:12px 16px">
          <div style="font-weight:700;color:${c.lastResult.won?"var(--green)":"var(--red)"}">
            ${c.lastResult.won?"🏆 CHIẾN THẮNG!":"💀 THẤT BẠI!"}
          </div>
          <div style="font-size:12px;margin-top:4px">
            Đối thủ: <strong>${(n=c.lastResult.opponent)==null?void 0:n.name}</strong> 
            ${(f=c.lastResult.opponent)!=null&&f.rank?c.lastResult.opponent.rank.icon:""} 
            (ELO ${(T=c.lastResult.opponent)==null?void 0:T.rating})
          </div>
          <div style="font-size:11px;opacity:0.6;margin-top:4px">
            ELO: ${c.lastResult.ratingChange>0?"+":""}${c.lastResult.ratingChange}
            ${c.lastResult.goldEarned>0?` · +${c.lastResult.goldEarned} 💎`:""}
          </div>
          ${(k=c.lastResult.combatLog)!=null&&k.length?`<details style="margin-top:6px"><summary style="font-size:11px;cursor:pointer">📜 Combat Log</summary>
            <div class="combat-log" style="font-size:10px;margin-top:4px;max-height:150px;overflow:auto">${c.lastResult.combatLog.map(L=>`<div>${L}</div>`).join("")}</div>
          </details>`:""}
        </div>
      </div>
      `:""}
      ...
      <div class="panel" style="margin-bottom:12px">
        ...
        <div class="panel-body no-pad">
          ${(h.opponents||[]).length>0?(h.opponents||[]).map(L=>{var E,S,P;return`
            <div class="list-item" style="padding:10px 14px;display:flex;align-items:center;gap:10px;cursor:pointer" >
              ...
              <button class="btn btn--red btn--sm btn-fight-opp" data-oid="${L.player_id}" ${c.fighting?"disabled":""}>⚔️ Đấu</button>
            </div>
          ...
          <div style="padding:8px 14px;text-align:center">
            <button class="btn btn--blue btn--sm" id="btnRandomFight" ${c.fighting?"disabled":""}>🎲 Đấu Ngẫu Nhiên (${h.entryFee||50} 💎)</button>
          </div>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
        <div class="panel">
          ...
          <div class="panel-body no-pad">
            ${(h.top10||[]).map((L,E)=>{var S,P;return`
        ...
        <div class="panel">
          ...
          <div class="panel-body no-pad">
            ${(h.history||[]).map(L=>{const E=L.winner_id===g;return`<div class="list-item" style="padding:6px 12px;font-size:11px">
                <span style="color:${E?"var(--green)":"var(--red)"}">
                  ${E?"✅":"❌"} vs ${L.attacker_id===g?L.defender_name:L.attacker_name}
                </span>
    ...
    `,a.querySelectorAll(".btn-fight-opp").forEach(L=>{L.addEventListener("click",E=>v(E.target.dataset.oid))}),(w=document.getElementById("btnRandomFight"))==null||w.addEventListener("click",()=>v(null))}async function v(h){c.fighting=!0,x();try{const i=await r.request(`/player/${g}/arena/fight`,{method:"POST",body:JSON.stringify({opponentId:h})});c.lastResult=i,t.player=i.player,$(),d(i.message,i.won?"success":"error"),c.fighting=!1,await u()}catch(i){d(i.message,"error"),c.fighting=!1,x()}}c.loaded?x():u()}function It(a,e){const{state:t,api:r,notify:d,updateSidebar:$,renderGame:g}=e,c=t.playerId,u=t._auctionTab||"browse";async function x(){try{const[i,b]=await Promise.all([r.getAuctions(),r.getMyAuctions(c)]);t._auctionListings=i.listings||[],t._auctionMine=b.listings||[],v()}catch(i){d(i.message,"error")}}function v(){const i=t._auctionListings||[],b=t._auctionMine||[],y=(t.player.inventory||[]).filter(m=>m.slot&&m.slot!=="consumable");a.innerHTML=`
      <div class="page-header">
        <h2>🏪 Đấu Giá</h2>
      ...
      <div style="display:flex;gap:6px;margin-bottom:10px">
        ...
        <button class="btn ${u==="mine"?"btn--gold":"btn--dark"} btn--sm tab-btn" data-tab="mine">📋 Của Tôi (${b.length})</button>
      </div>

      ${u==="browse"?`
        <div class="panel"><div class="panel-body no-pad">
          ${i.length===0?'<div style="padding:16px;opacity:0.3">Chưa có đấu giá nào...</div>':i.map(m=>{const s=JSON.parse(m.item_data||"{}");return`<div class="list-item" style="padding:8px 14px">
                <div style="flex:1">
          ...
          <div class="panel-body" style="padding:12px 16px">
            ${y.length===0?'<div style="opacity:0.3">Không có trang bị để bán</div>':`
              <select id="selSellItem" style="width:100%;padding:8px;background:var(--bg-secondary);color:var(--text);border:1px solid rgba(255,255,255,0.1);border-radius:6px;margin-bottom:8px">
                ${y.map(m=>`<option value="${m.id}">${m.name} [${m.rarity}]</option>`).join("")}
              </select>
      ...
      `:`
        <div class="panel"><div class="panel-body no-pad">
          ${b.length===0?'<div style="padding:16px;opacity:0.3">Chưa có đấu giá</div>':b.map(m=>`<div class="list-item" style="padding:8px 14px">
                <div style="flex:1">
      ...
      `}
    `,h()}function h(){var i;a.querySelectorAll(".tab-btn").forEach(b=>b.addEventListener("click",()=>{t._auctionTab=b.dataset.tab,x()})),a.querySelectorAll(".btn-buy").forEach(b=>b.addEventListener("click",async()=>{if(confirm("Mua vật phẩm này?"))try{const y=await r.buyAuction(c,parseInt(b.dataset.lid));d(y.message,"success"),t.player=y.player,$(),await x()}catch(y){d(y.message,"error")}})),a.querySelectorAll(".btn-cancel").forEach(b=>b.addEventListener("click",async()=>{try{const y=await r.cancelAuction(c,parseInt(b.dataset.lid));d(y.message,"success"),t.player=y.player,$(),await x()}catch(y){d(y.message,"error")}})),(i=document.getElementById("btnListItem"))==null||i.addEventListener("click",async()=>{var s,o,l;const b=(s=document.getElementById("selSellItem"))==null?void 0:s.value,y=parseInt(((o=document.getElementById("inpPrice"))==null?void 0:o.value)||"500"),m=parseInt(((l=document.getElementById("selDuration"))==null?void 0:l.value)||"24");try{const p=await r.listAuction(c,b,y,m);d(p.message,"success"),t.player=p.player,$(),t._auctionTab="mine",await x()}catch(p){d(p.message,"error")}})}x()}function Mt(a,e){const{state:t,api:r,notify:d,updateSidebar:$}=e,g=t.playerId;async function c(){try{const x=await r.getDailyQuests(g);t._dailyQuests=x,u()}catch(x){d(x.message,"error")}}function u(){const x=t._dailyQuests||{},v=x.quests||[];x.allCompleted;const h=x.bonusReward;a.innerHTML=`
      <div class="page-header">
        <h2>📋 Nhiệm Vụ Hàng Ngày</h2>
        <p class="page-sub">Hoàn thành 3 nhiệm vụ mỗi ngày để nhận thưởng. Reset lúc 00:00.</p>
      </div>

      ${v.map(i=>{const b=i.quest_info||{},y=i.target>0?Math.min(100,Math.round(i.progress/i.target*100)):0;return`
        <div class="panel" style="margin-bottom:8px;border-left:3px solid ${i.claimed?"var(--text-dim)":i.completed?"var(--green)":"var(--blue)"}">
          <div class="panel-body" style="padding:10px 14px">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px">
              <div>
                <strong>${b.name||i.quest_id}</strong>
            ...
            <div style="height:5px;background:rgba(255,255,255,0.05);border-radius:3px;overflow:hidden">
              <div style="height:100%;width:${y}%;background:${i.completed?"var(--green)":"var(--blue)"};border-radius:3px;transition:width 0.3s"></div>
            </div>
      ...
      `:""}
    `,a.querySelectorAll(".btn-claim").forEach(i=>i.addEventListener("click",async()=>{try{const b=await r.claimDailyQuest(g,parseInt(i.dataset.qid));d(b.message,"success"),t.player=b.player,$(),await c()}catch(b){d(b.message,"error")}}))}c()}function qt(a,e){const{state:t,api:r,notify:d,updateSidebar:$}=e,g=t.playerId;async function c(){try{t._worldBoss=await r.getWorldBoss(),u()}catch(x){d(x.message,"error")}}function u(){var m;const x=t._worldBoss||{},v=x.boss||{},h=x.hpPercent||0,i=x.topContributors||[],b=x.rewards||{},y=v.status==="active"&&v.current_hp>0;a.innerHTML=`
      <div class="page-header">
        <h2>🐉 Boss Thế Giới</h2>
      ...
      <div class="panel glass" style="margin-bottom:10px">
        <div class="panel-body" style="padding:16px;text-align:center">
          ...
          <div style="font-size:12px;opacity:0.5">Lv${v.level||"?"} · ${y?"ĐANG HOẠT ĐỘNG":"ĐÃ BỊ ĐÁNH BẠI"}</div>
      ...
      <div class="panel">
        ...
        <div class="panel-body no-pad">
          ${i.length===0?'<div style="padding:16px;opacity:0.3">Chưa ai đánh...</div>':i.map((s,o)=>{var l;return`
              <div class="list-item" style="padding:6px 12px;font-size:12px">
    ...
    `,(m=document.getElementById("btnAttackBoss"))==null||m.addEventListener("click",async()=>{const s=document.getElementById("btnAttackBoss");s.disabled=!0,s.textContent="⏳ Đang giao chiến...";const o=document.getElementById("bossCombatResult");try{const l=await r.attackWorldBoss(g);if(t.player=l.player,$(),l.log&&l.log.length>0){const p=l.log.map(k=>k.startsWith("---")?`<div class="turn">${k}</div>`:k.includes("hụt")?`<div class="miss">${k}</div>`:k.includes("né được")?`<div class="dodge">${k}</div>`:k.includes("CHÍNH MẠNG")||k.includes("💥")?`<div class="crit">${k}</div>`:k.includes("🔥")?`<div class="heavy text-orange">${k}</div>`:k.includes("chặn hoàn toàn")||k.includes("🛡")?`<div class="dodge">${k}</div>`:k.includes("ngã xuống")||k.includes("💀")?`<div class="death">${k}</div>`:k.includes("Chiến thắng")||k.includes("🏆")?`<div class="victory">${k}</div>`:k.includes("bỏ chạy")||k.includes("🏃")?`<div class="flee">${k}</div>`:k.includes("Bất phân")||k.includes("🤝")?`<div class="stalemate">${k}</div>`:k.includes("🧪")?`<div class="status-effect text-purple">${k}</div>`:k.includes("💔")?`<div class="dot-damage text-purple bold">${k}</div>`:k.includes("✨")?`<div class="regen text-green">${k}</div>`:`<div class="hit">${k}</div>`).join(""),n={win:{icon:"🏆",text:"Chiến thắng",cls:"win"},loss:{icon:"💀",text:"Hết sức (Không phạt)",cls:"lose"},stalemate:{icon:"⏰",text:"Bất phân thắng bại",cls:"draw"},flee:{icon:"🏃",text:"Thoát thân",cls:"flee"}},f=n[l.outcome]||n.loss,T=Math.max(0,t.player.currentHp/t.player.maxHp*100);o.innerHTML=`
            ...
            </div>`}l.defeated?d(l.message,"success"):d(`⚔️ ${l.damage} dmg!`,"info"),await c()}catch(l){d(l.message,"error"),s.disabled=!1,s.textContent="⚔️ Tấn Công"}})}c()}function Ht(a,e){const{state:t,api:r,notify:d,updateSidebar:$,renderGame:g}=e,c=t.playerId,u={common:"#999",uncommon:"var(--green)",rare:"var(--blue)",legendary:"var(--gold)"};async function x(){var h;try{const[i,b]=await Promise.all([r.getGachaPools(),r.getGachaPity(c)]);t._gacha={pools:i.pools||{},pity:b.pity||{},results:((h=t._gacha)==null?void 0:h.results)||[]},v()}catch(i){d(i.message,"error")}}function v(){const h=t._gacha||{},i=h.pools||{},b=h.pity||{},y=h.results||[];a.innerHTML=`
      <div class="page-header">
        <h2>🎰 Thiên Cơ Đài</h2>
      ...
      <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:10px;margin-bottom:12px">
        ${Object.entries(i).map(([m,s])=>{var l,p,n;const o=b[m]||{};return`
          <div class="panel glass">
            <div class="panel-body" style="padding:14px;text-align:center">
              ...
              <div style="font-size:10px;opacity:0.3;margin-bottom:8px">
                Pity Rare: ${o.pulls_since_rare||0}/${s.pityRare} · Legend: ${o.pulls_since_legendary||0}/${s.pityLegendary}
              </div>
          ...
          <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(120px,1fr));gap:6px">
            ${y.map(m=>{var s,o,l,p;return`
              <div style="background:rgba(255,255,255,0.03);border:1px solid ${u[m.rarity]||"#555"};border-radius:6px;padding:8px;text-align:center">
                <div style="font-size:14px">${((s=m.item)==null?void 0:s.slot)==="weapon"?"⚔️":((o=m.item)==null?void 0:o.slot)==="armor"?"🛡️":"💍"}</div>
      ...
      `:""}
    `,a.querySelectorAll(".btn-pull").forEach(m=>m.addEventListener("click",async()=>{const s=m.dataset.pool,o=parseInt(m.dataset.pulls);m.disabled=!0,m.textContent="⏳...";try{const l=await r.gachaPull(t.playerId,s,o);d(l.message,"success"),t.player=l.player,$(),t._gacha.results=l.results||[],t._gacha.pity[s]=l.pity,v()}catch(l){d(l.message,"error"),m.disabled=!1}}))}x()}function Nt(a,e){const{state:t,api:r,notify:d}=e,$=t._lbTab||"level";async function g(){try{t._lbData=await r.getLeaderboard($),c()}catch(u){d(u.message,"error")}}function c(){const x=(t._lbData||{}).rankings||[],v={level:"📊 Level",gold:"💰 Linh Thạch",pvp:"⚔️ PvP",guild:"🏯 Tông Môn"};a.innerHTML=`
      <div class="page-header">
        <h2>🏆 Bảng Xếp Hạng</h2>
      ...
      <div style="display:flex;gap:6px;margin-bottom:10px">
        ${Object.entries(v).map(([h,i])=>`<button class="btn ${$===h?"btn--gold":"btn--dark"} btn--sm tab-btn" data-tab="${h}">${i}</button>`).join("")}
      </div>
        ...
        <div class="panel-body no-pad">
          ...
          `).join(""):x.map((h,i)=>`
            <div class="list-item" style="padding:8px 14px;font-size:12px">
              ...
              ${$==="level"?`<span>Lv${h.level}</span>`:""}
              <span style="color:var(--gold);margin-left:8px">💎 ${parseInt(h.gold||0).toLocaleString()}</span>
            </div>
          `).join("")}
        </div>
      </div>
    `,a.querySelectorAll(".tab-btn").forEach(h=>h.addEventListener("click",()=>{t._lbTab=h.dataset.tab,g()}))}g()}const C={playerId:null,player:null,currentPage:"combat",monsters:[],skills:[],items:[]},nt=document.getElementById("app"),J={get state(){return C},api:q,notify:z,renderGame:H,updateSidebar:Gt};async function _t(){const a=localStorage.getItem("playerId");if(a&&!C.playerId)try{const e=await q.getPlayer(a);C.playerId=a,C.player=e.player,await V(),H();return}catch{localStorage.removeItem("playerId")}C.playerId?H():st()}function st(){var e,t;const a=C.authTab||"login";nt.innerHTML=`
...
...Cho đến khi hệ thống xuất hiện lỗi.</div>
    ...
    <div class="game-layout">
      ...
      <aside class="sidebar">
        ...
        <div class="sidebar-player">
          ...
          <div class="player-meta">Lv.${a.level} · ${((h=a.realmInfo)==null?void 0:h.fullName)||"?"}</div>
          ${it(a)}
          ${rt(a)}
          <div class="sidebar-bar" style="margin-top:8px">
            <div class="bar-label">
              ...
              <span>
                ${a.currentHp}/${a.maxHp}
                ${a.currentHp<a.maxHp?`<span style="font-size:10px; color:var(--text-dim); margin-left:4px;">${(i=a.skills)!=null&&i.some(n=>n.id==="toa_thien")?"+1%/10s":"(Không tự hồi)"}</span>`:""}
              </span>
            </div>
          ...
          <div class="sidebar-bar" style="margin-top:4px">
            <div class="bar-label">
              ...
              <span>
                ...
                ${(a.currentStamina??100)<(a.maxStamina??100)?`<span style="font-size:10px; color:var(--text-dim); margin-left:4px;">+${((b=a.stats)==null?void 0:b.staminaRegen)??10}/10s</span>`:""}
              </span>
            </div>
      ...
      <div class="floating-actions">
        ...
        <button class="btn-fab bg-green" id="btnFabSocial" title="Đạo Hữu"><span class="icon">🤝</span></button>
    ...
    </div>`,document.querySelectorAll(".nav-item[data-page]").forEach(n=>{n.addEventListener("click",()=>{C.currentPage=n.dataset.page,H()})}),(o=document.getElementById("btnFabChat"))==null||o.addEventListener("click",()=>D("chat")),(l=document.getElementById("btnFabSocial"))==null||l.addEventListener("click",()=>D("social"));const c=document.querySelector('.sidebar-gold .nav-item[data-page="events"]');c&&c.addEventListener("click",n=>{n.stopPropagation(),C.currentPage="events",C.popupOpen=!1,H()}),(p=document.getElementById("btnPopupClose"))==null||p.addEventListener("click",()=>{C.popupOpen=!1,H()}),document.querySelectorAll(".popup-tab[data-popup]").forEach(n=>{n.addEventListener("click",()=>D(n.dataset.popup))}),Rt(),C.popupOpen&&zt();const u=document.getElementById("searchPlayerInput"),x=document.getElementById("searchResults");let v=null;u&&x&&(u.addEventListener("input",()=>{clearTimeout(v);const n=u.value.trim();if(n.length<2){x.style.display="none";return}v=setTimeout(async()=>{try{const f=await q.searchPlayers(n),T=f.players||f.results||[];T.length===0?x.innerHTML='<div style="padding:8px 12px;font-size:12px;color:var(--text-dim)">Không tìm thấy</div>':x.innerHTML=T.map(k=>{var w;return`
            ...
            `}).join(""),x.style.display="block",x.querySelectorAll(".search-result").forEach(k=>{k.addEventListener("click",()=>{C.currentPage="profile",C._viewProfileId=k.dataset.pid,x.style.display="none",u.value="",H()}),k.addEventListener("mouseenter",()=>k.style.background="rgba(255,255,255,0.08)"),k.addEventListener("mouseleave",()=>k.style.background="transparent")})}catch{x.style.display="none"}},300)}),u.addEventListener("blur",()=>{setTimeout(()=>{x.style.display="none"},200)}),u.addEventListener("keydown",n=>{n.key==="Escape"&&(x.style.display="none",u.blur())})),Bt()}function D(a){C.popupOpen=!0,C.popupPage=a,H()}function zt(){const a=document.getElementById("popupContent");a&&(C.popupPage==="chat"?at(a,J):C.popupPage==="social"&&et(a,J))}const Ot={combat:ct,crimes:ht,education:yt,stats:ut,skills:Y,inventory:K,travel:tt,alchemy:F,quests:bt,admin:xt,social:et,chat:at,market:ft,realm:$t,events:Tt,dungeon:Z,housing:wt,wiki:Lt,npcshop:St,guild:Et,library:X,profile:Ct,arena:Pt,auction:It,dailyquest:Mt,worldboss:qt,gacha:Ht,leaderboard:Nt};function Rt(){const a=document.getElementById("pageContent");if(!a)return;const e=Ot[C.currentPage];e&&e(a,J)}function Gt(){var $,g,c,u,x;const a=C.player;if(!a)return;const e=Math.max(0,a.currentHp/a.maxHp*100),t=a.maxEnergy>0?Math.max(0,a.currentEnergy/a.maxEnergy*100):0,r=document.querySelector(".sidebar-player");if(r){const v=a.maxStamina>0?Math.max(0,a.currentStamina/a.maxStamina*100):0,h=(a.maxNerve??15)>0?Math.max(0,(a.nerve??0)/(a.maxNerve??15)*100):0;r.innerHTML=`
      <div class="player-name">${a.name}</div>
      ...
      <div class="sidebar-bar" style="margin-top:8px">
        <div class="bar-label">
          ...
          <span>
            ${a.currentHp}/${a.maxHp}
            ${a.currentHp<a.maxHp?`<span style="font-size:10px; color:var(--text-dim); margin-left:4px;">${(g=a.skills)!=null&&g.some(i=>i.id==="toa_thien")?"+1%/10s":"(Không tự hồi)"}</span>`:""}
          </span>
        </div>
        <div class="bar-track"><div class="bar-fill hp" style="width:${e}%" data-low="${e<30}"></div></div>
      </div>
