(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))c(o);new MutationObserver(o=>{for(const k of o)if(k.type==="childList")for(const v of k.addedNodes)v.tagName==="LINK"&&v.rel==="modulepreload"&&c(v)}).observe(document,{childList:!0,subtree:!0});function t(o){const k={};return o.integrity&&(k.integrity=o.integrity),o.referrerPolicy&&(k.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?k.credentials="include":o.crossOrigin==="anonymous"?k.credentials="omit":k.credentials="same-origin",k}function c(o){if(o.ep)return;o.ep=!0;const k=t(o);fetch(o.href,k)}})();const lt="/api";class ot{async request(a,t={}){try{const c=await fetch(`${lt}${a}`,{headers:{"Content-Type":"application/json",...t.headers},...t}),o=await c.json();if(!c.ok)throw new Error(o.error||`HTTP ${c.status}`);return o}catch(c){throw console.error(`API Error [${a}]:`,c),c}}register(a,t,c,o){return this.request("/auth/register",{method:"POST",body:JSON.stringify({username:a,password:t,name:c,gender:o})})}login(a,t){return this.request("/auth/login",{method:"POST",body:JSON.stringify({username:a,password:t})})}createPlayer(a,t){return this.request("/player/create",{method:"POST",body:JSON.stringify({name:a,gender:t})})}getPlayer(a){return this.request(`/player/${a}`)}allocateStat(a,t,c=1){return this.request(`/player/${a}/allocate`,{method:"POST",body:JSON.stringify({stat:t,points:c})})}equipItem(a,t){return this.request(`/player/${a}/equip`,{method:"POST",body:JSON.stringify({itemId:t})})}learnSkill(a,t){return this.request(`/player/${a}/learn-skill`,{method:"POST",body:JSON.stringify({skillId:t})})}equipSkill(a,t,c=!0){return this.request(`/player/${a}/equip-skill`,{method:"POST",body:JSON.stringify({skillId:t,equip:c})})}healPlayer(a){return this.request(`/player/${a}/heal`,{method:"POST"})}useMedicine(a,t){return this.request(`/player/${a}/use-medicine`,{method:"POST",body:JSON.stringify({medicineId:t})})}trainStat(a,t){return this.request(`/player/${a}/train`,{method:"POST",body:JSON.stringify({stat:t})})}fullCombat(a,t=null){return this.request("/combat/full",{method:"POST",body:JSON.stringify({playerId:a,monsterId:t})})}getMonsters(){return this.request("/data/monsters")}getSkills(){return this.request("/data/skills")}getItems(){return this.request("/data/items")}getMedicines(){return this.request("/data/medicines")}getCrimes(){return this.request("/data/crimes")}getEducation(){return this.request("/data/education")}getExploration(){return this.request("/data/exploration")}getRecipes(){return this.request("/recipes")}equipItem(a,t){return this.request(`/player/${a}/equip`,{method:"POST",body:JSON.stringify({itemId:t})})}useItem(a,t){return this.request(`/player/${a}/use`,{method:"POST",body:JSON.stringify({itemId:t})})}useMedicine(a,t){return this.request(`/player/${a}/use-medicine`,{method:"POST",body:JSON.stringify({medicineId:t})})}generateItem(a,t){return this.request("/items/generate",{method:"POST",body:JSON.stringify({rarity:t,playerId:a})})}trainStat(a,t,c=1){return this.request(`/player/${a}/train`,{method:"POST",body:JSON.stringify({stat:t,count:c})})}allocateStat(a,t){return this.request(`/player/${a}/allocate`,{method:"POST",body:JSON.stringify({stat:t})})}attemptBreakthrough(a){return this.request(`/player/${a}/breakthrough`,{method:"POST"})}getRealm(a){return this.request(`/player/${a}/realm`)}craftItem(a,t){return this.request(`/player/${a}/craft`,{method:"POST",body:JSON.stringify({recipeId:t})})}getCurrencies(){return this.request("/crafting/currencies")}applyCurrency(a,t,c,o=-1){return this.request(`/player/${a}/crafting/apply`,{method:"POST",body:JSON.stringify({currencyId:t,itemId:c,lockAffixIndex:o})})}commitCrime(a,t){return this.request(`/player/${a}/commit-crime`,{method:"POST",body:JSON.stringify({crimeId:t})})}escapeJail(a){return this.request(`/player/${a}/escape-jail`,{method:"POST"})}bail(a){return this.request(`/player/${a}/bail`,{method:"POST"})}enrollNode(a,t,c){return this.request(`/player/${a}/enroll`,{method:"POST",body:JSON.stringify({nodeId:t,treeId:c})})}checkEducation(a){return this.request(`/player/${a}/check-education`,{method:"POST"})}generateItem(a="common",t=null){return this.request("/items/generate",{method:"POST",body:JSON.stringify({rarity:a,slot:t})})}explore(a){return this.request(`/player/${a}/explore`,{method:"POST"})}trackMonster(a,t){return this.request(`/player/${a}/track-monster`,{method:"POST",body:JSON.stringify({monsterId:t})})}getAreaMonsters(a){return this.request(`/player/${a}/area-monsters`)}getNpc(a){return this.request(`/npc/${a}`)}getNpcs(){return this.request("/data/npcs")}acceptQuest(a,t,c){return this.request(`/player/${a}/accept-quest`,{method:"POST",body:JSON.stringify({npcId:t,questId:c})})}completeQuest(a,t){return this.request(`/player/${a}/complete-quest`,{method:"POST",body:JSON.stringify({questId:t})})}getQuests(a){return this.request(`/player/${a}/quests`)}searchPlayers(a){return this.request(`/players/search?q=${encodeURIComponent(a)}`)}getRelationships(a){return this.request(`/player/${a}/relationships`)}interactPlayer(a,t,c,o){return this.request(`/player/${a}/interact`,{method:"POST",body:JSON.stringify({targetId:t,action:c,amount:o})})}addFriend(a,t){return this.request(`/player/${a}/add-friend`,{method:"POST",body:JSON.stringify({targetId:t})})}acceptFriend(a,t){return this.request(`/player/${a}/accept-friend`,{method:"POST",body:JSON.stringify({targetId:t})})}rejectFriend(a,t){return this.request(`/player/${a}/reject-friend`,{method:"POST",body:JSON.stringify({targetId:t})})}removeFriend(a,t){return this.request(`/player/${a}/remove-friend`,{method:"POST",body:JSON.stringify({targetId:t})})}addEnemy(a,t){return this.request(`/player/${a}/add-enemy`,{method:"POST",body:JSON.stringify({targetId:t})})}removeEnemy(a,t){return this.request(`/player/${a}/remove-enemy`,{method:"POST",body:JSON.stringify({targetId:t})})}getGlobalChat(a=0){return this.request(`/chat/global?afterId=${a}`)}getPrivateChat(a,t,c=0){return this.request(`/chat/private/${a}?with=${t}&afterId=${c}`)}getChatFriends(a){return this.request(`/chat/friends/${a}`)}sendChat(a,t,c,o){return this.request("/chat/send",{method:"POST",body:JSON.stringify({senderId:a,channel:t,receiverId:c,message:o})})}getMarketListings(a="",t="newest"){const c=new URLSearchParams;return a&&c.set("type",a),t&&c.set("sort",t),this.request(`/market?${c.toString()}`)}getMyListings(a){return this.request(`/market/my/${a}`)}listForSale(a,t,c,o,k){return this.request("/market/list",{method:"POST",body:JSON.stringify({sellerId:a,itemType:t,itemId:c,quantity:o,price:k})})}buyFromMarket(a,t,c=1){return this.request("/market/buy",{method:"POST",body:JSON.stringify({buyerId:a,listingId:t,quantity:c})})}cancelListing(a,t){return this.request("/market/cancel",{method:"POST",body:JSON.stringify({sellerId:a,listingId:t})})}getRealmInfo(a){return this.request(`/player/${a}/realm`)}attemptBreakthrough(a){return this.request(`/player/${a}/breakthrough`,{method:"POST"})}getAllRealms(){return this.request("/data/realms")}getMugTargets(a){return this.request(`/player/${a}/mug-targets`)}mugPlayer(a,t){return this.request(`/player/${a}/mug`,{method:"POST",body:JSON.stringify({victimId:t})})}getMugLog(a){return this.request(`/player/${a}/mug-log`)}getMapItems(a){return this.request(`/player/${a}/map-items`)}enterDungeon(a,t){return this.request(`/player/${a}/dungeon/enter`,{method:"POST",body:JSON.stringify({mapItemId:t})})}fightDungeonWave(a){return this.request(`/player/${a}/dungeon/fight`,{method:"POST"})}abandonDungeon(a){return this.request(`/player/${a}/dungeon/abandon`,{method:"POST"})}getDungeonHistory(a){return this.request(`/player/${a}/dungeon/history`)}getHousing(a){return this.request(`/player/${a}/housing`)}buyHousing(a){return this.request(`/player/${a}/housing/buy`,{method:"POST"})}plantHerb(a,t,c){return this.request(`/player/${a}/housing/plant`,{method:"POST",body:JSON.stringify({herbId:t,slotIndex:c})})}harvestGarden(a){return this.request(`/player/${a}/housing/harvest`,{method:"POST"})}upgradeFormation(a,t){return this.request(`/player/${a}/housing/formation`,{method:"POST",body:JSON.stringify({formationId:t})})}payMaintenance(a){return this.request(`/player/${a}/housing/maintenance`,{method:"POST"})}listForRent(a,t){return this.request(`/player/${a}/housing/rent/list`,{method:"POST",body:JSON.stringify({pricePerDay:t})})}getRentals(){return this.request("/housing/rentals")}rentRoom(a,t){return this.request(`/player/${a}/housing/rent/take`,{method:"POST",body:JSON.stringify({rentalId:t})})}getMyGuild(a){return this.request(`/player/${a}/guild`)}createGuild(a,t,c,o){return this.request(`/player/${a}/guild/create`,{method:"POST",body:JSON.stringify({name:t,tag:c,description:o})})}contributeGuild(a,t){return this.request(`/player/${a}/guild/contribute`,{method:"POST",body:JSON.stringify({amount:t})})}upgradeGuild(a){return this.request(`/player/${a}/guild/upgrade`,{method:"POST"})}joinGuild(a,t){return this.request(`/player/${a}/guild/join`,{method:"POST",body:JSON.stringify({guildId:t})})}leaveGuild(a){return this.request(`/player/${a}/guild/leave`,{method:"POST"})}listGuilds(){return this.request("/guilds")}payGuildUpkeep(a){return this.request(`/guild/${a}/upkeep`,{method:"POST"})}getTribulation(a){return this.request(`/player/${a}/tribulation`)}fightTribulation(a){return this.request(`/player/${a}/tribulation/fight`,{method:"POST"})}getCurrencies(){return this.request("/crafting/currencies")}applyCurrency(a,t,c,o=-1){return this.request(`/player/${a}/crafting/apply`,{method:"POST",body:JSON.stringify({currencyId:t,itemId:c,lockAffixIndex:o})})}getShops(a){return this.request("/shops")}buyFromShop(a,t,c,o=1){return this.request(`/player/${a}/shop/buy`,{method:"POST",body:JSON.stringify({shopId:t,itemId:c,quantity:o})})}getMarketTax(){return this.request("/market/tax")}searchPlayers(a){return this.request(`/players/lookup?q=${encodeURIComponent(a)}`)}getPlayerProfile(a){return this.request(`/player/${a}/profile`)}getArena(a){return this.request(`/player/${a}/arena`)}arenaFight(a){return this.request(`/player/${a}/arena/fight`,{method:"POST"})}getAuctions(a=""){return this.request(`/auction${a?"?q="+encodeURIComponent(a):""}`)}getMyAuctions(a){return this.request(`/player/${a}/auction/mine`)}listAuction(a,t,c,o=24){return this.request(`/player/${a}/auction/list`,{method:"POST",body:JSON.stringify({itemId:t,buyoutPrice:c,durationHours:o})})}buyAuction(a,t){return this.request(`/player/${a}/auction/buy`,{method:"POST",body:JSON.stringify({listingId:t})})}cancelAuction(a,t){return this.request(`/player/${a}/auction/cancel`,{method:"POST",body:JSON.stringify({listingId:t})})}getDailyQuests(a){return this.request(`/player/${a}/daily-quests`)}claimDailyQuest(a,t){return this.request(`/player/${a}/daily-quests/claim`,{method:"POST",body:JSON.stringify({questId:t})})}getWorldBoss(){return this.request("/world-boss")}attackWorldBoss(a){return this.request(`/player/${a}/world-boss/attack`,{method:"POST"})}getGachaPools(){return this.request("/gacha/pools")}getGachaPity(a){return this.request(`/player/${a}/gacha/pity`)}gachaPull(a,t,c=1){return this.request(`/player/${a}/gacha/pull`,{method:"POST",body:JSON.stringify({poolId:t,pulls:c})})}getLeaderboard(a){return this.request(`/leaderboard/${a}`)}getActiveEvents(){return this.request("/events/active")}quickEvent(a){return this.request(`/events/quick/${a}`,{method:"POST"})}}const q=new ot;function ct(r,a){var g;const{state:t,api:c,notify:o,renderGame:k,updateSidebar:v}=a,l=t.player,b=t.exploration?t.exploration[l.currentArea||"thanh_lam_tran"]:null,f=b?b.name:"Vùng Đất Vô Danh",h=b?b.staminaCost:10;r.innerHTML=`
    ...
    <div class="panel mt-md">
      ...
      <div class="panel-body no-pad" id="areaMonstersList" style="max-height: 250px; overflow-y: auto;">
              ...
              <span class="text-blue">🛡 ${d.stats.defense}</span>`);let C="";T>=4&&d.drops&&d.drops.length>0&&(C=`<div class="text-xs text-dim mt-sm" style="display:flex;gap:4px;flex-wrap:wrap;">
            ...
            </div>`);let S="";if(T>=5){const _=((I=d.goldReward)==null?void 0:I[0])??((M=d.goldReward)==null?void 0:M.min)??"?",B=((P=d.goldReward)==null?void 0:P[1])??((N=d.goldReward)==null?void 0:N.max)??"?";S=`<span class="text-gold">💰 ${_}-${B}</span> <span class="text-purple">✨ ${d.xpReward??"?"} XP</span>`}return`
            ...
            </div>`}).join(""),e.querySelectorAll(".btn-attack-tracked").forEach(d=>{d.addEventListener("click",s=>{const y=s.currentTarget;W(a,y.dataset.mid,y.dataset.inst)})})}}catch(n){console.error("Lỗi tải dấu vết:",n)}})(),(async()=>{const n=document.getElementById("areaMonstersList");if(n)try{const e=await c.getAreaMonsters(l.id),i=t.exploration?t.exploration[l.currentArea||"thanh_lam_tran"]:null,d=(t.monsters||[]).filter(y=>!y.isWorldBoss&&!y.is_world_boss),s=d.length>0?d:[];if(s.length===0){n.innerHTML='<div style="padding: 16px; text-align: center;" class="text-dim">Không rõ quần thể yêu thú nơi đây.</div>';return}n.innerHTML=s.map(y=>{let x='<div class="item-desc text-sm text-dim mb-sm">Thông tin mờ ảo...</div>';return T>=1&&(x=`<div class="item-desc text-sm text-dim mb-sm">${y.description||"Yêu thú sinh sống tại vùng này."}</div>`),`
  ...
  `,r.querySelectorAll(".accordion-header").forEach(T=>{T.addEventListener("click",()=>{const p=T.nextElementSibling;p.style.display==="none"?(p.style.display="block",T.querySelector("div:last-child").textContent="▲"):(p.style.display="none",T.querySelector("div:last-child").textContent="▼")})}),r.querySelectorAll(".btn-learn").forEach(T=>{T.addEventListener("click",async p=>{p.stopPropagation();try{const u=await c.learnSkill(k.id,T.dataset.sid);u.error?o(u.error,"error"):(t.player=u.player,o(u.message,"success"),X(r,a))}catch(u){o("Lỗi học kỹ năng: "+u.message,"error")}})})}function ut(r,a){var u,m,g;const{state:t,api:c,notify:o,renderGame:k}=a,v=t.player,l=v.stats,b=v.allocatedStats||{},f=5,h=v.currentEnergy>=f&&!v.hospitalRemaining,T=v.talentDisplay||{},p=[["strength","💪","Sức mạnh","Tăng sát thương mỗi đòn"],["speed","🏃","Tốc độ","Tăng hit chance, giảm escape"],["dexterity","🎯","Khéo léo","Tăng dodge, escape, stealth"],["defense","🛡","Phòng thủ","Giảm sát thương nhận vào"]];r.innerHTML=`
    ...
    <div class="panel" style="margin-bottom:12px">
      ...
      <div class="panel-body" style="padding:12px 16px">
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;text-align:center">
          ${p.map(([n,e,i])=>{const d=T[n]||{value:1,name:"Phàm Cốt",icon:"⚪",color:"#ccc"};return`
    ...
    <div class="panel">
      ...
      <div class="panel-body no-pad">
        ${p.map(([n,e,i,d])=>{const s=T[n]||{value:1,name:"Phàm Cốt",icon:"⚪",color:"#ccc"},y=Math.floor(v.currentEnergy/f)||0;return`
          <div class="stat-row" style="padding:12px 16px">
            ...
            <div class="stat-val flex items-center gap-3">
              ...
              <button class="btn btn--sm ${h?"btn--blue":"btn--dark"} train-btn" data-train="${n}" ${h?"":"disabled"} title="Tốn ${f} Linh lực/lần · Căn cốt ×${s.value}">Rèn Luyện</button>
            </div>
          </div>
        `}).join("")}
    ...
    </div>`,(g=r.querySelector(".btn-breakthrough"))==null||g.addEventListener("click",async()=>{try{const n=r.querySelector(".btn-breakthrough");n.disabled=!0,n.innerHTML="Đang Độ Kiếp...";const e=await c.attemptBreakthrough(t.playerId);t.player=e.player,o(e.message,"success"),k()}catch(n){o(n.message||"Đột phá thất bại","error");const e=r.querySelector(".btn-breakthrough");e&&(e.disabled=!1,e.innerHTML="⚡ Đột Phá Cảnh Giới!")}}),r.querySelectorAll(".train-btn").forEach(n=>{n.addEventListener("click",async e=>{e.stopPropagation();const i=r.querySelector(`.train-count[data-stat="${n.dataset.train}"]`),d=parseInt(i==null?void 0:i.value)||1;try{const s=await c.trainStat(t.playerId,n.dataset.train,d);t.player=s.player,o(s.message,"success"),k()}catch(s){o(s.message||"Lỗi rèn luyện","error")}})})}function Y(r,a){var i;const{state:t,api:c,notify:o,renderGame:k}=a,v=t.player,l=t.educationTrees||[],b=v.unlockedNodes||[],f=v.studyingNode||"",h=f?f.split("|")[0]:"",T=v.studyEndsAt||0,p=Math.max(0,T-Math.floor(Date.now()/1e3)),u=v.treeProgress||{},m=v.skillProgress||{};let g=localStorage.getItem("eduActiveTree")||((i=l[0])==null?void 0:i.id),n=l.find(d=>d.id===g)||l[0];!n&&l.length>0&&(n=l[0]);const e=()=>{if(!n){r.innerHTML='<div class="p-lg">Chưa có dữ liệu tu luyện.</div>';return}const d=l.map(S=>`
      <button class="edu-tab ${S.id===n.id?"active":""}" data-tab="${S.id}">
        ...
        <span class="edu-tab-badge">${u[S.id]||0}</span>
      </button>
    `).join("");let s="";if(h){let S=null,I=null;l.forEach(M=>{const P=M.nodes.find(N=>N.id===h);P&&(S=P,I=M)}),S&&(s=`
        ...
        `)}const y=u[n.id]||0;let x=null;for(const S of n.milestones||[])if(y<S.require){x=S;break}let $="";x?$=`
      ...
      `:$='<div class="text-green text-sm flex items-center gap-2"><div style="font-size:24px">🌟</div> Cảnh giới đã viên mãn! Không còn chướng ngại.</div>';const w=v.discoveredNodes||[],L=(n.nodes||[]).map(S=>{const I=b.includes(S.id),M=h===S.id,P=(S.prerequisites||[]).every(A=>b.includes(A)),N=n.nodes.some(A=>(A.prerequisites||[]).includes(S.id));if(!(w.includes(S.id)||I||!(S.prerequisites&&S.prerequisites.length>0))||I&&N)return"";let _="";M?_="studying":I?_="done":_="available";let B="";M?B='<button class="btn btn--sm" disabled>Đang Lãnh Ngộ...</button>':h?B='<button class="btn btn--sm" disabled>Tâm trí bận rộn</button>':I?B=`<button class="btn btn--sm btn--gold btn-learn" data-node="${S.id}">Tiếp Tục Lãnh Ngộ (${S.duration}s)</button>`:P?B=`<button class="btn btn--sm btn--blue btn-learn" data-node="${S.id}">Bắt Đầu (${S.duration}s)</button>`:B='<button class="btn btn--sm" disabled>Chưa đả thông kinh mạch</button>';const j=m[S.id]||{level:1,exp:0},dt=j.level*100;let U="";return I&&(U=`<div class="text-xs text-gold mt-xs">Cảnh giới: ${j.level} | Độ hiểu thấu: ${j.exp}/${dt}</div>`),`
    ...
    `,r.querySelectorAll(".edu-tab").forEach(S=>{S.addEventListener("click",()=>{const I=S.dataset.tab;localStorage.setItem("eduActiveTree",I),g=I,n=l.find(M=>M.id===I)||l[0],e()})}),window.eduTimer&&clearInterval(window.eduTimer),h&&T>0&&(window.eduTimer=setInterval(()=>{const S=Math.floor(Date.now()/1e3);let I=Math.max(0,T-S);const M=document.getElementById("eduCounter");if(M&&(M.innerText=I+"s"),I<=0){clearInterval(window.eduTimer);const P=document.getElementById("btnCheckEdu");P&&(P.disabled=!1,P.innerHTML="✨ Đột Phá!")}},1e3));const C=r.querySelector("#btnCheckEdu");C&&C.addEventListener("click",async()=>{try{C.disabled=!0,C.innerHTML="Đang xử lý...";const S=await c.checkEducation(t.playerId);t.player=S.player,o(S.message,S.completed?"success":"info"),k()}catch(S){o(S.message||"Lỗi đột phá","error"),C.disabled=!1,C.innerHTML="Thử lại"}}),r.querySelectorAll(".btn-learn").forEach(S=>{S.addEventListener("click",async()=>{try{const I=S.dataset.node;S.disabled=!0,S.innerHTML="Chờ...";const M=await c.enrollNode(t.playerId,I,n.id);t.player=M.player,o(M.message,"success"),k()}catch(I){o(I.message||"Lỗi ghi danh","error"),S.disabled=!1,S.innerHTML="Bắt Đầu"}})})};e()}function vt(r,a){const{state:t,api:c,notify:o,renderGame:k}=a,v=t.player.skills||[],l=v.map(p=>typeof p=="string"?p:p.id),b=t.skills||[],f={combat:{icon:"⚔️",name:"Chiến Đấu",desc:"Chiêu thức sử dụng trong giao đấu"},life:{icon:"🛠️",name:"Sinh Hoạt",desc:"Thu thập, chế tạo, sinh tồn"},internal:{icon:"🧘",name:"Nội Công",desc:"Thụ động tăng cường bản thân"},gongfa:{icon:"📖",name:"Công Pháp",desc:"Tu luyện công pháp, nâng cao cảnh giới"}};let h=localStorage.getItem("skillsTab")||"combat";const T=()=>{if(h==="gongfa"){const e=Object.entries(f).map(([d,s])=>{const y=d==="gongfa"?(t.educationTrees||[]).length:v.filter(x=>{const $=typeof x=="string"?x:x.id,w=b.find(L=>L.id===$);return w&&(w.category||"combat")===d}).length;return`<button class="skill-tab ${d===h?"active":""}" data-tab="${d}">
          ${s.icon} ${s.name} <span class="skill-tab-count">${y}</span>
      ...
      `,r.querySelectorAll(".skill-tab").forEach(d=>{d.addEventListener("click",()=>{h=d.dataset.tab,localStorage.setItem("skillsTab",h),T()})});const i=r.querySelector("#gongfa-content");i&&Y(i,a);return}const p=v.map(e=>{const i=typeof e=="string"?e:e.id;return{...b.find(s=>s.id===i)||{name:i,id:i,category:"combat"},level:e.level||1,xp:e.xp||e.currentXp||0,equipped:e.equipped||e.isEquipped||!1}}),u=p.filter(e=>(e.category||"combat")===h),m=b.filter(e=>(e.category||"combat")===h&&!l.includes(e.id)),g=Object.entries(f).map(([e,i])=>{const d=e==="gongfa"?(t.educationTrees||[]).length:p.filter(s=>(s.category||"combat")===e).length;return`<button class="skill-tab ${e===h?"active":""}" data-tab="${e}">
        ${i.icon} ${i.name} <span class="skill-tab-count">${d}</span>
      </button>`}).join(""),n=(e,i)=>{const d=e.level*100,s=Math.min(100,e.xp/d*100),y=e.type==="passive",x="★".repeat(Math.min(e.tier||1,7)),$=(e.tier||1)>=5?"var(--gold)":(e.tier||1)>=3?"var(--purple)":"var(--blue)";let w="";return i?y?w='<span style="font-size:10px;color:var(--green)">🔮 Vĩnh Viễn</span>':e.equipped?w=`<button class="btn btn--sm btn--red equip-btn" data-eq="0" data-sid="${e.id}">Tháo</button>`:w=`<button class="btn btn--sm btn--blue equip-btn" data-eq="1" data-sid="${e.id}">Trang Bị</button>`:w='<span class="text-dim" style="font-size:11px">Chưa lĩnh ngộ</span>',`
        <div class="skill-card ${i?"":"locked"} ${e.equipped&&!y?"equipped":""}">
    ...
    <div class="panel">
    ...
    </div>`;const g=document.getElementById("invTabContent"),n=()=>{g.querySelectorAll("[data-eid]").forEach(w=>{w.addEventListener("click",async L=>{L.stopPropagation();try{const C=await c.equipItem(t.playerId,w.dataset.eid);t.player=C.player,o(C.message,"success"),k()}catch(C){o(C.message||"Lỗi trang bị","error")}})}),g.querySelectorAll("[data-use]").forEach(w=>{w.addEventListener("click",async L=>{L.stopPropagation();try{const C=await c.useItem(t.playerId,w.dataset.use);t.player=C.player,o(C.message,"success"),k()}catch(C){o(C.message||"Lỗi sử dụng","error")}})})};if(h==="equipped"){const w=l.equipment||{},L=[{key:"weapon",icon:"⚔️",name:"Vũ Khí"},{key:"body",icon:"🥋",name:"Giáp"},{key:"shield",icon:"🛡️",name:"Thuẫn"},{key:"feet",icon:"👢",name:"Hài"},{key:"ring1",icon:"💍",name:"Nhẫn 1"},{key:"ring2",icon:"💍",name:"Nhẫn 2"}];g.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;padding:10px 14px">
        ${L.map(C=>{const S=w[C.key],I=S&&S.id,M=I?`rarity-${S.rarity}`:"";return`
      ...
      ${v.length>0?`
        ...
        ${v.filter(C=>C&&C.id).map(C=>Q(C,!1)).join("")}
      `:""}
    `,n()}else if(h==="medicine")g.innerHTML=`
      <div style="padding:12px">
        ...
        ${b.length===0?'<div class="text-dim text-center mt-3">Túi trống không.</div>':b.map(w=>`
          ...
          `).join("")}
      </div>`,g.querySelectorAll("[data-med]").forEach(w=>{w.addEventListener("click",async()=>{try{const L=await c.useMedicine(t.playerId,w.dataset.med);t.player=L.player,o(L.message,"success"),k()}catch(L){o(L.message||"Đan độc quá nồng!","error")}})});else{const w=l.inventory||[];let L=[];h==="weapon"?L=w.filter(C=>C.slot==="weapon"&&C.category!=="manual"):h==="armor"?L=w.filter(C=>["body","shield","feet"].includes(C.slot)):h==="accessory"?L=w.filter(C=>["ring","amulet","ring1","ring2"].includes(C.slot)):h==="manual"&&(L=w.filter(C=>C.category==="manual")),g.innerHTML=`
      ${L.length===0?'<div style="padding:20px; text-align:center" class="text-dim">Không có vật phẩm loại này.</div>':L.map(C=>Q(C,!0)).join("")}
    `,n()}r.querySelectorAll("[data-tab]").forEach(w=>{w.addEventListener("click",()=>{t.inventoryTab=w.dataset.tab,K(r,a)})}),($=document.getElementById("btnGen"))==null||$.addEventListener("click",async()=>{const w=["common","rare","epic","legendary"];try{const L=await c.generateItem(t.playerId,w[Math.floor(Math.random()*w.length)]);t.player=L.player,t.items=L.items||[],o(L.message,"success"),K(r,a)}catch{o("Lỗi tạo ngẫu nhiên","error")}})}function yt(r,a){var d,s;const{state:t,api:c,notify:o,renderGame:k}=a,v=t.player,l=t.crimes||[];if((v.jailRemaining??0)>0){const y=v.jailRemaining,x=Math.max(10,100*Math.ceil(y/60)*v.level);r.innerHTML=`
    ...
    <div class="panel mt-md" style="border-color: ${$.color}40;">
      ...
      <div class="panel-body no-pad">
        ${x.map(w=>{var P;const L=((P=v.crimeSkills)==null?void 0:P[w.id])??0,C=L<(w.minSkill??0),S=!C&&(v.nerve??0)>=w.nerveCost,I=w.special||[],M=Math.min(95,w.baseSuccessRate+L*.5);return`
              ...
              <div class="item-info">
                ...
                ${I.length>0?`
                  <div style="margin-top:4px;display:flex;flex-wrap:wrap;gap:4px;">
                    ${I.map(N=>`<span class="badge" style="background:rgba(255,255,255,0.08);font-size:10px;padding:1px 5px;">${h[N]||N}</span>`).join("")}
                  </div>
                `:""}
              </div>
    ...
    </div>`}).join(""),u=v.crimeExp||0,m=Math.floor(u/50),g=u%50,n=50,e=g/n*100,i=`
  ...
  `;r.innerHTML=`
    ...
    ${p}`,r.querySelectorAll("[data-crime]").forEach(y=>{y.addEventListener("click",async()=>{try{const x=await c.commitCrime(t.playerId,y.dataset.crime);t.player=x.player;const $=x.outcome==="success"?"success":x.outcome==="critical_fail"?"error":"info";o(x.message,$),k()}catch(x){o(x.message||"Lỗi","error")}})})}function Z(r,a){const{state:t,api:c,notify:o,updateSidebar:k,renderGame:v}=a,l=t.playerId;t._dungeon||(t._dungeon={mapItems:[],activeRun:null,history:[],loaded:!1,combatLog:[],lastLoot:[],lastResult:null});const b=t._dungeon;async function f(){try{const[n,e]=await Promise.all([c.getMapItems(l),c.getDungeonHistory(l)]);b.mapItems=n.mapItems||[],b.activeRun=n.activeRun||null,b.history=e.history||[],b.loaded=!0,h()}catch(n){o(n.message||"Lỗi tải Bí Cảnh","error")}}function h(){r.innerHTML=`
      ...
      ${m()}
    `,g()}function T(){var d,s;const n=b.activeRun,e=n.currentWave===n.totalWaves,i=((n.currentWave-1)/n.totalWaves*100).toFixed(0);return`
    ...
    `}function u(){var d,s;const n=b.lastResult,e=n.result==="dungeon_complete"?"🏆":n.result==="wave_cleared"?"✅":"💀",i=n.result==="dungeon_failed"?"var(--red)":"var(--gold)";return`
    ...
    `}function g(){var n,e;document.querySelectorAll("[data-enter]").forEach(i=>{i.addEventListener("click",async()=>{const d=i.dataset.enter;if(confirm("⚡ Kích hoạt Ngọc Giản và vào Bí Cảnh?")){i.disabled=!0;try{const s=await c.enterDungeon(l,d);o(s.message,"success"),t.player=s.player,k(),b.activeRun=s.run,b.lastResult=null,await f()}catch(s){o(s.message,"error"),i.disabled=!1}}})}),(n=document.getElementById("btnFight"))==null||n.addEventListener("click",async()=>{const i=document.getElementById("btnFight");i.disabled=!0,i.textContent="⏳ Đang chiến đấu...";try{const d=await c.fightDungeonWave(l);t.player=d.player,k(),b.lastResult=d,d.result==="dungeon_complete"||d.result==="dungeon_failed"?b.activeRun=null:d.result==="wave_cleared"&&(b.activeRun.currentWave=d.nextWave),h()}catch(d){o(d.message,"error"),i.disabled=!1,i.textContent="⚔️ Chiến Đấu"}}),(e=document.getElementById("btnAbandon"))==null||e.addEventListener("click",async()=>{if(confirm("🚪 Bỏ cuộc? Ngọc Giản sẽ không được hoàn lại!"))try{await c.abandonDungeon(l),o("Đã rời khỏi Bí Cảnh.","info"),b.activeRun=null,b.lastResult=null,await f()}catch(i){o(i.message,"error")}})}b.loaded?h():f()}function tt(r,a){const{state:t}=a,c=t._travelTab||"map";r.innerHTML=`
    <div class="page-header">
      <h1>🗺️ Ngao Du</h1>
  ...
  `,r.querySelectorAll(".tab-btn").forEach(k=>{k.addEventListener("click",()=>{t._travelTab=k.dataset.tab,tt(r,a)})});const o=r.querySelector("#travelTabContent");c==="map"?O(o,a):Z(o,a)}async function O(r,a){const{state:t,api:c,notify:o,updateSidebar:k}=a;r.innerHTML='<div class="loading" style="padding:20px; text-align:center">Đang mở địa đồ...</div>';try{const[v,l]=await Promise.all([c.request("/data/areas"),c.request(`/player/${t.playerId}/area`)]),b=v.areas||[],f=l.area,h=l.player,T=l.traveling||!1,p=l.travelRemaining||0,u=l.travelDestination||"";l.message&&o(l.message,"success"),l.player&&(t.player=l.player,k());const m=t.exploration||{},g=m[(h==null?void 0:h.currentArea)||"thanh_lam_tran"],n=(f==null?void 0:f.name)||(g==null?void 0:g.name)||"Vùng Đất Vô Danh",e=(g==null?void 0:g.staminaCost)||10,i={hac_phong_lam:"🌲 Rừng rậm: +5% Tốc Độ",vong_linh_coc:"👻 Âm khí: +10% Nhanh Nhẹn",thiet_huyet_son:"🌋 Nóng bức: +10% ST Hỏa",thien_kiep_uyen:"⚡ Lôi điện: +15% Tốc Độ",bac_suong_canh:"❄️ Đóng băng: -10% Tốc Độ",am_sat_hoang:"🎯 Sát khí: +15 Nhanh Nhẹn",co_moc_linh_vien:"🌳 Linh mộc: +15% Phòng Ngự",huyet_ma_chien_truong:"🩸 Huyết chiến: +30% ST, +20% ST nhận",thien_hoa_linh_dia:"🔥 Địa hỏa: +25% ST Hỏa",u_minh_quy_vuc:"💀 U minh: -15% Phòng Ngự",thien_dao_tan_tich:"✨ Thiên đạo: +15% Toàn Chỉ Số",vo_tan_hu_khong:"🌀 Hỗn loạn: +50% ST Gây & Nhận"},d=i[h==null?void 0:h.currentArea]||"",s=[...b].sort((x,$)=>(x.sort_order||x.mapY||0)-($.sort_order||$.mapY||0)),y=[...b].sort((x,$)=>(x.mapY||0)-($.mapY||0));if(r.innerHTML=`
      ...
      <div class="panel mt-md">
        ...
        <div class="panel-body no-pad" style="position:relative; width:100%; height:300px; background-color: #0f172a; background-image: radial-gradient(rgba(255,255,255,0.05) 1px, transparent 1px); background-size: 20px 20px; overflow:hidden; border-radius:0 0 8px 8px">
          ...
          ${y.map(x=>{const $=m[x.id],w=x.id===h.currentArea&&!T,L=h.level<(x.min_level||1),C=($==null?void 0:$.mapX)||50,S=($==null?void 0:$.mapY)||50,I=w?"var(--green)":L?"var(--red)":"var(--blue)",M=w?`box-shadow: 0 0 15px ${I}; animation: pulse 2s infinite`:"",P=!w&&!L&&!T;return`
              <div class="map-node ${P?"clickable":""}" ${P?`data-travel="${x.id}"`:""} 
      ...
      <div class="panel mt-md">
        ...
        <div class="panel-body no-pad" style="max-height: 300px; overflow-y:auto">
          ${s.map(x=>{const $=m[x.id],w=x.id===h.currentArea&&!T,L=h.level<(x.min_level||1),C=parseInt(x.travel_time)||0,S=($==null?void 0:$.staminaCost)||"?",I=i[x.id]||"";return`
      ...
      </div>`,r.querySelectorAll("[data-travel]").forEach(x=>{x.addEventListener("click",async $=>{$.stopPropagation();const w=x.dataset.travel;r.querySelectorAll("[data-travel]").forEach(L=>{L.tagName==="BUTTON"&&(L.disabled=!0),L.style.pointerEvents="none"});try{const L=await c.request(`/player/${t.playerId}/travel`,{method:"POST",body:JSON.stringify({areaId:w})});L.player&&(t.player=L.player,k()),o(L.message,"success"),O(r,a)}catch(L){o(L.message||"Lỗi di chuyển!","error"),O(r,a)}})}),T&&p>0){let x=p;const $=p,w=setInterval(async()=>{x--;const L=document.getElementById("travelTimer"),C=document.getElementById("travelBar");if(L&&(L.textContent=`⏳ ${Math.max(0,x)}s`),C&&(C.style.width=`${Math.max(0,x/$*100)}%`),x<=0){clearInterval(w);try{const S=await c.request(`/player/${t.playerId}/travel-check`,{method:"POST"});S.player&&(t.player=S.player,k()),S.arrived&&o(S.message,"success"),O(r,a)}catch{O(r,a)}}},1e3)}}catch(v){r.innerHTML='<div class="panel"><div class="panel-body text-dim">Lỗi tải dữ liệu khu vực</div></div>',console.error(v)}}function F(r,a){var i,d;const{state:t,renderGame:c,notify:o,updateSidebar:k}=a,v=t.player,l=t.recipes||[],b=t.medicines||[],f=t._alchemyTab||"recipes",h=s=>{const y=b.find(x=>x.id===s);return y?(y.icon||"💊")+" "+y.name:s};let T=0,p=0,u=0,m=0;(v.skills||[]).forEach(s=>{const y=typeof s=="string"?s:s.id,x=typeof s=="string"?1:s.level||1;y==="tinh_che"&&(T=x*2),y==="phu_an_thuat"&&(p=x*5),y==="linh_kiem_thuat"&&(u=x*10),y==="cuong_hoa_thuat"&&(m=x*15)});const g=s=>s.split("_").map(y=>y.charAt(0).toUpperCase()+y.slice(1)).join(" "),n=[];Object.values(v.equipment||{}).forEach(s=>{s&&n.push({...s,loc:"eq"})}),(v.inventory||[]).filter(s=>s.slot&&s.slot!=="consumable").forEach(s=>n.push({...s,loc:"inv"}));let e=`
    <div class="page-header">
  ...
  `;if(f==="recipes"){if(e+=`<div class="panel"><div class="panel-title">🌿 Khí Hải Tàng Trữ (Nguyên Liệu)</div>
      <div class="panel-body flex gap-2" style="overflow-x:auto;padding-bottom:12px;white-space:nowrap">`,!v.materials||Object.keys(v.materials).length===0)e+='<div style="color:var(--text-dim);font-size:14px;padding:8px 0">Nguyên liệu trống không...</div>';else for(const[s,y]of Object.entries(v.materials))e+=`<div class="badge" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);padding:4px 8px">${g(s)} <span style="color:var(--gold)">x${y}</span></div>`;e+="</div></div>",e+='<div class="panel"><div class="panel-title">🔥 Bản Ghi Công Thức</div><div class="panel-body no-pad">',l.length===0?e+='<div style="padding:16px" class="text-dim">Chưa có công thức...</div>':l.forEach(s=>{var C;const y=h(s.target),x=Math.min(100,(s.successRate||100)+T);let $="";(C=s.requirements)!=null&&C.skill&&($=`<div class="text-orange" style="font-size:12px;margin-bottom:8px">Yêu cầu: ${g(s.requirements.skill)} lv${s.requirements.level||1}</div>`);let w="";s.materials.forEach(S=>{var M;const I=((M=v.materials)==null?void 0:M[S.id])||0;w+=`<span style="font-size:13px;margin-right:12px;display:inline-block;background:rgba(255,255,255,0.05);padding:2px 6px;border-radius:4px"><span style="color:${I>=S.amount?"var(--green)":"var(--red)"};font-weight:bold">${I}/${S.amount}</span> ${g(S.id)}</span>`});const L=b.find(S=>S.id===s.target)||{};e+=`
          <div class="list-item" style="flex-direction:column;padding:0;align-items:stretch">
        ...
        ${[{id:"tay_tuy_phu",name:"Tẩy Tủy Phù",icon:"🔄",desc:"Xóa toàn bộ affix và roll lại",cost:200},{id:"hon_chu_phu",name:"Hỗn Chú Phù",icon:"➕",desc:"Thêm 1 affix (tối đa 4)",cost:500},{id:"thien_menh_phu",name:"Thiên Mệnh Phù",icon:"🔒",desc:"Khóa 1 affix, reroll còn lại",cost:1e3},{id:"thang_cap_phu",name:"Thăng Cấp Phù",icon:"⬆️",desc:"Tăng item level +1 (max +5)",cost:1500}].map(s=>{const y=Math.max(1,Math.round(s.cost*(1-p/100)));return`
            <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:12px">
              ...
              <button class="btn btn--gold btn--sm btn-currency" data-cid="${s.id}" style="width:100%">
                💎 ${y} ${p>0?`<s style="opacity:0.4;font-size:10px">${s.cost}</s>`:""}
              </button>
            </div>`}).join("")}
      </div>
    `;r.innerHTML=e,r.querySelectorAll(".tab-btn").forEach(s=>{s.addEventListener("click",()=>{t._alchemyTab=s.dataset.tab,F(r,a)})}),r.querySelectorAll(".accordion-header").forEach(s=>{s.addEventListener("click",()=>{const y=s.nextElementSibling;y.style.display==="none"?(y.style.display="block",s.querySelector(".text-dim:last-child").textContent="▲"):(y.style.display="none",s.querySelector(".text-dim:last-child").textContent="▼")})}),r.querySelectorAll(".btn-craft").forEach(s=>{s.addEventListener("click",async y=>{y.stopPropagation();const x=l.find($=>$.id===s.dataset.recipe);if(x&&v.gold<(x.cost||0))return o("Không đủ linh thạch!","error");try{const $=await q.craftItem(v.id,s.dataset.recipe);t.player=$.player,o($.message,$.success?"success":"error"),c()}catch($){o($.message,"error")}})}),r.querySelectorAll(".btn-currency").forEach(s=>{s.addEventListener("click",async()=>{const y=document.getElementById("selItem");if(!(y!=null&&y.value))return o("Chọn trang bị trước!","error");const x=s.dataset.cid;let $=-1;if(x==="thien_menh_phu"){const w=n.find(S=>S.id===y.value),L=(w==null?void 0:w.affixes)||[];if(L.length===0)return o("Item không có affix để khóa!","error");const C=prompt(`Chọn affix để khóa (0-${L.length-1}):
${L.map((S,I)=>`${I}: ${S.name||S.stat} +${S.value}`).join(`
`)}`);if(C===null)return;if($=parseInt(C),isNaN($)||$<0||$>=L.length)return o("Chỉ số không hợp lệ!","error")}s.disabled=!0,s.textContent="⏳...";try{const w=await q.applyCurrency(v.id,x,y.value,$);o(w.message,"success"),t.player=w.player,k(),F(r,a)}catch(w){o(w.message,"error"),s.disabled=!1,s.textContent="💎 Dùng"}})}),(i=document.getElementById("selItem"))==null||i.addEventListener("change",()=>{const s=n.find(x=>x.id===document.getElementById("selItem").value),y=document.getElementById("itemPreview");s&&y&&(y.innerHTML=(s.affixes||[]).map(x=>`<span style="color:var(--blue)">• ${x.name||x.stat} +${x.value}</span>`).join(" | ")||"Không có affix")}),(d=document.getElementById("selItem"))==null||d.dispatchEvent(new Event("change"))}function bt(r,a){const{state:t,api:c,notify:o,renderGame:k}=a;t.player,r.innerHTML=`
    <div class="page-header">
      <h2>🏷️ Nhiệm Vụ</h2>
  ...
  `,document.getElementById("adminTabs").addEventListener("click",e=>{const i=e.target.closest(".admin-tab");i&&(l=i.dataset.tab,document.querySelectorAll(".admin-tab").forEach(d=>d.classList.remove("active")),i.classList.add("active"),b(l))}),b(l);async function b(e){const i=document.getElementById("adminContent");if(i){i.innerHTML='<div class="loading-spinner">⏳ Đang tải...</div>';try{const d=await c.request(`/admin/${e}?adminId=${t.playerId}`);f(e,d,i)}catch(d){i.innerHTML=`<div class="panel"><div class="panel-body text-red">Lỗi: ${d.message}</div></div>`}}}function f(e,i,d){e==="monsters"?h(i,d):e==="npcs"?T(i,d):e==="areas"?p(i,d):u(e,i,d)}function h(e,i){const d=e.monsters||[];i.innerHTML=`
    ...
    `,g(i,e,"monsters","monsters")}function T(e,i){const d=e.npcs||[];i.innerHTML=`
      <div class="admin-table-header">
    ...
    `,g(i,e,"npcs","npcs")}function p(e,i){const d=Object.keys(e);i.innerHTML=`
      <div class="admin-table-header">
        <span class="text-dim">${d.length} khu vực</span>
      </div>
      <div class="admin-grid">
        ${d.map(s=>{const y=e[s];return`
    ...
    `,i.querySelectorAll(".admin-edit-area").forEach(s=>{s.addEventListener("click",()=>{const y=s.dataset.id,x=e[y];m(y,x,`areas/${y}`)})})}function u(e,i,d){var x;const s=JSON.stringify(i,null,2),y=s.split(`
`).length;d.innerHTML=`
      <div class="admin-table-header">
        <span class="text-dim">${e} — Raw JSON Editor</span>
        <button class="btn btn--gold btn--sm" id="btnSaveGeneric">💾 Lưu</button>
      </div>
      <textarea id="genericEditor" class="admin-json-editor" rows="${Math.min(y+5,30)}">${n(s)}</textarea>
    `,(x=document.getElementById("btnSaveGeneric"))==null||x.addEventListener("click",async()=>{try{const $=document.getElementById("genericEditor").value,w=JSON.parse($);o("Generic save chưa hỗ trợ — vui lòng dùng editor chi tiết.","error")}catch($){o("JSON không hợp lệ: "+$.message,"error")}})}function m(e,i,d,s){const y=JSON.stringify(i,null,2),x=document.createElement("div");x.className="admin-modal-overlay",x.innerHTML=`
    ...
    `,document.body.appendChild(x),x.querySelectorAll(".admin-modal-close").forEach($=>{$.addEventListener("click",()=>x.remove())}),x.addEventListener("click",$=>{$.target===x&&x.remove()}),document.getElementById("btnModalSave").addEventListener("click",async()=>{try{const $=document.getElementById("modalEditor").value,w=JSON.parse($);await c.request(`/admin/${d}?adminId=${t.playerId}`,{method:"PUT",body:JSON.stringify({data:w})}),o("✅ Đã lưu!","success"),x.remove(),b(l)}catch($){o("Lỗi: "+$.message,"error")}})}function g(e,i,d,s){e.querySelectorAll(".admin-edit-btn").forEach(y=>{y.addEventListener("click",()=>{const x=y.dataset.id,w=(i[s]||[]).find(L=>L.id===x);w&&m(x,w,`${d}/${x}`)})})}function n(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}function et(r,a){const{state:t,api:c,notify:o,renderGame:k,updateSidebar:v}=a,l=t.playerId;t._social||(t._social={tab:"friends",searchQuery:"",searchResults:[],relationships:{friends:[],enemies:[],pendingSent:[],pendingReceived:[]},loaded:!1});const b=t._social;async function f(){try{const g=await c.getRelationships(l);b.relationships=g,b.loaded=!0,h()}catch(g){o(g.message||"Lỗi tải dữ liệu Giao Tế","error")}}function h(){const{friends:g,enemies:n,pendingSent:e,pendingReceived:i}=b.relationships,d=i.length;r.innerHTML=`
      <div class="page-header">
        <h2>🤝 Đạo Hữu</h2>
    ...
    `).join("")}function u(g,n){let e="";return g.length>0&&(e+='<div style="font-weight:600;margin-bottom:8px;color:var(--gold)">📥 Lời mời nhận được</div>',e+=g.map(i=>`
        <div class="social-row" style="display:flex;align-items:center;justify-content:space-between;padding:10px;border-bottom:1px solid rgba(255,255,255,0.05)">
          <div>
      ...
      <div class="chat-tabs" style="display:flex;gap:8px;margin-bottom:12px">
        ...
        ${v.tab==="private"?`
          <select id="friendSelect" style="flex:1;padding:4px 8px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:6px;color:#eee;font-size:13px">
            ...
            ${v.friends.map(e=>{var i;return`<option value="${e.id}" ${((i=v.selectedFriend)==null?void 0:i.id)===e.id?"selected":""}>${e.name} (Lv.${e.level})</option>`}).join("")}
          </select>
        `:""}
      </div>
    ...
    `,g(),u()}function T(n){return n.length===0?'<div style="text-align:center;opacity:0.4;padding:40px">Chưa có tin nhắn nào...</div>':n.map(e=>{const i=e.sender_id===k,d=new Date(e.created_at).toLocaleTimeString("vi-VN",{hour:"2-digit",minute:"2-digit"});return`
      ...
      `}).join("")}function p(){const n=document.getElementById("chatMessages");if(!n)return;const e=v.tab==="global"?v.globalMessages:v.privateMessages;n.innerHTML=T(e)}function u(){const n=document.getElementById("chatMessages");n&&(n.scrollTop=n.scrollHeight)}function m(n){const e=document.createElement("div");return e.textContent=n,e.innerHTML}function g(){var e,i,d;document.querySelectorAll("[data-chat-tab]").forEach(s=>{s.addEventListener("click",()=>{v.tab=s.dataset.chatTab,v.tab==="global"&&(v.lastGlobalId=v.globalMessages.length>0?v.globalMessages[v.globalMessages.length-1].id:0),h(),b()})}),(e=document.getElementById("friendSelect"))==null||e.addEventListener("change",async s=>{const y=s.target.value;if(!y){v.selectedFriend=null,v.privateMessages=[],h();return}v.selectedFriend=v.friends.find(x=>x.id===y)||null,v.lastPrivateId=0;try{const x=await c.getPrivateChat(k,y);v.privateMessages=x.messages||[],v.privateMessages.length>0&&(v.lastPrivateId=v.privateMessages[v.privateMessages.length-1].id),p(),u()}catch(x){o(x.message,"error")}});const n=async()=>{var x,$;const s=document.getElementById("chatInput"),y=s==null?void 0:s.value.trim();if(y){if(v.tab==="private"&&!v.selectedFriend)return o("Chọn Đạo Hữu trước!","error");try{if(await c.sendChat(k,v.tab,v.tab==="private"?v.selectedFriend.id:null,y),s.value="",v.tab==="global"){const w=await c.getGlobalChat(v.lastGlobalId);((x=w.messages)==null?void 0:x.length)>0&&(v.globalMessages.push(...w.messages),v.lastGlobalId=v.globalMessages[v.globalMessages.length-1].id)}else{const w=await c.getPrivateChat(k,v.selectedFriend.id,v.lastPrivateId);(($=w.messages)==null?void 0:$.length)>0&&(v.privateMessages.push(...w.messages),v.lastPrivateId=v.privateMessages[v.privateMessages.length-1].id)}p(),u()}catch(w){o(w.message||"Lỗi gửi tin nhắn","error")}}};(i=document.getElementById("btnSend"))==null||i.addEventListener("click",n),(d=document.getElementById("chatInput"))==null||d.addEventListener("keydown",s=>{s.key==="Enter"&&n()})}a.renderGame,v.loaded?(h(),b()):l()}function ft(r,a){const{state:t,api:c,notify:o,updateSidebar:k}=a,v=t.playerId;t._market||(t._market={tab:"browse",filter:"",sort:"newest",search:"",listings:[],myListings:[],mugTargets:[],mugLog:[],mugCooldown:0,loaded:!1,showListForm:!1});const l=t._market;async function b(){try{const[n,e]=await Promise.all([c.getMarketListings(l.filter,l.sort),c.getMyListings(v)]);l.listings=n.listings||[],l.myListings=e.listings||[],l.loaded=!0,h()}catch(n){o(n.message||"Lỗi tải Giao Dịch Đài","error")}}async function f(){try{const[n,e]=await Promise.all([c.getMugTargets(v),c.getMugLog(v)]);l.mugTargets=n.targets||[],l.mugCooldown=n.mugCooldown||0,l.mugLog=e.logs||[],h()}catch(n){o(n.message||"Lỗi tải dữ liệu Cướp Đoạt","error")}}function h(){const n=t.player;r.innerHTML=`
      <div class="page-header">
        <h2>🏪 Giao Dịch Đài</h2>
    ...
    `;return l.mugTargets.length===0?n+='<div style="text-align:center;opacity:0.5;padding:20px">Không có mục tiêu nào ở khu vực này.</div>':n+=l.mugTargets.map(e=>`
      ...
      `).join(""),n+="</div></div>",l.mugLog.length>0&&(n+=`
        <div class="panel" style="margin-top:12px">
          ...
          <div class="panel-body no-pad" style="max-height:200px;overflow-y:auto">
            ${l.mugLog.map(e=>{const i=e.attacker_id===v,d=e.outcome==="success"?"✅":"❌",s=e.outcome==="success"?"var(--green)":"var(--red)",y=i?e.outcome==="success"?`Cướp ${e.victim_name}: +${e.gold_stolen} 💎`:`Phục kích ${e.victim_name} thất bại!`:e.outcome==="success"?`Bị ${e.attacker_name} cướp: -${e.gold_stolen} 💎`:`${e.attacker_name} phục kích bạn thất bại!`;return`<div class="list-item" style="padding:6px 14px;font-size:12px;color:${s}">${d} ${y} <span style="opacity:0.4;margin-left:auto">${new Date(e.created_at).toLocaleString("vi-VN")}</span></div>`}).join("")}
          </div>
        </div>
      `),n}function m(n){const e=Object.entries(n.materials||{}).map(([y,x])=>({id:y,qty:x,type:"material",name:y})),i=Object.entries(n.medicines||{}).map(([y,x])=>({id:y,qty:x,type:"medicine",name:y})),d=(n.inventory||[]).map(y=>({id:y.id,qty:1,type:"item",name:y.name||y.id})),s=[...e,...i,...d];return`
    ...
    `}function g(){var n,e,i,d;document.querySelectorAll("[data-mtab]").forEach(s=>{s.addEventListener("click",()=>{if(l.tab=s.dataset.mtab,l.tab==="mug"&&l.mugTargets.length===0){f();return}h()})}),(n=document.getElementById("btnShowList"))==null||n.addEventListener("click",()=>{l.showListForm=!l.showListForm,h()}),document.querySelectorAll("[data-filter]").forEach(s=>{s.addEventListener("click",async()=>{l.filter=s.dataset.filter,await b()})}),(e=document.getElementById("sortSelect"))==null||e.addEventListener("change",async s=>{l.sort=s.target.value,await b()}),(i=document.getElementById("searchInput"))==null||i.addEventListener("input",s=>{l.search=s.target.value,h();const y=document.getElementById("searchInput");y&&(y.focus(),y.setSelectionRange(l.search.length,l.search.length))}),(d=document.getElementById("btnConfirmList"))==null||d.addEventListener("click",async()=>{var L,C,S;const s=(L=document.getElementById("listItem"))==null?void 0:L.value;if(!s)return;const[y,x]=s.split("|"),$=parseInt((C=document.getElementById("listQty"))==null?void 0:C.value)||1,w=parseInt((S=document.getElementById("listPrice"))==null?void 0:S.value)||0;if(w<=0)return o("Giá phải lớn hơn 0!","error");try{const I=await c.listForSale(v,y,x,$,w);o(I.message,"success"),t.player=I.player,k(),l.showListForm=!1,await b()}catch(I){o(I.message,"error")}}),document.querySelectorAll("[data-buy]").forEach(s=>{s.addEventListener("click",async()=>{const y=parseInt(s.dataset.buy),x=parseInt(s.dataset.qty),$=parseInt(s.dataset.price);let w=1;if(x>1){const L=prompt(`Mua bao nhiêu? (tối đa ${x}, giá ${$} 💎/cái)`,"1");if(!L)return;w=Math.min(parseInt(L)||1,x)}s.disabled=!0;try{const L=await c.buyFromMarket(v,y,w);o(L.message,"success"),t.player=L.player,k(),await b()}catch(L){o(L.message,"error"),s.disabled=!1}})}),document.querySelectorAll("[data-cancel]").forEach(s=>{s.addEventListener("click",async()=>{s.disabled=!0;try{const y=await c.cancelListing(v,parseInt(s.dataset.cancel));o(y.message,"success"),t.player=y.player,k(),await b()}catch(y){o(y.message,"error"),s.disabled=!1}})}),document.querySelectorAll("[data-mug]").forEach(s=>{s.addEventListener("click",async()=>{const y=s.dataset.mug;if(confirm("⚠️ Xác nhận phục kích? Thất bại sẽ bị phản đòn và trọng thương!")){s.disabled=!0,s.textContent="⏳...";try{const x=await c.mugPlayer(v,y);o(x.message,x.success?"success":"error"),t.player=x.player,k(),await f()}catch(x){o(x.message,"error"),s.disabled=!1,s.textContent="💀 Phục Kích"}}})})}l.tab==="mug"?f():l.loaded?h():b()}function $t(r,a){const{state:t,api:c,notify:o,updateSidebar:k}=a,v=t.playerId;let l=!1,b=null;async function f(){try{b=await c.getRealmInfo(v),l=!0,h()}catch(u){o(u.message||"Lỗi tải Cảnh Giới","error")}}function h(){if(!b)return;const u=b.current,m=b.allRealms||[],g=t.player,n=g.xpToNext>0?Math.floor(g.xp/g.xpToNext*100):0;r.innerHTML=`
      <div class="page-header">
        ...
        ${u.bonuses?`
          <div style="margin-top:8px">
            ...
            <div style="display:flex;gap:6px;flex-wrap:wrap">
              ${Object.entries(u.bonuses).filter(([,e])=>e>0).map(([e,i])=>`
      ...
      <div class="card">
        ...
        ${m.map(e=>{const i=e.tier===u.tier,d=e.tier<u.tier,y=e.tier>u.tier?"0.35":"1";return`
            <div style="display:flex;align-items:center;gap:10px;padding:8px;border-bottom:${i?`2px solid ${e.color}`:"1px solid rgba(255,255,255,0.05)"};opacity:${y};transition:opacity 0.3s">
    ...
    `}catch(v){r.innerHTML=`<div class="panel"><div class="panel-body text-red">Lỗi tải dữ liệu sự kiện: ${v.message}</div></div>`}}function wt(r,a){const{state:t,api:c,notify:o,updateSidebar:k}=a,v=t.playerId;t._tc||(t._tc={data:null,loaded:!1,fighting:!1,tab:"atlas"});const l=t._tc;async function b(){try{l.data=await c.request(`/player/${v}/atlas-maps`),l.loaded=!0,f()}catch(g){o(g.message,"error")}}function f(){const g=l.data,n=(g==null?void 0:g.atlas)||{},e=(g==null?void 0:g.maps)||[],i=g==null?void 0:g.activeRun,d=(g==null?void 0:g.allMaps)||[];g!=null&&g.modifiers,r.innerHTML=`
      <div class="page-header">
        <h2>🗺️ Tiên Cảnh</h2>
    ...
    `,r.querySelectorAll("[data-tab]").forEach(y=>{y.addEventListener("click",()=>{l.tab=y.dataset.tab,f()})});const s=document.getElementById("tcContent");s&&(i&&l.tab==="run"?u(s,i):l.tab==="inventory"?T(s,e):h(s,d,n))}function h(g,n,e){var d;const i=((d=l.data)==null?void 0:d.tiers)||[];g.innerHTML=i.map(s=>{const y=n.filter(x=>x.tier===s.tier);return`
    ...
    </div>`,e.addEventListener("click",async d=>{const s=d.target.closest("[data-modid]");if(s)try{const y=await c.request(`/player/${v}/atlas-maps/modify`,{method:"POST",body:JSON.stringify({mapIndex:g,modifierId:s.dataset.modid})});o(y.message,"success"),t.player=y.player,k(),e.remove(),await b()}catch(y){o(y.message,"error")}else d.target===e&&e.remove()}),document.body.appendChild(e)}function u(g,n){var d,s;const e=n.currentWave/n.totalWaves*100,i=n.modifiers||[];g.innerHTML=`
    ...
    `,(d=document.getElementById("btnTCFight"))==null||d.addEventListener("click",async()=>{l.fighting=!0,f();try{const y=await c.request(`/player/${v}/atlas-maps/fight`,{method:"POST"});t.player=y.player,k();const x=y.result!=="map_failed";o(y.message,x?"success":"error"),l.fighting=!1,(y.result==="map_complete"||y.result==="map_failed")&&(l.tab="atlas"),await b()}catch(y){o(y.message,"error"),l.fighting=!1,f()}}),(s=document.getElementById("btnTCQuit"))==null||s.addEventListener("click",async()=>{try{await c.request(`/player/${v}/atlas-maps/abandon`,{method:"POST"}),o("Đã rời Tiên Cảnh","info"),l.tab="atlas",await b()}catch(y){o(y.message,"error")}})}function m(g){return{1:"#5ba3cf",2:"#6a8f3f",3:"#d4a017",4:"#b06cff",5:"#ff6b35",6:"#ff4500",7:"#e91e63",8:"#ff0000"}[g]||"#666"}l.loaded?f():b()}function Lt(r,a){const{state:t,api:c,notify:o,updateSidebar:k}=a,v=t.playerId;t._tw||(t._tw={data:null,loaded:!1,fighting:!1,tab:"tower"});const l=t._tw;async function b(){try{l.data=await c.request(`/player/${v}/tower`),l.loaded=!0,f()}catch(u){o(u.message,"error")}}function f(){var d,s;const u=l.data,m=u==null?void 0:u.run,g=(u==null?void 0:u.leaderboard)||[],n=(u==null?void 0:u.milestones)||{},e=u==null?void 0:u.nextMilestone;r.innerHTML=`
      <div class="page-header">
    ...
    `,r.querySelectorAll("[data-tab]").forEach(y=>y.addEventListener("click",()=>{l.tab=y.dataset.tab,f()})),(d=document.getElementById("btnEnter"))==null||d.addEventListener("click",async()=>{try{const y=await c.request(`/player/${v}/tower/climb`,{method:"POST"});o(y.message,"success"),await b()}catch(y){o(y.message,"error")}}),(s=document.getElementById("btnFight"))==null||s.addEventListener("click",async()=>{var y,x;l.fighting=!0,f();try{const $=await c.request(`/player/${v}/tower/fight`,{method:"POST"});t.player=$.player,k(),l.fighting=!1;const w=document.getElementById("twResult");if(w){const L=$.result!=="death";w.innerHTML=`
            <div class="panel" style="border-left:3px solid ${L?"var(--green)":"var(--red)"}">
              <div class="panel-body" style="padding:14px">
                ...
                ${((x=$.combatResults)==null?void 0:x.map(C=>`<details style="margin-top:6px"><summary style="cursor:pointer;font-size:11px">${C.monster} — ${C.result==="win"?"✅":"❌"}</summary><pre style="font-size:10px;max-height:150px;overflow:auto;opacity:0.6;margin-top:4px">${(C.log||[]).map(S=>`${S.turn||""}: ${S.text||JSON.stringify(S)}`).join(`
`)}</pre></details>`).join(""))||""}
              </div>
            </div>
          `}await b()}catch($){o($.message,"error"),l.fighting=!1,f()}});const i=document.getElementById("twContent");i&&(l.tab==="leaderboard"?T(i,g,u.playerRank):l.tab==="milestones"?p(i,n,(m==null?void 0:m.highestFloor)||0):h(i,m))}function h(u,m){if(!m){u.innerHTML='<div class="panel"><div class="panel-body" style="text-align:center;padding:30px;opacity:0.5">Vào tháp để bắt đầu leo!</div></div>';return}const g=m.currentFloor,n=[];g%10===0?n.push("👑 Boss"):g%15===0?n.push("💰 Bảo Tàng (2.5x loot)"):g%7===0?n.push("☠️ Bẫy Trận (-10% HP)"):g%13===0?n.push("💚 Linh Tuyền (+20% HP)"):g%11===0?n.push("⚡ Tinh Anh (+30% stats)"):g%9===0&&g>20&&n.push("☯ Ngũ Hành");const e=Math.min(1+Math.floor(g/20),3);u.innerHTML=`<div class="panel"><div class="panel-body" style="padding:14px">
      ...
      ${m.map(e=>{const i=e.rank<=3?["","🥇","🥈","🥉"][e.rank]:`#${e.rank}`,d=e.playerId===v;return`<div class="list-item" style="padding:8px 14px;${d?"background:rgba(255,215,0,0.1)":""}">
    ...
    `}function p(m){const g=m.gardenSlots||[],n=m.gardenHerbs||{};return`
      ...
      <div class="panel">
        ...
        <div class="panel-body" style="padding:12px 16px">
          <div style="display:grid;grid-template-columns:repeat(${Math.min(m.maxSlots,5)},1fr);gap:8px">
            ${Array.from({length:m.maxSlots},(e,i)=>{const d=g[i]||{},s=!!d.herb,y=d.ready,x=d.remaining||0,$=Math.ceil(x/60);return`
      ...
      `:""}
    `}function u(){var m,g,n,e;(m=document.getElementById("btnBuyHouse"))==null||m.addEventListener("click",async()=>{if(confirm("Mua Động Phủ?"))try{const i=await c.buyHousing(l);o(i.message,"success"),t.player=i.player,k(),await f()}catch(i){o(i.message,"error")}}),(g=document.getElementById("btnUpgrade"))==null||g.addEventListener("click",async()=>{if(confirm("Nâng cấp Động Phủ?"))try{const i=await c.buyHousing(l);o(i.message,"success"),t.player=i.player,k(),await f()}catch(i){o(i.message,"error")}}),document.querySelectorAll(".plant-select").forEach(i=>{i.addEventListener("change",async d=>{const s=d.target.value;if(!s)return;const y=parseInt(i.dataset.slot);try{const x=await c.plantHerb(l,s,y);o(x.message,"success"),await f()}catch(x){o(x.message,"error")}})}),(n=document.getElementById("btnHarvest"))==null||n.addEventListener("click",async()=>{try{const i=await c.harvestGarden(l);o(i.message,"success"),t.player=i.player,k(),await f()}catch(i){o(i.message,"error")}}),document.querySelectorAll(".btn-formation").forEach(i=>{i.addEventListener("click",async()=>{const d=i.dataset.fid;i.disabled=!0,i.textContent="⏳...";try{const s=await c.upgradeFormation(l,d);o(s.message,"success"),t.player=s.player,k(),await f()}catch(s){o(s.message,"error"),i.disabled=!1,i.textContent="⬆ Nâng"}})}),(e=document.getElementById("btnMaintenance"))==null||e.addEventListener("click",async()=>{try{const i=await c.payMaintenance(l);o(i.message,"success"),t.player=i.player,k(),await f()}catch(i){o(i.message,"error")}})}b.loaded?h():f()}function Ct(r,a){const{state:t}=a;t._wikiTab||(t._wikiTab="lore");function c(){r.innerHTML=`
      <div class="page-header">
    ...
    `,r.querySelectorAll("[data-tab]").forEach(k=>{k.addEventListener("click",()=>{t._wikiTab=k.dataset.tab,c()})})}function o(k){return{lore:`
      ...
      `}[k]||'<div style="text-align:center;opacity:0.4">Chọn một mục để xem</div>'}c()}function Et(r,a){const{state:t,api:c,notify:o,updateSidebar:k}=a,v=t.playerId;t._npcShop||(t._npcShop={shops:[],tax:{rate:5,reason:""},loaded:!1});const l=t._npcShop;let b=parseInt(localStorage.getItem("npcShopIdx")||"0");async function f(){try{r.innerHTML='<div class="loading" style="padding:40px;text-align:center">⏳ Đang tải gian hàng...</div>';const p=await c.getShops(v);l.shops=p.shops||[],l.tax=p.currentTax||{rate:5,reason:"Thuế tiêu chuẩn"},l.loaded=!0,b>=l.shops.length&&(b=0),h()}catch(p){o(p.message||"Lỗi tải shop","error")}}function h(){var e;if(l.shops.length===0){r.innerHTML=`
        ...
        </div></div>`;return}const p=l.shops[b]||l.shops[0],u=l.shops.map((i,d)=>`
      <button class="skill-tab ${d===b?"active":""}" data-shop-idx="${d}">
        ${i.icon||"🧓"} ${i.name}
      </button>
    `).join(""),m={common:"#888",uncommon:"#4a9",rare:"#48f",epic:"#a4f",legendary:"var(--gold)"},g={common:"Phàm",uncommon:"Tốt",rare:"Quý",epic:"Huyền",legendary:"Thần"},n=(p.items||[]).map(i=>{var $,w;const d=m[i.rarity||"common"]||"#888",s=g[i.rarity||"common"]||"Phàm",y=(i.remainingStock??1)<=0,x=((($=t.player)==null?void 0:$.gold)??0)>=(i.currentPrice||0);return`
    ...
    `}function p(m){var i;const g=m.guild,n=m.members||[],e=m.log||[];return`
      <div class="panel glass" style="margin-bottom:12px">
        <div class="panel-body" style="display:flex;align-items:center;gap:16px;padding:14px 16px">
          <div style="font-size:36px">🏯</div>
          <div style="flex:1">
    ...
    `}function u(){var m,g,n,e,i,d;(m=document.getElementById("btnCreate"))==null||m.addEventListener("click",async()=>{var $,w,L,C,S,I;const s=(w=($=document.getElementById("guildName"))==null?void 0:$.value)==null?void 0:w.trim(),y=(C=(L=document.getElementById("guildTag"))==null?void 0:L.value)==null?void 0:C.trim(),x=(I=(S=document.getElementById("guildDesc"))==null?void 0:S.value)==null?void 0:I.trim();if(!s||!y)return o("Nhập tên và tag!","error");try{const M=await c.createGuild(v,s,y,x);o(M.message,"success"),t.player=M.player,k(),l.loaded=!1,await b()}catch(M){o(M.message,"error")}}),(g=document.getElementById("btnLoadGuilds"))==null||g.addEventListener("click",f),document.querySelectorAll(".btn-join").forEach(s=>{s.addEventListener("click",async()=>{try{const y=await c.joinGuild(v,parseInt(s.dataset.gid));o(y.message,"success"),l.loaded=!1,await b()}catch(y){o(y.message,"error")}})}),(n=document.getElementById("btnContribute"))==null||n.addEventListener("click",async()=>{var y;const s=parseInt(((y=document.getElementById("contributeAmt"))==null?void 0:y.value)||0);if(!(s<=0))try{const x=await c.contributeGuild(v,s);o(x.message,"success"),t.player=x.player,k(),await b()}catch(x){o(x.message,"error")}}),(e=document.getElementById("btnUpgradeGuild"))==null||e.addEventListener("click",async()=>{if(confirm("Nâng cấp Tông Môn? Dùng tiền quỹ."))try{const s=await c.upgradeGuild(v);o(s.message,"success"),await b()}catch(s){o(s.message,"error")}}),(i=document.getElementById("btnPayUpkeep"))==null||i.addEventListener("click",async()=>{try{const s=await c.payGuildUpkeep(l.data.guild.id);o(s.message,"success"),await b()}catch(s){o(s.message,"error")}}),(d=document.getElementById("btnLeave"))==null||d.addEventListener("click",async()=>{if(confirm("Rời Tông Môn?"))try{const s=await c.leaveGuild(v);o(s.message,"success"),l.loaded=!1,await b()}catch(s){o(s.message,"error")}})}l.loaded?h():b()}function Mt(r,a){const{state:t,api:c,notify:o,updateSidebar:k}=a,v=t.playerId;t._profile||(t._profile={results:[],viewing:null,searchQuery:""});const l=t._profile;function b(){r.innerHTML=`
      <div class="page-header">
        <h2>🔍 Tìm Đạo Hữu</h2>
    ...
    `,h()}function f(p){var n,e,i;const u=p.id===v,m=p.maxHp>0?Math.round(p.currentHp/p.maxHp*100):100,g={thanh_lam_tran:"Thanh Lam Trấn",hac_phong_lam:"Hắc Phong Lâm",vong_linh_coc:"Vong Linh Cốc",thiet_huyet_son:"Thiết Huyết Sơn",bac_suong_canh:"Bắc Sương Cảnh"};return`
      <div class="panel glass" style="margin-bottom:12px">
        <div class="panel-body" style="padding:16px">
    ...
    `}function h(){var p,u,m,g,n;(p=document.getElementById("btnSearch"))==null||p.addEventListener("click",T),(u=document.getElementById("searchInput"))==null||u.addEventListener("keydown",e=>{e.key==="Enter"&&T()}),document.querySelectorAll(".btn-view, [data-view]").forEach(e=>{e.addEventListener("click",async()=>{const i=e.dataset.vid||e.dataset.view;try{const d=await c.getPlayerProfile(i);l.viewing=d.profile,b()}catch(d){o(d.message,"error")}})}),(m=document.getElementById("btnAttack"))==null||m.addEventListener("click",async()=>{const e=document.getElementById("btnAttack").dataset.tid;if(confirm(`Tấn công ${l.viewing.name}?`))try{const i=await c.mugPlayer(v,e);o(i.message,i.won?"success":"error"),i.player&&(t.player=i.player,k())}catch(i){o(i.message,"error")}}),(g=document.getElementById("btnAddFriend"))==null||g.addEventListener("click",async()=>{const e=document.getElementById("btnAddFriend").dataset.tid;try{const i=await c.addFriend(v,e);o(i.message||"Đã gửi lời mời!","success")}catch(i){o(i.message,"error")}}),(n=document.getElementById("btnBackSearch"))==null||n.addEventListener("click",()=>{l.viewing=null,b()})}async function T(){var m;const p=document.getElementById("searchInput"),u=(m=p==null?void 0:p.value)==null?void 0:m.trim();if(!u||u.length<2)return o("Nhập ít nhất 2 ký tự!","error");l.searchQuery=u,l.viewing=null;try{const g=await c.searchPlayers(u);l.results=g.players||[],b()}catch(g){o(g.message,"error")}}b()}function Pt(r,a){const{state:t,api:c,notify:o,updateSidebar:k}=a,v=t.playerId;t._arena||(t._arena={data:null,loaded:!1,fighting:!1,lastResult:null});const l=t._arena;async function b(){try{l.data=await c.getArena(v),l.loaded=!0,f()}catch(T){o(T.message,"error")}}function f(){var e,i,d,s,y,x,$,w;const T=l.data,p=(T==null?void 0:T.arena)||{},u=p.rank||{},m=parseInt(p.streak)||0,g=m>=5?`🔥x${m}`:m>=3?`⚡x${m}`:m>0?`${m}W`:m<0?`${Math.abs(m)}L`:"",n=m>=5?"var(--gold)":m>=3?"var(--orange)":m>0?"var(--green)":m<0?"var(--red)":"var(--text-dim)";r.innerHTML=`
      <div class="page-header">
        <h2>⚔️ Đấu Trường</h2>
      ...
      <div class="panel" style="margin-bottom:12px">
        ...
        <div class="panel-body no-pad">
          ${(T.opponents||[]).length>0?(T.opponents||[]).map(L=>{var C,S,I;return`
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
        <div class="panel">
          ...
          <div class="panel-body no-pad">
            ${(T.top10||[]).map((L,C)=>{var S,I;return`
        ...
        <div class="panel">
          ...
          <div class="panel-body no-pad">
            ${(T.history||[]).map(L=>{const C=L.winner_id===v;return`<div class="list-item" style="padding:6px 12px;font-size:11px">
                <span style="color:${C?"var(--green)":"var(--red)"}">
                  ${C?"✅":"❌"} vs ${L.attacker_id===v?L.defender_name:L.attacker_name}
                </span>
    ...
    `,r.querySelectorAll(".btn-claim").forEach(p=>p.addEventListener("click",async()=>{try{const u=await c.claimDailyQuest(v,parseInt(p.dataset.qid));o(u.message,"success"),t.player=u.player,k(),await l()}catch(u){o(u.message,"error")}}))}l()}function Nt(r,a){const{state:t,api:c,notify:o,updateSidebar:k}=a,v=t.playerId;async function l(){try{t._worldBoss=await c.getWorldBoss(),b()}catch(f){o(f.message,"error")}}function b(){var g;const f=t._worldBoss||{},h=f.boss||{},T=f.hpPercent||0,p=f.topContributors||[],u=f.rewards||{},m=h.status==="active"&&h.current_hp>0;r.innerHTML=`
      ...
      <div class="panel">
        ...
        <div class="panel-body no-pad">
          ${p.length===0?'<div style="padding:16px;opacity:0.3">Chưa ai đánh...</div>':p.map((n,e)=>{var i;return`
              <div class="list-item" style="padding:6px 12px;font-size:12px">
    ...
    `,(g=document.getElementById("btnAttackBoss"))==null||g.addEventListener("click",async()=>{const n=document.getElementById("btnAttackBoss");n.disabled=!0,n.textContent="⏳ Đang giao chiến...";const e=document.getElementById("bossCombatResult");try{const i=await c.attackWorldBoss(v);if(t.player=i.player,k(),i.log&&i.log.length>0){const d=i.log.map($=>$.startsWith("---")?`<div class="turn">${$}</div>`:$.includes("hụt")?`<div class="miss">${$}</div>`:$.includes("né được")?`<div class="dodge">${$}</div>`:$.includes("CHÍNH MẠNG")||$.includes("💥")?`<div class="crit">${$}</div>`:$.includes("🔥")?`<div class="heavy text-orange">${$}</div>`:$.includes("chặn hoàn toàn")||$.includes("🛡")?`<div class="dodge">${$}</div>`:$.includes("ngã xuống")||$.includes("💀")?`<div class="death">${$}</div>`:$.includes("Chiến thắng")||$.includes("🏆")?`<div class="victory">${$}</div>`:$.includes("bỏ chạy")||$.includes("🏃")?`<div class="flee">${$}</div>`:$.includes("Bất phân")||$.includes("🤝")?`<div class="stalemate">${$}</div>`:$.includes("🧪")?`<div class="status-effect text-purple">${$}</div>`:$.includes("💔")?`<div class="dot-damage text-purple bold">${$}</div>`:$.includes("✨")?`<div class="regen text-green">${$}</div>`:`<div class="hit">${$}</div>`).join(""),s={win:{icon:"🏆",text:"Chiến thắng",cls:"win"},loss:{icon:"💀",text:"Hết sức (Không phạt)",cls:"lose"},stalemate:{icon:"⏰",text:"Bất phân thắng bại",cls:"draw"},flee:{icon:"🏃",text:"Thoát thân",cls:"flee"}},y=s[i.outcome]||s.loss,x=Math.max(0,t.player.currentHp/t.player.maxHp*100);e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:10px;margin-bottom:12px">
        ${Object.entries(p).map(([g,n])=>{var i,d,s;const e=u[g]||{};return`
          <div class="panel glass">
    ...
    `,r.querySelectorAll(".skill-tab[data-tab]").forEach(u=>{u.addEventListener("click",()=>{t._lbTab=u.dataset.tab,k()})})}k()}const E={playerId:null,player:null,currentPage:"combat",monsters:[],skills:[],items:[]},nt=document.getElementById("app"),J={get state(){return E},api:q,notify:z,renderGame:H,updateSidebar:Gt};async function zt(){const r=localStorage.getItem("playerId");if(r&&!E.playerId)try{const a=await q.getPlayer(r);E.playerId=r,E.player=a.player,await V(),H();return}catch{localStorage.removeItem("playerId")}E.playerId?H():st()}function st(){var a,t;const r=E.authTab||"login";nt.innerHTML=`
...
...Cho đến khi hệ thống xuất hiện lỗi.</div>
    ...
    <div class="game-layout">
        ...
        <div class="sidebar-player">
          ...
          <div class="sidebar-bar" style="margin-top:8px">
            <div class="bar-label">
              ...
              <span>
                ${r.currentHp}/${r.maxHp}
                ${r.currentHp<r.maxHp?`<span style="font-size:10px; color:var(--text-dim); margin-left:4px;">${(p=r.skills)!=null&&p.some(s=>s.id==="toa_thien")?"+1%/10s":"+0.5%/10s"}</span>`:""}
              </span>
            </div>
      ...
      <div class="floating-actions">
        ...
        <button class="btn-fab bg-green" id="btnFabSocial" title="Đạo Hữu"><span class="icon">🤝</span></button>
    ...
    </div>`,document.querySelectorAll(".nav-item[data-page]").forEach(s=>{s.addEventListener("click",()=>{E.currentPage=s.dataset.page,H()})}),(e=document.getElementById("btnFabChat"))==null||e.addEventListener("click",()=>D("chat")),(i=document.getElementById("btnFabSocial"))==null||i.addEventListener("click",()=>D("social"));const l=document.querySelector('.sidebar-action-bar .nav-item[data-page="events"]');l&&l.addEventListener("click",s=>{s.stopPropagation(),E.currentPage="events",E.popupOpen=!1,H()}),(d=document.getElementById("btnPopupClose"))==null||d.addEventListener("click",()=>{E.popupOpen=!1,H()}),document.querySelectorAll(".popup-tab[data-popup]").forEach(s=>{s.addEventListener("click",()=>D(s.dataset.popup))}),At(),E.popupOpen&&Rt();const b=document.getElementById("searchPlayerInput"),f=document.getElementById("searchResults");let h=null;b&&f&&(b.addEventListener("input",()=>{clearTimeout(h);const s=b.value.trim();if(s.length<2){f.style.display="none";return}h=setTimeout(async()=>{try{const y=await q.searchPlayers(s),x=y.players||y.results||[];x.length===0?f.innerHTML='<div style="padding:8px 12px;font-size:12px;color:var(--text-dim)">Không tìm thấy</div>':f.innerHTML=x.map($=>{var w;return`
            ...
            `}).join(""),f.style.display="block",f.querySelectorAll(".search-result").forEach($=>{$.addEventListener("click",()=>{E.currentPage="profile",E._viewProfileId=$.dataset.pid,f.style.display="none",b.value="",H()}),$.addEventListener("mouseenter",()=>$.style.background="rgba(255,255,255,0.08)"),$.addEventListener("mouseleave",()=>$.style.background="transparent")})}catch{f.style.display="none"}},300)}),b.addEventListener("blur",()=>{setTimeout(()=>{f.style.display="none"},200)}),b.addEventListener("keydown",s=>{s.key==="Escape"&&(f.style.display="none",b.blur())})),Ot()}function D(r){E.popupOpen=!0,E.popupPage=r,H()}function Rt(){const r=document.getElementById("popupContent");r&&(E.popupPage==="chat"?at(r,J):E.popupPage==="social"&&et(r,J))}const jt={combat:ct,crimes:yt,education:Y,stats:ut,skills:vt,inventory:K,travel:tt,alchemy:F,quests:bt,admin:xt,social:et,chat:at,market:ft,realm:$t,events:Tt,dungeon:Z,housing:St,wiki:Ct,npcshop:Et,guild:It,library:X,profile:Mt,arena:Pt,auction:qt,dailyquest:Ht,worldboss:Nt,gacha:_t,leaderboard:Bt,tiencanh:wt,tower:Lt};function At(){const r=document.getElementById("pageContent");if(!r)return;const a=jt[E.currentPage];a&&a(r,J)}function Gt(){var k,v,l,b,f;const r=E.player;if(!r)return;const a=Math.max(0,r.currentHp/r.maxHp*100),t=r.maxEnergy>0?Math.max(0,r.currentEnergy/r.maxEnergy*100):0,c=document.querySelector(".sidebar-player");if(c){const h=r.maxStamina>0?Math.max(0,r.currentStamina/r.maxStamina*100):0,T=(r.maxNerve??15)>0?Math.max(0,(r.nerve??0)/(r.maxNerve??15)*100):0;c.innerHTML=`
      <div class="player-name">${r.name}</div>
      ...
      <div class="sidebar-gold">💎 ${r.gold??0} Linh Thạch</div>`}const o=document.querySelector('.nav-item[data-page="stats"]');if(o){let h="";r.statPoints>0&&(h+=`<span class="badge">${r.statPoints}</span>`),(f=r.realmInfo)!=null&&f.canBreakthrough&&(h+='<span class="badge" style="background:var(--gold);animation:pulse 1.5s infinite">!</span>'),o.querySelectorAll(".badge").forEach(T=>T.remove()),o.insertAdjacentHTML("beforeend",h)}}async function V(){try{const[r,a,t,c,o,k]=await Promise.all([q.getMonsters(),q.getSkills(),q.getItems(),q.getMedicines(),q.getCrimes(),q.getEducation()]);E.monsters=r.monsters||[],E.skills=a.skills||[],E.items=t.items||[],E.medicines=c.medicines||[],E.crimes=o.crimes||[],E.educationTrees=k.trees||[],E.exploration=await q.getExploration(),E.recipes=(await q.getRecipes()).recipes,E.npcs=(await q.getNpcs()).npcs||[]}catch(r){console.error("Lỗi tải dữ liệu:",r)}}function z(r,a="info"){var c;(c=document.querySelector(".notification"))==null||c.remove();const t=document.createElement("div");t.className=`notification ${a}`,t.textContent=r,document.body.appendChild(t),setTimeout(()=>{t.style.opacity="0",t.style.transition="opacity 0.3s",setTimeout(()=>t.remove(),300)},3e3)}zt();
//# sourceMappingURL=index-B0iitJu4.js.map
